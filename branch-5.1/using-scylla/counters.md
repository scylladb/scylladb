...
* Updates are **not** [idempotent](https://opensource.docs.scylladb.com/branch-5.1/glossary.md#term-Idempotent). In the case of a write failure, the client cannot safely retry the request.
...
Read our [blog](http://www.scylladb.com/2017/04/04/counters/) on counters, or see the data type [description](https://opensource.docs.scylladb.com/branch-5.1/cql/types.md#counters).

## More information

[Scylla University: Advanced Data Modeling lesson](https://university.scylladb.com/courses/data-modeling/lessons/advanced-data-modeling/) - Covers advanced Data Modeling topics. It’s recommended to start with the basic data modeling lesson first. It goes over Application workflow and query analysis and denormalization among other topics while showing some concrete hands-on examples.
