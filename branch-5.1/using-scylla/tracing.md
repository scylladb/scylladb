...
If you are sending this data to Scylla for help, follow the directions in [How to Report a Scylla Problem](https://opensource.docs.scylladb.com/branch-5.1/troubleshooting/report-scylla-problem.md#report-performance-problem).
