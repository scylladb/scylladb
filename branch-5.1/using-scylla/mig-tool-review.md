...
* From SSTable to SSTable
  : - Based on Scylla refresh
    ...
    - For example, [unirestore](https://github.com/scylladb/field-engineering/tree/master/unirestore): SSTable to SSTable
* From SSTable to CQL.
  : - [sstableloader](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/admin-tools/sstableloader.md)
* From CQL to CQL
