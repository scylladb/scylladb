...
#### Versionadded
Added in version Scylla: Enterprise 2020.1

Local Secondary Indexes is an enhancement to [Global Secondary Indexes](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/secondary-indexes.md),
...
![image](using-scylla/global-sec-index-example.png)
...
![image](using-scylla/local-sec-index-example.png)
...
![image](using-scylla/local-sec-index-token-aware-exaple.png)
...
* [Global Secondary Indexes](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/secondary-indexes.md)
* [CQL Reference](https://opensource.docs.scylladb.com/branch-5.1/cql/secondary-indexes.md) - CQL Reference for Secondary Indexes
