...
In versions prior to Scylla Open Source 4.3, CDC is an experimental feature and you need to enable it in order to use it. See [this procedure](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/admin.md#yaml-enabling-experimental-features).
