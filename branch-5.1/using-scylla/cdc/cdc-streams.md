...
* the currently operating *CDC generation* ([CDC Stream Generations](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/cdc/cdc-stream-generations.md)),
