...
* **Log Table** - this is the table associated to the base table which is created when CDC is enabled. Read about it in the [log table document](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/cdc/cdc-log-table.md).
