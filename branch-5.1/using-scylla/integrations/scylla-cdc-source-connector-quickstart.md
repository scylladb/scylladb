...
a Scylla table using [Scylla CDC](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/cdc/cdc-intro.md).
...
environments, please refer to the [Install Scylla page](https://opensource.docs.scylladb.com/branch-5.1/getting-started/install-scylla/index.md).
...
To learn more about Scylla CDC, visit [Change Data Capture (CDC) page](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/cdc/index.md).
