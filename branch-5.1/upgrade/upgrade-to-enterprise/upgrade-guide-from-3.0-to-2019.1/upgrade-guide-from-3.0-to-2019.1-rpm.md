...
1. Update the [Scylla RPM Enterprise repo](http://www.scylladb.com/enterprise-download/centos_rpm/)  to **2019.1**
2. install
...
<a id="upgrade-3-0-2019-1-rpm-rollback-procedure"></a>
