# Upgrade Guide - ScyllaDB 5.0 to ScyllaDB Enterprise 2022.1 for Debian 10
...
This guide covers upgrading ScyllaDB from version 5.0.x to ScyllaDB Enterprise version 2022.1.y on Debian 10. See [OS Support by Platform and Version](https://opensource.docs.scylladb.com/branch-5.1/getting-started/os-support.md) for information about supported Debian 10 versions.
...
Before upgrading, check what version you are running now using `dpkg -l scylla\*server`. You should use the same version in case you want to [rollback](/upgrade/upgrade-to-enterprise/upgrade-guide-from-5.0-to-2022.1/upgrade-guide-from-5.0-to-2022.1-debian-10/#rollback-procedure) the upgrade. If you are not running a 5.0.x version, stop right here! This guide only covers 5.0.x to 2022.1.y upgrades.

To upgrade:

1. Update the [ScyllaDB Enterprise Deb repo](https://www.scylladb.com/customer-portal/?product=ent&platform=debian-10&version=stable-release-2022.1) to **2022.1**.
2. Install:
   > ```sh
...
1. Remove the old repo file.
   ...
   > ```
2. Update the [ScyllaDB deb repo](http://www.scylladb.com/download/?platform=debian-10&version=scylla-5.0) to **5.0**.
3. Install:
   > ```sh
   > sudo apt-get clean all
   > sudo apt-get update
