...
See the relevant [upgrade guide](https://opensource.docs.scylladb.com/branch-5.1/upgrade/index.md) for detailed instructions for upgrading your ScyllaDB version.
