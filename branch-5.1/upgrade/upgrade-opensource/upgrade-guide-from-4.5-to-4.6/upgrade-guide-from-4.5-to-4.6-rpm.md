...
1. Remove the old repo file.
   ...
   > ```
2. Update the [Scylla rpm repo](https://www.scylladb.com/download/?platform=centos&version=scylla-4.6)  to 4.5.
3. Install:
   > ```console
   > sudo yum clean all
...
Restore all tables of **system** and **system_schema** from previous snapshot because 4.6 uses a different set of system tables. See [Restore from a Backup and Incremental Backup](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/backup-restore/restore.md) for details.
