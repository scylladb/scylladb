# Upgrade Guide - Scylla 4.6 to 5.0 for Debian 10
...
This guide covers upgrading Scylla 4.6 to Scylla 5.0 on Debian 10.
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=debian-10&version=scylla-5.0) to 5.0.
2. Install:
   > ```console
...
1. Remove the old repo file.
   ...
   > ```
2. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=debian-10&version=scylla-5.0) to 4.6.
3. Install:
   > ```default
   > sudo apt-get update
