# Upgrade Guide - Scylla 4.6 to 5.0 for Ubuntu 20.04
...
This guide covers upgrading Scylla 4.6 to Scylla 5.0 on Ubuntu 20.04.
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=ubuntu-20.04&version=scylla-5.0) to 5.0.
2. Install:
   > ```console
...
1. Remove the old repo file.
   ...
   > ```
2. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=ubuntu-20.04&version=scylla-5.0) to 4.6.
3. Install:
   > ```default
   > sudo apt-get update
