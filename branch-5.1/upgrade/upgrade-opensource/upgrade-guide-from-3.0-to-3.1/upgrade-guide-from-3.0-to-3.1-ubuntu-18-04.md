# Upgrade Guide - Scylla 3.0 to 3.1 for Ubuntu 18.04
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=ubuntu-18.04) to 3.1, and enable scylla/ppa repo
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=ubuntu-18.04) to 3.0
2. install
