# Upgrade Guide - Scylla 3.0 to 3.1 for Debian 9
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=debian-9) to 3.1, and enable scylla/ppa repo
...
Restore all tables of **system** and **system_schema** from previous snapshot, 3.1 uses a different set of system tables. Reference doc: [Restore from a Backup and Incremental Backup](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/backup-restore/restore.md)
