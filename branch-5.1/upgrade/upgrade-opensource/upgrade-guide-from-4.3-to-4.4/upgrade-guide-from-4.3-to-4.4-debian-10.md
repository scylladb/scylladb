# Upgrade Guide - Scylla 4.3 to 4.4 for Debian 10
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=debian-10&version=scylla-4.4) to 4.4
2. Install
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=debian-10&version=scylla-4.4) to 4.3
2. install
...
Restore all tables of **system** and **system_schema** from previous snapshot, 4.4 uses a different set of system tables. Reference doc: [Restore from a Backup and Incremental Backup](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/backup-restore/restore.md)
