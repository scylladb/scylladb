...
want to [rollback](#upgrade-1-3-1-4-ubuntu-rollback-procedure)
the upgrade. If you are not running a 1.3.x version, stop right here!
This guide only covers 1.3.x to 1.4.y upgrades.

To upgrade:

1. Update the [Scylla deb repo](http://www.scylladb.com/download/#fndtn-deb) to
   **1.4**
2. Install
...
<a id="upgrade-1-3-1-4-ubuntu-rollback-procedure"></a>
