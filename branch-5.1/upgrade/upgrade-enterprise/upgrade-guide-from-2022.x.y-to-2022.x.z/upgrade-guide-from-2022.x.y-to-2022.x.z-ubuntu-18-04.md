# Upgrade Guide - ScyllaDB Enterprise 2022.x.y to 2022.x.z for Ubuntu 16.04
...
1. Update the [ScyllaDB Enterprise deb repo](https://www.scylladb.com/customer-portal/?product=ent&platform=ubuntu-16.04&version=stable-release-2022.1) to **2022.x**.
2. Install:
   > ```sh
