# Upgrade Guide - Scylla Enterprise 2019.1 to 2020.1 for 16.04
...
Before upgrading, check what version you are running now using `dpkg -s scylla-enterprise-server`. You should use the same version in case you want to [rollback](/upgrade/upgrade-enterprise/upgrade-guide-from-2019.1-to-2020.1/upgrade-guide-from-2019.1-to-2020.1-ubuntu-16-04/#rollback-procedure) the upgrade. If you are not running a 2019.1.x version, stop right here! This guide only covers 2019.1.x to 2020.1.y upgrades.

To upgrade:

1. Update the [Scylla Enterprise Deb repo](https://www.scylladb.com/customer-portal/?product=ent&platform=ubuntu-16.04&version=stable-release-2020.1) to **2020.1**, and enable scylla/ppa repo
...
1. Update the [Scylla Enterprise Deb repo](https://www.scylladb.com/customer-portal/?product=ent&platform=ubuntu-16.04&version=stable-release-2020.1) to **2019.1**
2. install
