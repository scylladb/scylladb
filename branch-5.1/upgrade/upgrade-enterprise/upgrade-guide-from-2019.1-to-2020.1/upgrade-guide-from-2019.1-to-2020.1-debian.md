# Upgrade Guide - Scylla Enterprise 2019.1 to 2020.1 for Debian 9
...
Before upgrading, check what version you are running now using `dpkg -s scylla-enterprise-server`. You should use the same version in case you want to [rollback](/upgrade/upgrade-enterprise/upgrade-guide-from-2019.1-to-2020.1/upgrade-guide-from-2019.1-to-2020.1-debian/#rollback-procedure) the upgrade. If you are not running a 2019.1.x version, stop right here! This guide only covers 2019.1.x to 2020.1.y upgrades.

To upgrade:

1. Update the [Scylla Enterprise Deb repo](https://www.scylladb.com/customer-portal/?product=ent&platform=debian-9&version=stable-release-2020.1) to **2020.1**, and enable scylla/ppa repo
...
1. Config java to 1.8, which is requested by Scylla Enterprise 2020.1
...
* More on [Scylla Metrics Update - Scylla Enterprise 2019.1 to 2020.1](https://opensource.docs.scylladb.com/branch-5.1/upgrade/upgrade-enterprise/upgrade-guide-from-2019.1-to-2020.1/metric-update-2019.1-to-2020.1.md)
...
1. Update the [Scylla Enterprise Deb repo](https://www.scylladb.com/customer-portal/?product=ent&platform=debian-9&version=stable-release-2020.1) to **2019.1**
2. install
...
Restore all tables of **system** and **system_schema** from previous snapshot, 2020.1 uses a different set of system tables. Reference doc: [Restore from a Backup and Incremental Backup](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/backup-restore/restore.md)
