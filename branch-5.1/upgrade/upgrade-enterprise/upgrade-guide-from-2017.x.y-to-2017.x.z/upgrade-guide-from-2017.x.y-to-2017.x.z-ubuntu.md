# Upgrade Guide - Scylla Enterprise 2017.x.y to 2017.x.z for Ubuntu 14.04 or 16.04
...
Before upgrading, check what version you are running now using `dpkg -s scylla-server`. You should use the same version in case you want to [rollback](/upgrade/upgrade-enterprise/upgrade-guide-from-2017.x.y-to-2017.x.z/upgrade-guide-from-2017.x.y-to-2017.x.z-ubuntu/#rollback-procedure) the upgrade. If you are not running a 2017.x.y version, stop right here! This guide only covers 2017.x.y to 2017.x.z upgrades.

To upgrade:

1. Update the [Scylla Enterprise deb repo](http://www.scylladb.com/enterprise-download/) to **2017.x**
2. Install
