# Upgrade Guide - Scylla Enterprise 2017.1 to 2018.1 for Debian 8
...
Before upgrading, check what version you are running now using `dpkg -s scylla-server`. You should use the same version in case you want to [rollback](/upgrade/upgrade-enterprise/upgrade-guide-from-2017.1-to-2018.1/upgrade-guide-from-2017.1-to-2018.1-debian/#rollback-procedure) the upgrade. If you are not running a 2017.1.x version, stop right here! This guide only covers 2017.1.x to 2018.1.y upgrades.

To upgrade:

1. Update the [Scylla Enterprise Deb repo](http://www.scylladb.com/enterprise-download/debian8/) to **2018.1**, and enable scylla/ppa repo
