...
#### NOTE
To figure out WHICH query is causing the failure, you might try the procedure described in [probabilistic tracing](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/tracing.md#tracing-probabilistic-tracing).
...
You need to perform a [rolling restart](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/config-change/rolling-restart.md) of all nodes above to apply the new settings.
