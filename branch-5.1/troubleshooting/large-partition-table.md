...
Partitions bigger than this threshold are reported in the `system.large_partitions` table and generate a warning in the Scylla log (refer to [log](https://opensource.docs.scylladb.com/branch-5.1/getting-started/logging.md)).
...
[Large Partitions Hunting](https://opensource.docs.scylladb.com/branch-5.1/troubleshooting/debugging-large-partition.md)
