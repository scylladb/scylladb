...
Failed to create [materialized view](/getting-started/mv/) after node was removed from the cluster.
...
Scylla Open Source 4.3 and later and Scylla Enterprise 2021.1 and later are seedless. See [Scylla Seed Nodes](https://opensource.docs.scylladb.com/branch-5.1/kb/seed-nodes.md) for details.
...
To verify that the node wasn’t remove properly use the [nodetool gossipinfo](/operating-scylla/nodetool-commands/gossipinfo/) command
