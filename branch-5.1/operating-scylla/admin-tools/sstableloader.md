...
#### NOTE
sstableloader does **not** support loading from encrypted files. For restoring data from encrypted files see [Migration to Scylla](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/cassandra-to-scylla-migration-process.md#cassandra-to-scylla-procedure).
...
For example of such usage see [Apache Cassandra to Scylla Migration Process](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/cassandra-to-scylla-migration-process.md)
