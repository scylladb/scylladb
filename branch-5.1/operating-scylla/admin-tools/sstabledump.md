...
In older versions, the tool is named [SSTable2json](/operating-scylla/admin-tools/sstable2json).
If you need more flexibility or want to dump more than just the data-component, see [scylla-sstable](/operating-scylla/admin-tools/scylla-sstable).
