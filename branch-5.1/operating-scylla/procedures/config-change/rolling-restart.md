...
1. Verify the node is up and has returned to the Scylla cluster using [nodetool status](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/nodetool-commands/status.md).
