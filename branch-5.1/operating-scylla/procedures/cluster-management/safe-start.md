...
* Confirm that the cluster was shut down using the [shutdown procedure](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/cluster-management/safe-shutdown.md).
...
nodes first. Validate that the seed nodes have all returned to normal by running [nodetool status](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/nodetool-commands/status.md).
...
2. Validate that the nodes have all returned to normal. Run [nodetool status](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/nodetool-commands/status.md).
