...
#### NOTE
Using trace or debug logging levels will create very large log files where the readers may not find what they are looking for. It is best to use these levels for a very short period of time or with the help of Scylla Support.
...
[Change the Log Level](https://opensource.docs.scylladb.com/branch-5.1/troubleshooting/log-level.md)
