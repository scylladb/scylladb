...
See [Enabling Experimental Features](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/admin.md#yaml-enabling-experimental-features) for details.
...
see [Counting all rows in a table is slow](https://opensource.docs.scylladb.com/branch-5.1/kb/count-all-rows.md) for instructions.
...
[Apache Cassandra Query Language](https://opensource.docs.scylladb.com/branch-5.1/cql/index.md)
