...
A [Consistency Level (CL)](https://opensource.docs.scylladb.com/branch-5.1/glossary.md#term-Consistency-Level-CL) is a dynamic value which dictates the number of replicas (in a cluster) that must acknowledge a read or write operation in order for the coordinator node to determine the operation was successful.
...
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------|---------------------------------------|
| ANY (Write Only)         | Closest replica, as determined by the snitch. If all replica nodes are down, write succeeds after a [hinted handoff](https://opensource.docs.scylladb.com/branch-5.1/glossary.md#term-Hinted-Handoff). Provides low latency, guarantees writes never fail. | Lowest (WRITE)                | Highest (WRITE)                       |
| ONE                      | The closest replica as determined by the [Snitch](https://opensource.docs.scylladb.com/branch-5.1/glossary.md#term-Snitch). Consistency requirements are not too strict.                                                                                   | Lowest (READ)                 | Highest (READ)                        |
...
* [Consistency Level Calculator](https://opensource.docs.scylladb.com/branch-5.1/cql/consistency-calculator.md)
* [Fault Tolerance](https://opensource.docs.scylladb.com/branch-5.1/architecture/architecture-fault-tolerance.md)
* [Cluster membership changes and LWT consistency](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/procedures/cluster-management/membership-changes.md)
* [Consistency Level Compatibility](https://opensource.docs.scylladb.com/branch-5.1/using-scylla/cassandra-compatibility.md#consistency-level-read-and-write)
* [Consistency Quiz](https://opensource.docs.scylladb.com/branch-5.1/kb/quiz-administrators.md)
