...
and most are reserved. The list of those keywords can be found in [Appendix A: CQL Keywords](https://opensource.docs.scylladb.com/branch-5.1/cql/appendices.md#appendix-a).
...
For how these constants are typed, see the [data-types](https://opensource.docs.scylladb.com/branch-5.1/cql/types.md) document.
...
- A literal for either [a collection](https://opensource.docs.scylladb.com/branch-5.1/cql/types.md#collections), a user-defined type or a tuple
...
- [Data Definition](https://opensource.docs.scylladb.com/branch-5.1/cql/ddl.md) statements - to define and change how the data is stored (keyspaces and tables).
- [Data Manipulation](https://opensource.docs.scylladb.com/branch-5.1/cql/dml.md) statements - for selecting, inserting and deleting data.
- [Permissions](https://opensource.docs.scylladb.com/branch-5.1/operating-scylla/security/authorization.md#cql-permissions) statements.
