...
- The [selection](https://opensource.docs.scylladb.com/branch-5.1/cql/dml.md#selection-clause) is limited to those that only select columns of the base table. In other
  words, you can’t use any function (aggregate or not), casting, term, etc. Aliases are also not supported. You can,
  however, use \* as a shortcut to selecting all columns. Further, [static columns](https://opensource.docs.scylladb.com/branch-5.1/cql/ddl.md#static-columns) cannot be
...
- The SELECT statement cannot include **any** of the following:
  - An [ordering clause](https://opensource.docs.scylladb.com/branch-5.1/cql/dml.md#ordering-clause)
  - A [limit](https://opensource.docs.scylladb.com/branch-5.1/cql/dml.md#limit-clause) clause
  - An [ALLOW FILTERING](https://opensource.docs.scylladb.com/branch-5.1/cql/dml.md#allow-filtering) clause.
...
creating a table](https://opensource.docs.scylladb.com/branch-5.1/cql/ddl.md#create-table-options).
...
The options that can be updated with an ALTER statement are the same as those used with a CREATE statement (see [Create table options](https://opensource.docs.scylladb.com/branch-5.1/cql/ddl.md#create-table-options)).
...
* [Apache Cassandra Query Language (CQL) Reference](https://opensource.docs.scylladb.com/branch-5.1/cql/index.md)
