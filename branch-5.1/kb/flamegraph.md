...
1. Install flamegraph and flamegraph-stackcollapse-perf
   ...
   cd FlameGraph
   ```
2. Run the following perf commands, using [Map CPU to Scylla Shards](https://opensource.docs.scylladb.com/branch-5.1/kb/map-cpu.md)  and [Using the perf utility with Scylla](https://opensource.docs.scylladb.com/branch-5.1/kb/use-perf.md) for reference.
   ```shell
