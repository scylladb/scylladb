...
#define OPERATION_LATENCY(name, CamelCaseName) \
    ...
    _metrics.add_group("alternator", {
            ...
            seastar::metrics::make_total_operations("filtered_rows_matched_total", cql_stats.filtered_rows_matched_total,
                    seastar::metrics::description("number of rows read and matched during filtering operations"))(alternator_label).set_skip_when_empty(),
            seastar::metrics::make_total_operations("filtered_rows_dropped_total", [this] { return cql_stats.filtered_rows_read_total - cql_stats.filtered_rows_matched_total; },
                    ...
                    seastar::metrics::make_counter("batch_item_count", seastar::metrics::description("The total number of items processed across all batches"),{op("BatchWriteItem"), basic_level},
                            api_operations.batch_write_item_batch_total)(alternator_label).set_skip_when_empty(),
                    seastar::metrics::make_counter("batch_item_count", seastar::metrics::description("The total number of items processed across all batches"),{op("BatchGetItem"), basic_level},
