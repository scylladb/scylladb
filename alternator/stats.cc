...
#define OPERATION_LATENCY(name, CamelCaseName) \
    ...
    metrics.add_group(group_name, {
            ...
            seastar::metrics::make_histogram("get_item_op_size_kib", seastar::metrics::description("Histogram of item sizes involved in a request"), labels,
            ...
            seastar::metrics::make_histogram("put_item_op_size_kib", seastar::metrics::description("Histogram of item sizes involved in a request"), labels,
            ...
            seastar::metrics::make_histogram("delete_item_op_size_kib", seastar::metrics::description("Histogram of item sizes involved in a request"), labels,
            ...
            seastar::metrics::make_histogram("update_item_op_size_kib", seastar::metrics::description("Histogram of item sizes involved in a request"), labels,
            ...
            seastar::metrics::make_histogram("batch_get_item_op_size_kib", seastar::metrics::description("Histogram of item sizes involved in a request"), labels,
            ...
            seastar::metrics::make_histogram("batch_write_item_op_size_kib", seastar::metrics::description("Histogram of item sizes involved in a request. If alternator_force_read_before_write is disabled, the metrics may be incomplete."), labels,
