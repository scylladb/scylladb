...
#define OPERATION_LATENCY(name, CamelCaseName) \
    ...
    _metrics.add_group("alternator", {
            ...
            seastar::metrics::make_counter("wcu_total", wcu_total,
                    seastar::metrics::description("total number of consumed write units, counted as half units")).set_skip_when_empty(),
