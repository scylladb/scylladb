...
#define OPERATION_LATENCY(name, CamelCaseName) \
            ...
            OPERATION_LATENCY(list_streams_latency, "ListStreams")
            OPERATION_LATENCY(describe_stream_latency, "DescribeStream")
            OPERATION_LATENCY(get_shard_iterator_latency, "GetShardIterator")
