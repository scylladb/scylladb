...
#define OPERATION_LATENCY_WITH_TABLE(name, CamelCaseName) \
    ...
    if (has_table) {
        metrics.add_group("alternator_table", {
            OPERATION_LATENCY_WITH_TABLE(put_item_latency, "PutItem")
            OPERATION_LATENCY_WITH_TABLE(get_item_latency, "GetItem")
            OPERATION_LATENCY_WITH_TABLE(delete_item_latency, "DeleteItem")
            OPERATION_LATENCY_WITH_TABLE(update_item_latency, "UpdateItem")
            OPERATION_LATENCY_WITH_TABLE(batch_write_item_latency, "BatchWriteItem")
            OPERATION_LATENCY_WITH_TABLE(batch_get_item_latency, "BatchGetItem")
            OPERATION_LATENCY_WITH_TABLE(get_records_latency, "GetRecords")
        });
    } else {
