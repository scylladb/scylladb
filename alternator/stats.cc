...
#define OPERATION_LATENCY(name, CamelCaseName) \
    ...
    metrics.add_group(group_name, {
            ...
            seastar::metrics::make_histogram("put_item_op_size_kib", seastar::metrics::description("Histogram of item sizes for items created or replaced by the PutItem operation"), labels,
            ...
            seastar::metrics::make_histogram("delete_item_op_size_kib", seastar::metrics::description("Histogram of deleted item sizes by DeleteItem requests. If alternator_force_read_before_write is disabled, the metrics may be incomplete."), labels,
            ...
            seastar::metrics::make_histogram("update_item_op_size_kib", seastar::metrics::description("Histogram of item sizes in UpdateItem requests. This value is an estimate. It's a sum of the existing item size and the estimated size of the updated fields. If alternator_force_read_before_write is disabled, the metrics may be incomplete."), labels,
            ...
            seastar::metrics::make_histogram("batch_write_item_op_size_kib", seastar::metrics::description("Histogram of write sizes in BatchWriteItem requests. If the inserted item exists, logged size is the maximum of the old and the new item size."), labels,
