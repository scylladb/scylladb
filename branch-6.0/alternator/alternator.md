...
[Scylla Alternator for DynamoDB users](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md) document,
...
See also [https://github.com/scylladb/scylladb/issues/5283](https://github.com/scylladb/scylladb/issues/5283).
...
*conditional* update or an update based on the old value of an attribute.
The read and the write should be treated as a single transaction - protected
(*isolated*) from other parallel writes to the same item.
...
So Alternator supports four *write isolation policies*, which can be chosen
...
* `f`, `forbid`, or `forbid_rmw` - This mode *forbids* write requests
...
[https://docs.google.com/document/d/1i4yjF5OSAazAY_-T8CBce9-2ykW4twx_E_Nt2zDoOVs](https://docs.google.com/document/d/1i4yjF5OSAazAY_-T8CBce9-2ykW4twx_E_Nt2zDoOVs)
...
read-modify-write transactions should be *isolated* from each other, so
...
* [Getting Started With ScyllaDB Alternator](https://opensource.docs.scylladb.com/branch-6.0/alternator/getting-started.md)
  * [Installing ScyllaDB](https://opensource.docs.scylladb.com/branch-6.0/alternator/getting-started.md#installing-scylladb)
  * [Testing Scylla’s DynamoDB API support:](https://opensource.docs.scylladb.com/branch-6.0/alternator/getting-started.md#testing-scylla-s-dynamodb-api-support)
* [ScyllaDB Alternator for DynamoDB users](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md)
  * [Provisioning](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#provisioning)
  * [Scan ordering](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#scan-ordering)
  * [Load balancing](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#load-balancing)
  * [Write isolation policies](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#write-isolation-policies)
  * [Avoiding write reordering](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#avoiding-write-reordering)
  * [Authorization](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#authorization)
  * [Metrics](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#metrics)
  * [Time To Live (TTL)](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#time-to-live-ttl)
  * [Experimental API features](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#experimental-api-features)
  * [Unimplemented API features](https://opensource.docs.scylladb.com/branch-6.0/alternator/compatibility.md#unimplemented-api-features)
