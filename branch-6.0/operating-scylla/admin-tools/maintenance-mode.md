...
The only way to make CQL queries is to use [the maintenance socket](https://opensource.docs.scylladb.com/branch-6.0/operating-scylla/admin-tools/maintenance-socket.md). The node serves only local data.
