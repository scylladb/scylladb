...
Install and use the [Scylla Monitoring Stack](http://monitoring.docs.scylladb.com/); it gives excellent additional value beyond performance.
...
With the recent addition of the [Scylla Advisor](http://monitoring.docs.scylladb.com/stable/advisor.html) to the Scylla Monitoring Stack, it is even easier to find potential issues.

## Install Scylla Manager

Install and use Scylla Manager <https://manager.docs.scylladb.com> together with the [Scylla Monitoring Stack](http://monitoring.docs.scylladb.com/).
...
But, if `scylla_setup` has not run, the system won’t be configured optimally. Refer to the [System Configuration](https://opensource.docs.scylladb.com/branch-6.0/getting-started/system-configuration.md) guide for details.
...
Tools, such as [cassandra-stress](https://opensource.docs.scylladb.com/branch-6.0/operating-scylla/admin-tools/cassandra-stress.md), use a default data model that does not reflect the actions that you will perform in production.
...
For more information, read this [article](http://highscalability.com/blog/2015/10/5/your-load-generator-is-probably-lying-to-you-take-the-red-pi.html).
...
The actual p99 will be equal or smaller than the maximum p99. For more information on percentiles, read this [blog](http://pveentjer.blogspot.com/2017/08/percentiles-and-mean.html).
...
* [Large partitions](https://opensource.docs.scylladb.com/branch-6.0/troubleshooting/large-partition-table.md), [large rows and large cells](https://opensource.docs.scylladb.com/branch-6.0/troubleshooting/large-rows-large-cells-tables.md) should be avoided because it can cause high latencies.
...
Read more about [Stop Wasting Scylla’s CPU Time by Not Being Prepared](https://www.scylladb.com/2017/12/13/prepared-statements-scylla/).
...
Read about [More Efficient Query Paging](https://www.scylladb.com/2018/07/13/efficient-query-paging/).
...
[Workload prioritization](https://enterprise.docs.scylladb.com/stable/using-scylla/workload-prioritization.html) is only available with [Scylla Enterprise](https://enterprise.docs.scylladb.com/).
...
See [Bypass Cache](https://opensource.docs.scylladb.com/branch-6.0/cql/dml/select.md#bypass-cache) for more information.
...
Without [batching](https://opensource.docs.scylladb.com/branch-6.0/cql/dml/batch.md#batch-statement) the total latency would be 10x(0.9+0.1)=10.0 ms.
...
Use the [Scylla drivers](https://opensource.docs.scylladb.com/branch-6.0/using-scylla/drivers/index.md) that are available for Java, Python, Go, and C/C++.
...
Read more about [Scylla System Requirements](https://opensource.docs.scylladb.com/branch-6.0/getting-started/system-requirements.md).
...
Read more about  [Scylla System Requirements](https://opensource.docs.scylladb.com/branch-6.0/getting-started/system-requirements.md) or [Starting Scylla in a Shared Environment](https://opensource.docs.scylladb.com/branch-6.0/getting-started/scylla-in-a-shared-environment.md).
...
Read more about [Scylla Network Requirements](https://opensource.docs.scylladb.com/branch-6.0/getting-started/system-requirements.md#system-requirements-network).
...
Read more about [Starting Scylla in a Shared Environment](https://opensource.docs.scylladb.com/branch-6.0/getting-started/scylla-in-a-shared-environment.md).
...
Read more about [Scylla Supported Platforms](https://opensource.docs.scylladb.com/branch-6.0/getting-started/system-requirements.md#system-requirements-supported-platforms).
...
There is a new instance type available called [r5b](https://aws.amazon.com/blogs/aws/new-amazon-ec2-r5b-instances-providing-3x-higher-ebs-performance/) that has high EBS performance.

### GCP

For GCP we recommend n1/n2-highmem with local SSDs.

Read more at: [https://docs.scylladb.com/getting-started/system-requirements/#google-compute-engine-gce](https://docs.scylladb.com/getting-started/system-requirements/#google-compute-engine-gce)

### Azure

For Azure we recommend the Lsv2 series. They feature high throughput and low latency and have local NVMe storage.
Read more about [Azure Requirements](https://opensource.docs.scylladb.com/branch-6.0/getting-started/cloud-instance-recommendations.md#system-requirements-azure).

### Docker

When running in Docker platform, please use CPU pinning and host networking for best performance.
Read more about [The Cost of Containerization for Your Scylla](https://www.scylladb.com/2018/08/09/cost-containerization-scylla/).
...
Read more about [Exploring Scylla on Kubernetes](https://www.scylladb.com/2018/03/29/scylla-kubernetes-overview/).
...
* Use the following [Compaction Strategy Matrix](https://opensource.docs.scylladb.com/branch-6.0/architecture/compaction/compaction-strategies.md#csm1) to use the correct compaction strategy for your workload.
...
Read more about [Compaction Strategies](https://opensource.docs.scylladb.com/branch-6.0/architecture/compaction/compaction-strategies.md)
...
Read more about [Fault Tolerance](https://opensource.docs.scylladb.com/branch-6.0/architecture/architecture-fault-tolerance.md)
...
Read more about [Maximizing Performance via Concurrency While Minimizing Timeouts in Distributed Databases](https://www.scylladb.com/2019/11/20/maximizing-performance-via-concurrency-while-minimizing-timeouts-in-distributed-databases/) for more information.
