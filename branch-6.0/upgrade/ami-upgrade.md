...
instructions on the **Debian/Ubuntu** tab in the [upgrade guide](https://opensource.docs.scylladb.com/branch-6.0/upgrade/index.md)
...
in the [upgrade guide](https://opensource.docs.scylladb.com/branch-6.0/upgrade/index.md) for your ScyllaDB version.
