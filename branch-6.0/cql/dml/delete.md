...
The `DELETE` statement deletes data written with [INSERT](https://opensource.docs.scylladb.com/branch-6.0/cql/dml/insert.md#insert-statement) or [UPDATE](https://opensource.docs.scylladb.com/branch-6.0/cql/dml/update.md#update-statement) (or [BATCH](https://opensource.docs.scylladb.com/branch-6.0/cql/dml/batch.md#batch-statement))
...
`UPDATE` of the same primary key, delete operation prevails (see [update ordering](https://opensource.docs.scylladb.com/branch-6.0/cql/dml.md#update-ordering)).
