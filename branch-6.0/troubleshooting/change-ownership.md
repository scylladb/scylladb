...
In cases where the Scylla node fails to start, check Scylla [logs](https://opensource.docs.scylladb.com/branch-6.0/getting-started/logging.md). If you see the following error message:
