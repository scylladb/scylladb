...
Starting in version 3.0, Scylla ships with a script to let users know about the mapping between CPUs and Scylla Shards. For users of older versions, a copy of the script can be downloaded from the [Seastar git tree](https://raw.githubusercontent.com/scylladb/seastar/master/scripts/seastar-cpu-map.sh).
