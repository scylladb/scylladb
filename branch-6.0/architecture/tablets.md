...
![image](architecture/images/tablets-cluster.png)
...
![image](architecture/images/tablets-load-balancing.png)

<a id="tablets-enable-tablets"></a>

## Enabling Tablets

ScyllaDB now uses tablets by default for data distribution. This functionality is
controlled by the [`enable_tablets`](https://opensource.docs.scylladb.com/branch-6.0/reference/configuration-parameters.md#confval-enable_tablets) option. However, tablets only work if
...
[with tablets disabled](#tablets-enable-tablets).
