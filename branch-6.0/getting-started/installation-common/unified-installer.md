...
[ScyllaDB Web Installer](https://opensource.docs.scylladb.com/branch-6.0/getting-started/installation-common/scylla-web-installer.md)
...
See [OS Support](https://opensource.docs.scylladb.com/branch-6.0/getting-started/os-support.md) for information about supported Linux distributions and versions.

Note that if you’re on CentOS 7, only root offline installation is supported.

## Download and Install

1. Download the latest tar.gz file for ScyllaDB 5.2 (x86 or ARM) from [https://downloads.scylladb.com/downloads/scylla/relocatable/scylladb-5.2/](https://downloads.scylladb.com/downloads/scylla/relocatable/scylladb-5.2/).
