...
1. Choose an instance type. See [Cloud Instance Recommendations for Azure](https://opensource.docs.scylladb.com/branch-6.0/getting-started/cloud-instance-recommendations.md#system-requirements-azure) for the list of recommended instances.
...
5. See the following table to obtain image information for the latest patch release.
   For earlier releases, see [Azure Images](https://opensource.docs.scylladb.com/branch-6.0/reference/azure-images.md)
   <!-- -*- mode: rst -*- -->
   ...
   |----------------------------|-------------------------|-----------------------------------------------|
   | scylla-6.0                 | 6.0.4                   | scylladb-7e8d8a04-23db-487d-87ec-0e175c0615bb |
