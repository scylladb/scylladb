...
System configuration steps are performed automatically by the Scylla RPM and deb packages. For information on getting started with Scylla, see [Getting Started](https://opensource.docs.scylladb.com/branch-6.0/getting-started/index.md).
...
When installing Scylla, it is highly recommended to use the [scylla_setup](https://opensource.docs.scylladb.com/branch-6.0/getting-started/system-configuration.md) script.
...
See [Seastar Perftune](https://opensource.docs.scylladb.com/branch-6.0/operating-scylla/admin-tools/perftune.md) for details.

## Configuring Scylla

Configuration for Scylla itself is in the [Scylla Configuration](https://opensource.docs.scylladb.com/branch-6.0/operating-scylla/admin.md#admin-scylla-configuration) section of the administration guide.
