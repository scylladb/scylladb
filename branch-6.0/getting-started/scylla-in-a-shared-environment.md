...
configuration to verify that it is compatible with Scylla’s performance requirements. See [developer mode](https://opensource.docs.scylladb.com/branch-6.0/getting-started/installation-common/dev-mod.md) for more instructions.
