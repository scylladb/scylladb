...
[Jaeger Server](https://www.jaegertracing.io) is an open-source distributed tracing system, originally developed by Uber Technologies,
...
Jaeger Server [can also be run](https://github.com/jaegertracing/jaeger/tree/main/plugin/storage/scylladb) with ScyllaDB as the storage backend, thanks to ScyllaDB’s compatibility with Cassandra.
