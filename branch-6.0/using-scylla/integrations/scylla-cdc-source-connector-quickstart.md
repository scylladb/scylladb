...
a Scylla table using [Scylla CDC](https://opensource.docs.scylladb.com/branch-6.0/using-scylla/cdc/cdc-intro.md).
...
environments, please refer to the [Getting Started guide](https://opensource.docs.scylladb.com/branch-6.0/getting-started/index.md).
...
To learn more about Scylla CDC, visit [Change Data Capture (CDC) page](https://opensource.docs.scylladb.com/branch-6.0/using-scylla/cdc/index.md).
