...
* From SSTable to SSTable
  : - Using nodetool refresh, [Load and Stream](https://opensource.docs.scylladb.com/branch-6.0/operating-scylla/nodetool-commands/refresh.md#nodetool-refresh-load-and-stream) option.
    - On a large scale, it requires tooling to upload / transfer files from location to location.
* From SSTable to CQL.
  : - [sstableloader](https://opensource.docs.scylladb.com/branch-6.0/operating-scylla/admin-tools/sstableloader.md)
* From CQL to CQL
