...
of nodes in that datacenter. Alternatively, you can use `EverywhereReplicationStrategy`. See [How to Safely Increase the Replication Factor](https://opensource.docs.scylladb.com/branch-6.0/kb/rf-increase.md) for details on changing the RF.
...
<a id="tracing-probabilistic-tracing"></a>
...
When we use [Slow Query Logging](#slow-query-logging) trying to identify the source of high latencies due to heavy queueing, we have to deal with the problem of “collateral damage”.
...
New columns were added to [system_traces.sessions](#sessions-table-column-descriptions) (available from Scylla 3.0)

* `request_size`
* `response_size`

<a id="tracing-catching-a-hot-partition"></a>
...
<a id="tracing-collecting-tracing-data"></a>
...
If you are sending this data to Scylla for help, follow the directions in [How to Report a Scylla Problem](https://opensource.docs.scylladb.com/branch-6.0/troubleshooting/report-scylla-problem.md#report-performance-problem).
