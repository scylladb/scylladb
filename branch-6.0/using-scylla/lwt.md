...
* [How to Change gc_grace_seconds for a Table](https://opensource.docs.scylladb.com/branch-6.0/kb/gc-grace-seconds.md) - How to change the `gc_grace_seconds` parameter for a table
