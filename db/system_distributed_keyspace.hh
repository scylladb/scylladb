...
public:
    ...
    future<> insert_snapshot_sstable(sstring snapshot_name, sstring ks, sstring table, sstring dc, sstring rack, utils::UUID id, dht::token first_token, dht::token last_token, sstring prefix, uint64_t ttl_seconds);
