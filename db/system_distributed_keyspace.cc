...
<<<<<<< HEAD
||||||| parent of 2310f3fdf3 (db: extract snapshot_table_entry construction into a helper)
...
>>>>>>> 2310f3fdf3 (db: extract snapshot_table_entry construction into a helper)
} // namespace db
