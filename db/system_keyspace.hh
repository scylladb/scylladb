...
public:
    ...
    future<mutation> make_service_levels_driver_created_mutation(bool is_created, api::timestamp_type timestamp);
    future<std::optional<mutation>> get_service_levels_driver_created_mutation();
