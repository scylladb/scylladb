...
public:
    ...
    */
    ...
    future<> sstables_registry_create_entry(utils::UUID owner, sstring status, sstables::sstable_state state, sstables::entry_descriptor desc);
    future<> sstables_registry_update_entry_status(utils::UUID owner, sstables::generation_type gen, sstring status);
    future<> sstables_registry_update_entry_state(utils::UUID owner, sstables::generation_type gen, sstables::sstable_state state);
    future<> sstables_registry_delete_entry(utils::UUID owner, sstables::generation_type gen);
    using sstable_registry_entry_consumer = sstables::sstables_registry::entry_consumer;
    future<> sstables_registry_list(utils::UUID owner, sstable_registry_entry_consumer consumer);
