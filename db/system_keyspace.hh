...
public:
    ...
    static constexpr auto CDC_PENDING_STREAMS = "cdc_pending_streams";
    ...
    static schema_ptr cdc_pending_streams();
...
public:
    ...
    */
    ...
    future<cdc::base_streams_state> read_cdc_streams_state(table_id table);

    future<> read_cdc_streams_history(std::optional<table_id> table, noncopyable_function<future<>(table_id, db_clock::time_point, cdc::cdc_stream_diff)> f);

    future<cdc::pending_streams> read_cdc_pending_streams(table_id table);
