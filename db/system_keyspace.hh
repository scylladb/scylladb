...
struct system_keyspace_compaction_history_entry;
...
public:
    ...
    future<> update_compaction_history(system_keyspace_compaction_history_entry);
    using compaction_history_consumer = noncopyable_function<future<>(const system_keyspace_compaction_history_entry&)>;
