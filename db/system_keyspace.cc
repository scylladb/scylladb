...
future<service::group0_upgrade_state> system_keyspace::load_group0_upgrade_state() {
    ...
    if (!s || *s == "use_old_procedures") {
        co_return service::group0_upgrade_state::use_old_procedures;
    } else if (*s == "synchronize") {
        co_return service::group0_upgrade_state::synchronize;
    } else if (*s == "use_new_procedures") {
        co_return service::group0_upgrade_state::use_new_procedures;
    } else if (*s == "recovery") {
    ...
    slogger.error(
            ...
            " Correct values are: 'use_old_procedures', 'synchronize', 'use_new_procedures', 'recovery'."
            " Assuming 'recovery'.", *s);
...
future<> system_keyspace::save_group0_upgrade_state(service::group0_upgrade_state s) {
    auto value = [s] () constexpr {
        switch (s) {
            case service::group0_upgrade_state::use_new_procedures:
                return "use_new_procedures";
            ...
            case service::group0_upgrade_state::recovery:
                ...
                return "recovery";
            case service::group0_upgrade_state::use_old_procedures:
                // It should not be necessary to ever save this state, but handle the case anyway.
                return "use_old_procedures";
        }
