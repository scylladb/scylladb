...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , alternator_encryption_options(this, "alternator_encryption_options", value_status::Used, {/*none*/},
        ...
        "* enable_session_tickets: (Default: false) Enables or disables TLS1.3 session tickets.")
    , alternator_force_read_before_write(this, "alternator_force_read_before_write", liveness::LiveUpdate, value_status::Used, false, "Forces Alternator to perform Read Before Write. Used for accurate WCU calculation")
