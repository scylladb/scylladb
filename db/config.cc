...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , best_effort_to_removenode(this, "best_effort_to_removenode", liveness::LiveUpdate, value_status::Used, false, "Set true to perform removenode operations in best effort mode.")
