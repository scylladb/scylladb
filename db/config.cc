...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , bolt_instrumentation_dump_address(this, "bolt_instrumentation_dump_address", value_status::Used, "", "Address of BOLT's instrumentation runtime library dump function. Printed by BOLT after performing the instrumentation. For Scylla developer use only.")
