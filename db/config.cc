...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , sstable_compression_user_table_options(this, "sstable_compression_user_table_options", value_status::Used, compression_parameters{compression_parameters::algorithm::lz4_with_dicts},
        ...
        "Note: If sstable_compression is not explicitly set and sstable_compression_dictionaries_allow_in_ddl is disabled, the default automatically falls back to LZ4Compressor.\n"
