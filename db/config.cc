...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , write_consistency_levels_warned(this, "write_consistency_levels_warned", liveness::LiveUpdate, value_status::Used, "ANY, ONE, LOCAL_ONE", "A comma-separated list of consistency levels that will trigger a warning when used in write operations. Requests using these levels will not fail and the response will not contain a cql warning, but the write_consistency_levels_warned_violations metric will be incremented.")
