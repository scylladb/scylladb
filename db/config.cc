...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , replace_address(this, "replace_address", value_status::Deprecated, "", "[[deprecated]] The listen_address or broadcast_address of the dead node to replace. Same as -Dcassandra.replace_address.")
    , replace_address_first_boot(this, "replace_address_first_boot", value_status::Deprecated, "", "[[deprecated]] Like replace_address option, but if the node has been bootstrapped successfully it will be ignored. Same as -Dcassandra.replace_address_first_boot.")
