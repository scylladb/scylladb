...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , maintenance_io_throughput_mb_per_sec(this, "maintenance_io_throughput_mb_per_sec", liveness::LiveUpdate, value_status::Used, 0,
        ...
        "It is recommended to set the value for this parameter to be 75% of network bandwidth, so that the background activities do not saturate the network interface and interfere with the user workload.")
