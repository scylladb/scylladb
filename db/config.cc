...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , alternator_max_expression_cache_entries(this, "alternator_max_expression_cache_entries", liveness::LiveUpdate, value_status::Used, 0, "Maximum amount of entries in expression cache.")
