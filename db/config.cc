...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , alternator_describe_table_info_timeout_in_seconds(this, "alternator_describe_table_info_timeout_in_seconds", liveness::LiveUpdate, value_status::Used, 60 * 60 * 6,
        "The timeout for DescribeTable information - table size in bytes. This is how long calculated value will be reused before recalculation.")
