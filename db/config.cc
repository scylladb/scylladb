...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , compaction_max_shares(this, "compaction_max_shares", liveness::LiveUpdate, value_status::Used, 1000,
        "Set the maximum compaction shares to the specific value. Do not set this unless you know what you are doing and suspect a problem in the controller. This option will be retired when the controller reaches more maturity.")
