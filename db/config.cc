...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , high_disk_utilization_level(this, "high_disk_utilization_level", liveness::LiveUpdate, value_status::Used, 0.9,
        "Set the threshold of disk utilization level (between 0.0 - 1.0) above which out-of-space prevention logic kicks in. Do not set this unless you know what you are doing and suspect a problem in streaming.")
    , streaming_min_shares(this, "streaming_min_shares", liveness::LiveUpdate, value_status::Used, 200,
        "Set the minimum number of shares for the streaming/maintenance scheduling group controller, used below the `high_disk_utilization_level`. Do not set this unless you know what you are doing and suspect a problem in streaming. Note that this scheduling group is used for other background maintenance operations, like major compaction, repair, backup, and so on.")
    , streaming_max_shares(this, "streaming_max_shares", liveness::LiveUpdate, value_status::Used, 1000,
        "Set the maximum number of shares for the streaming/maintenance scheduling group controller. Streaming shares are increased linearly between minimum and maximum when disk utilization is above `high_disk_utilization_level`. Do not set this unless you know what you are doing and suspect a problem in streaming. Note that this scheduling group is used for other background maintenance operations, like major compaction, repair, backup, and so on.")
