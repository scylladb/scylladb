...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , alternator_streams_postmortem_interval_s(this, "alternator_streams_postmortem_interval_s", value_status::Used, 24*60*60, "The duration that streams remain accessible after Alternator is disabled on a table.")
