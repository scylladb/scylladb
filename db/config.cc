...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , gossip_endpoint_expiration_time(this, "gossip_endpoint_expiration_time", value_status::Used, 24 * 60 * 60 * 3, "Amount of time (in seconds) an unavailable node should be kept in gossip.")
