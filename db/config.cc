...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , recovery_leader(this, "recovery_leader", liveness::LiveUpdate, value_status::Used, "", "Host ID of the node restarted first while performing the Manual Raft Recovery Procedure")
