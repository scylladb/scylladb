...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , auto_scrub_period_seconds(this, "auto_scrub_period_seconds", liveness::LiveUpdate, value_status::Used, 0,
        "If set to a non-zero value, every sstable which was written or scrubbed more than this many seconds ago, will be scheduled for scrub. Set to 0 to disable automatic scrub.")
