...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , tablets_group0_leader_shard_ratio(this, "tablets_group0_leader_shard_ratio", liveness::LiveUpdate, value_status::Used, 100,
         ...
         "freeing it up for raft/topology work. 100 (default) is no skew; 0 shrinks shard 0's share to a minimum "
         "of roughly one tablet rather than excluding it. Values above 100 behave as 100 (disabled).")
