...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , materialized_views_rmw_admission(this, "materialized_views_rmw_admission", liveness::LiveUpdate, value_status::Used, true, "Controls if materialized views reads in rmw use admission control")
    , materialized_views_rmw_admission_fraction(this, "materialized_views_rmw_admission_fraction", liveness::MustRestart, value_status::Used, 1.0, "The fraction/multiplier for the materialized views concurrency relative to the read concurrency")
