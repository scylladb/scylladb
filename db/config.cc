...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , persistent_toppartitions_publish_interval_sec(this, "persistent_toppartitions_publish_interval", liveness::LiveUpdate, value_status::Used, 10, "Time interval, in seconds, to publish the toppartitions results to the logs.")
    ...
    , persistent_toppartitions_list_size(this, "persistent_toppartitions_list_size", liveness::LiveUpdate, value_status::Used, 20, "Controls how many partitions per shard will be shown in the toppartitions results.")
