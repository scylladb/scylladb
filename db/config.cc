...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    */
    ...
    , write_consistency_levels_warned(this, "write_consistency_levels_warned", liveness::LiveUpdate, value_status::Used, {}, "A comma-separated list of consistency levels that will trigger a warning when used in write operations.")
