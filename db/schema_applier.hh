...
class schema_applier {
    ...
    // Each is destroyed on its shard: explicitly by release_schema_change_commit_guards(), or by
    // foreign_ptr in the background should the applier go away without it.
