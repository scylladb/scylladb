...
void view_building_coordinator::generate_tablet_migration_updates(utils::chunked_vector<canonical_mutation>& out, const service::group0_guard& guard, const locator::shared_tablet_map& tmap, locator::global_tablet_id gid, const locator::tablet_transition_info& trinfo) {
...
void view_building_coordinator::generate_tablet_resize_updates(utils::chunked_vector<canonical_mutation>& out, const service::group0_guard& guard, table_id table_id, const locator::shared_tablet_map& old_tmap, const locator::shared_tablet_map& new_tmap) {
