...
private:
    ...
    future<> handle_create_view_local(const sstring& ks_name, const sstring& view_name, std::optional<view_builder_units> units);
    future<> handle_drop_view_local(const sstring& ks_name, const sstring& view_name, std::optional<view_builder_units> units);
