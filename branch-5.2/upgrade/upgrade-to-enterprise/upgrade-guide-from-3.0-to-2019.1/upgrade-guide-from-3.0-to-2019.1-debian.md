...
* More on [Scylla Metrics Update - Scylla 3.0 to 2019.1](https://opensource.docs.scylladb.com/branch-5.2/upgrade/upgrade-to-enterprise/upgrade-guide-from-3.0-to-2019.1/metric-update-3.0-to-2019.1.md)
