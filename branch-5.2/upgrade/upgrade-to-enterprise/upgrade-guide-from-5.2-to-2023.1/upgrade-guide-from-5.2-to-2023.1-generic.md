...
1. Remove the old repo file.
   ...
   > ```
2. Update the ScyllaDB deb repo ([Debian](http://www.scylladb.com/download/?platform=debian-10&version=scylla-5.3), [Ubuntu](https://www.scylladb.com/download/?platform=ubuntu-20.04&version=scylla-5.2)) to 5.2.
3. Install:
   > ```default
   > sudo apt-get update
...
Restore all tables of **system** and **system_schema** from the previous snapshot because 2023.1 uses a different set of system tables. See [Restore from a Backup and Incremental Backup](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/procedures/backup-restore/restore.md) for reference.
