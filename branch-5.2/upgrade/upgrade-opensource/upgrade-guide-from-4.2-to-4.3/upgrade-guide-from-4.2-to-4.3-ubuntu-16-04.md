# Upgrade Guide - Scylla 4.2 to 4.3 for Ubuntu 16.04
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=ubuntu-16.04&version=scylla-4.3) to 4.2
2. install
