...
Before upgrading, check what version you are running now using `rpm -qa | grep scylla-server`. You should use the same version in case you want to [rollback](#upgrade-2-1-2-2-rpm-rollback-procedure) the upgrade. If you are not running a 2.1.x version, stop right here! This guide only covers 2.1.x to 2.2.y upgrades.
...
<a id="upgrade-2-1-2-2-rpm-rollback-procedure"></a>
