...
case you want to
[rollback](#upgrade-1-3-1-4-rpm-rollback-procedure) the
upgrade. If you are not running a 1.3.x version, stop right here! This
guide only covers 1.3.x to 1.4.y upgrades.

To upgrade:

1. Update the [Scylla RPM repo](http://www.scylladb.com/download/centos_rpm) to
   **1.4**
2. install
...
<a id="upgrade-1-3-1-4-rpm-rollback-procedure"></a>
