...
Before upgrading, check what version you are running now using `dpkg -s scylla-server`. You should use the same version in case you want to [rollback](#upgrade-1-4-1-5-ubuntu-rollback-procedure) the upgrade. If you are not running a 1.4.x version, stop right here! This guide only covers 1.4.x to 1.5.y upgrades.

To upgrade:

1. Update the [Scylla deb repo](http://www.scylladb.com/download/#fndtn-deb) to **1.5**
2. Install
...
<a id="upgrade-1-4-1-5-ubuntu-rollback-procedure"></a>
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/#fndtn-deb) to **1.4**
2. install
