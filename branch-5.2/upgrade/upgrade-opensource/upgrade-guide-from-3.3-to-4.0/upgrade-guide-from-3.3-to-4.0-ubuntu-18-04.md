# Upgrade Guide - Scylla 3.3 to 4.0 for Ubuntu 18.04
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=ubuntu-18.04) to 4.0, and enable scylla/ppa repo
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=ubuntu-18.04) to 3.3
2. install
