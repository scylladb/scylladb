# Scylla Metric Update - Scylla 3.3 to 4.0

Scylla 4.0 Dashboards are available as part of the latest [Scylla Monitoring Stack](https://monitoring.docs.scylladb.com).

## The following metrics are new in Scylla 4.0
