# Upgrade Guide - Scylla 4.0 to 4.1 for Debian 9
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=debian-9) to 4.1, and enable scylla/ppa repo
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=debian-9) to 4.0
2. install
...
Restore all tables of **system** and **system_schema** from previous snapshot, 4.1 uses a different set of system tables. Reference doc: [Restore from a Backup and Incremental Backup](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/procedures/backup-restore/restore.md)
