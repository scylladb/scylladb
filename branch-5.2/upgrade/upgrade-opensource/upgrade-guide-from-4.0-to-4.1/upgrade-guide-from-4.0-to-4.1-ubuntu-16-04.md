# Upgrade Guide - Scylla 4.0 to 4.1 for Ubuntu 16.04
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=ubuntu-16.04) to 4.1, and enable scylla/ppa repo
...
1. Update the [Scylla deb repo](https://www.scylladb.com/download/?platform=ubuntu-16.04) to 4.0
2. install
