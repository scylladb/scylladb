# Upgrade Guide - Scylla 3.2 to 3.3 for Ubuntu 16.04
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=ubuntu-16.04) to 3.3, and enable scylla/ppa repo
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=ubuntu-16.04) to 3.2
2. install
