...
case you want to
[rollback](#upgrade-1-2-1-3-rpm-rollback-procedure) the
upgrade. If you are not running a 1.2.x version, stop right here! This
guide only covers 1.2.x to 1.3.y upgrades.

To upgrade:

1. Update the [Scylla RPM repo](http://www.scylladb.com/download/#fndtn-RPM) to
   **1.3**
2. install
...
<a id="upgrade-1-2-1-3-rpm-rollback-procedure"></a>
