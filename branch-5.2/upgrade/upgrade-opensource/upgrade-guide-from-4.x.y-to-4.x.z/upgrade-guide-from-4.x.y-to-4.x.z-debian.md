# Upgrade Guide - ScyllaDB 4.x.y to 4.x.z for Debian 9
...
Before upgrading, check what version you are running now using `dpkg -s scylla-server`. You should use the same version in case you want to [rollback](/upgrade/upgrade-opensource/upgrade-guide-from-4.x.y-to-4.x.z/upgrade-guide-from-4.x.y-to-4.x.z-debian/#rollback-procedure) the upgrade. If you are not running a 4.x.y version, stop right here! This guide only covers 4.x.y to 4.x.z upgrades.
