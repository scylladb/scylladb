# Upgrade Guide - Scylla 3.1 to 3.2 for Debian 9
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=debian-9) to 3.2, and enable scylla/ppa repo
...
1. Update the [Scylla deb repo](http://www.scylladb.com/download/?platform=debian-9) to 3.1
2. install
