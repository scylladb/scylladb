...
[Scylla Alternator for DynamoDB users](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md) document,
...
**alternator\_port** and **alternator\_write\_isolation**. For example in the
...
–alternator-write-isolation=only\_rmw\_uses\_lwt.

the **alternator\_port** option determines on which port Scylla listens for
...
**alternator\_address** option.

The meaning of the **alternator\_write\_isolation** option is explained in detail
...
use case and configure alternator\_write\_isolation accordingly. There is
...
In addition to (or instead of) serving HTTP requests on alternator\_port,
Scylla can accept DynamoDB API requests over HTTPS (encrypted), on the port
specified by **alternator\_https\_port**. As usual for HTTPS servers, the
...
* Scylla exposes lots of useful information via its internal system tables,
  ...
  in an error.
  Example: in order to query the contents of Scylla’s system.large\_rows,
  pass TableName=’.scylla.alternator.system.large\_rows’ to a Query/Scan request.
...
* [Getting Started With ScyllaDB Alternator](https://opensource.docs.scylladb.com/branch-5.2/alternator/getting-started.md)
  * [Installing ScyllaDB](https://opensource.docs.scylladb.com/branch-5.2/alternator/getting-started.md#installing-scylladb)
  * [Testing Scylla’s DynamoDB API support:](https://opensource.docs.scylladb.com/branch-5.2/alternator/getting-started.md#testing-scylla-s-dynamodb-api-support)
* [ScyllaDB Alternator for DynamoDB users](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md)
  * [Provisioning](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#provisioning)
  * [Scan ordering](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#scan-ordering)
  * [Load balancing](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#load-balancing)
  * [Write isolation policies](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#write-isolation-policies)
  * [Avoiding write reordering](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#avoiding-write-reordering)
  * [Authorization](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#authorization)
  * [Metrics](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#metrics)
  * [Time To Live (TTL)](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#time-to-live-ttl)
  * [Experimental API features](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#experimental-api-features)
  * [Unimplemented API features](https://opensource.docs.scylladb.com/branch-5.2/alternator/compatibility.md#unimplemented-api-features)
