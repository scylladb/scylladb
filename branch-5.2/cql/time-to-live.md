...
Refer to [LWT](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/lwt.md) for more information.

The `gc_grace_seconds` parameter is defined [here](https://opensource.docs.scylladb.com/branch-5.2/cql/ddl.md#create-table-general-options).

## TTL for a Collection

You can set the TTL on a per element basis for collections. An example of how to do this, is shown in the [Maps](https://opensource.docs.scylladb.com/branch-5.2/cql/types.md#maps) CQL Reference.
...
* [KB Article:How to Change gc_grace_seconds for a Table](https://opensource.docs.scylladb.com/branch-5.2/kb/gc-grace-seconds.md)
* [KB Article:Time to Live (TTL) and Compaction](https://opensource.docs.scylladb.com/branch-5.2/kb/ttl-facts.md)
