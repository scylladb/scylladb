...
If you need our help, please follow [How to Report a Performance Problem](https://opensource.docs.scylladb.com/branch-5.2/troubleshooting/report-scylla-problem.md) to share data securely.
...
Swap can be set up in several ways. One way to set up swap is detailed in the KB Article [How to Set up a Swap Space](https://opensource.docs.scylladb.com/branch-5.2/kb/set-up-swap.md).
...
If you are using a time range in the query, refer to the solution in the troubleshooting document, [Time Range Queries Do Not Return Some or All of the Data](https://opensource.docs.scylladb.com/branch-5.2/troubleshooting/time-zone.md).
...
As SI is built ontop of MV, you can expect to see MV in your schema. There is nothing wrong with your system. More information on [Global Secondary Indexes](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/secondary-indexes.md).
...
Check the [Operating System Support Guide](https://opensource.docs.scylladb.com/branch-5.2/getting-started/os-support.md) for a list of supported operating systems and versions.
...
The [new “mc” SSTable format](https://opensource.docs.scylladb.com/branch-5.2/architecture/sstable/sstable3/index.md) is supported in Scylla 3.0 and later.
...
- [Alter](https://opensource.docs.scylladb.com/branch-5.2/cql/ddl.md#alter-keyspace-statement) the replication factor for desired keyspace (using cqlsh for instance).
...
- If you’re increasing the replication factor, refer to [How to Safely Increase the RF](https://opensource.docs.scylladb.com/branch-5.2/kb/rf-increase.md)
...
function: it assists with gossip convergence. See [Scylla Seed Nodes](https://opensource.docs.scylladb.com/branch-5.2/kb/seed-nodes.md) for details.
...
You can, but it is not recommended. Scylla [clustering architecture](https://opensource.docs.scylladb.com/branch-5.2/architecture/ringarchitecture/index.md) already provides data replication across nodes and DCs.
...
Increase the Replication Factor (RF) of [relevant Keyspaces](https://opensource.docs.scylladb.com/branch-5.2/cql/ddl.md).

### Can I use JBOD and not use RAID0?

[JBOD](https://opensource.docs.scylladb.com/branch-5.2/glossary.md#term-JBOD) is not supported by Scylla.
...
When running [nodetool repair](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/nodetool-commands/repair.md) on a node, it performs a repair on every token range this node owns; this will also repair other nodes that share the same range.
...
or added to your `scylla.yaml` (see [Scylla Configuration](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/admin.md)).
...
It goes in and out of in-memory, as expected. This is [documented](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/in-memory.md#change-a-table-to-an-in-memory-table) in the Scylla Docs.
