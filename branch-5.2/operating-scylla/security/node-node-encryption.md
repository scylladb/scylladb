...
To build a self-signed certificate chain, see [generating a self-signed certificate chain using openssl](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/security/generate-certificate.md).
...
* [Invalid SSL Protocol Error](https://opensource.docs.scylladb.com/branch-5.2/troubleshooting/error-messages/invalid-ssl-prot-error.md)
