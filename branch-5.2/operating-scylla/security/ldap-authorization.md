...
Each role must already exist in Scylla, created via the [CREATE ROLE](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/security/authorization.md#create-role-statement) CQL command beforehand.
