...
1. Create a new cqlsh configuration file at `~/.cassandra/cqlshrc`, using the template below.
   ...
   [a self-signed certificate](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/security/generate-certificate.md), the `[ssl]` section will
...
2. Change the following parameters:
   ...
   | certfile         | Root certificate that was used to sign file specified with the `usercert` patameter | Applies to CA signed certificates                                        |
