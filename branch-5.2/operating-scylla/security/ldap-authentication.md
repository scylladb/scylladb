...
The general instructions are [here](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/security/saslauthd.md).

1. Follow all of the steps in [this procedure](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/security/saslauthd.md) and use the code snippets below to list LDAP as the authentication mechanism.
