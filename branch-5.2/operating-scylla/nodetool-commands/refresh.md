...
[Materialized Views (MV)](https://opensource.docs.scylladb.com/branch-5.2/cql/mv.md) and [Secondary Indexes (SI)](https://opensource.docs.scylladb.com/branch-5.2/cql/secondary-indexes.md) of the upload table, and if they exist, they are automatically updated. Uploading MV or SI SSTables is not required and will fail.
