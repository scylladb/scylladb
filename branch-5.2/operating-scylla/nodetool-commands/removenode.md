...
See [Remove a Node from a Scylla Cluster](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/procedures/cluster-management/remove-node.md) for more information.
...
#### Versionadded
Added in version version: 4.6 `--ignore-dead-nodes` option
