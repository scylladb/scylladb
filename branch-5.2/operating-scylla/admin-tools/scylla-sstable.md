...
For more information about the sstable components and the format itself, visit [SStable](/architecture/sstable).
...
The low-level API allows you to write custom JSON and it loosely follows the API of [rapidjson::Writer](https://rapidjson.org/classrapidjson_1_1_writer.html_) (upon which it is implemented).
