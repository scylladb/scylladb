...
In older versions, the tool is named [SSTable2json](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/admin-tools/sstable2json.md).
If you need more flexibility or want to dump more than just the data-component, see [scylla-sstable](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/admin-tools/scylla-sstable.md).
