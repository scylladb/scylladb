...
#### NOTE
Scylla and Apache Cassandra [encrypted backup files](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/security/encryption-at-rest.md) are **not** compatible.
...
* Update the SSTables files with [upgradesstable](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/nodetool-commands/upgradesstables.md)
* Use sstableloader
...
#### NOTE
Scylla Open Source 3.0 and later and Scylla Enterprise 2019.1 and later support [Materialized View(MV)](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/materialized-views.md) and [Secondary Index(SI)](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/secondary-indexes.md).
...
* Upload all the data with sstableloader first, and only then [create the secondary indexes](https://opensource.docs.scylladb.com/branch-5.2/cql/secondary-indexes.md#create-index-statement) and [MVs](https://opensource.docs.scylladb.com/branch-5.2/cql/mv.md#create-materialized-view-statement).
...
More on [Scylla and Apache Cassandra Compatibility](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/cassandra-compatibility.md)
