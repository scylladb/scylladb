...
When a Replication Factor (RF) is increased, using the [ALTER KEYSPACE](https://opensource.docs.scylladb.com/branch-5.2/cql/ddl.md#alter-keyspace-statement) command, the data consistency is effectively dropped
...
* [Fault Tolerance](https://opensource.docs.scylladb.com/branch-5.2/architecture/architecture-fault-tolerance.md)
* [Set the RF (first time)](https://opensource.docs.scylladb.com/branch-5.2/cql/ddl.md#create-keyspace-statement)
* [Change the RF (increase or decrease)](https://opensource.docs.scylladb.com/branch-5.2/cql/ddl.md#alter-keyspace-statement)
