...
1. Copy the stack from the [system log](https://opensource.docs.scylladb.com/branch-5.2/getting-started/logging.md) and place it in a file (trace.txt, for example).
   ```none
