...
System configuration steps are performed automatically by the Scylla RPM and deb packages. For information on getting started with Scylla, see [Getting Started](https://opensource.docs.scylladb.com/branch-5.2/getting-started/index.md).
...
When installing Scylla, it is highly recommended to use the [scylla_setup](https://opensource.docs.scylladb.com/branch-5.2/getting-started/system-configuration.md) script.
...
Configuration for Scylla itself is in the [Scylla Configuration](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/admin.md#admin-scylla-configuration) section of the administration guide.
