...
configuration to verify that it is compatible with Scylla’s performance requirements. See [developer mode](https://opensource.docs.scylladb.com/branch-5.2/getting-started/install-scylla/dev-mod.md) for more instructions.
