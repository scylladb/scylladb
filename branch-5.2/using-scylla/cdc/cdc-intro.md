...
In versions prior to Scylla Open Source 4.3, CDC is an experimental feature and you need to enable it in order to use it. See [this procedure](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/admin.md#yaml-enabling-experimental-features).
...
* **Log Table** - this is the table associated to the base table which is created when CDC is enabled. Read about it in the [log table document](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/cdc/cdc-log-table.md).
...
[Scylla University: Change Data Capture (CDC) lesson](https://university.scylladb.com/courses/scylla-operations/lessons/change-data-capture-cdc/) -  Learn how to use CDC. Some of the topics covered are:
