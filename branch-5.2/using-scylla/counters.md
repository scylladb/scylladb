...
* Updates are **not** [idempotent](https://opensource.docs.scylladb.com/branch-5.2/glossary.md#term-Idempotent). In the case of a write failure, the client cannot safely retry the request.
...
* Read our [blog](http://www.scylladb.com/2017/04/04/counters/) on counters, or see the data type [description](https://opensource.docs.scylladb.com/branch-5.2/cql/types.md#counters).
