...
* Replication of row-level changes from Scylla using [Scylla CDC](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/cdc/cdc-intro.md). The connector replicates the following operations: `INSERT`, `UPDATE`, `DELETE` (single row deletes)
...
* [Scylla CDC Source Connector Quickstart](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/integrations/scylla-cdc-source-connector-quickstart.md)
