...
In releases prior to **Scylla 4.0** this feature is an **experimental** feature, to use it you must [enable the experimental status](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/admin.md#yaml-enabling-experimental-features).
...
* [How to Change gc_grace_seconds for a Table](https://opensource.docs.scylladb.com/branch-5.2/kb/gc-grace-seconds.md) - How to change the `gc_grace_seconds` parameter for a table
