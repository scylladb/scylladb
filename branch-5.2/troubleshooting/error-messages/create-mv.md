...
Failed to create [materialized view](https://opensource.docs.scylladb.com/branch-5.2/cql/mv.md) after node was removed from the cluster.
...
Scylla Open Source 4.3 and later and Scylla Enterprise 2021.1 and later are seedless. See [Scylla Seed Nodes](https://opensource.docs.scylladb.com/branch-5.2/kb/seed-nodes.md) for details.
...
To verify that the node wasn’t remove properly use the [nodetool gossipinfo](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/nodetool-commands/gossipinfo.md) command
