...
2. Refer to [generate core dumps](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/admin.md#admin-core-dumps) for details.
...
* The contents of your tracing data. See [Collecting Tracing Data](https://opensource.docs.scylladb.com/branch-5.2/using-scylla/tracing.md#tracing-collecting-tracing-data).
