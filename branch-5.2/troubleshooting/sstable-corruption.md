...
When there is an unknown problem, checking the [logs](https://opensource.docs.scylladb.com/branch-5.2/getting-started/logging.md) is mandatory, using `journalctl -xe`
...
2. Run the [nodetool repair](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/nodetool-commands/repair.md) command on the node with the corrupted SSTable
