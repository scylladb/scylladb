...
Partitions that are bigger than the size threshold and/or hold more than the rows count threshold are reported in the `system.large_partitions` table and generate a warning in the Scylla log (refer to [log](https://opensource.docs.scylladb.com/branch-5.2/getting-started/logging.md)).
