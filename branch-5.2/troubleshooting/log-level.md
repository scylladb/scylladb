...
Alternatively, you can use Nodetool commands. Refer to [setlogginglevel](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/nodetool-commands/setlogginglevel.md) to set the logging level threshold for Scylla classes.
...
[Nodetool setlogginglevel](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/nodetool-commands/setlogginglevel.md)
