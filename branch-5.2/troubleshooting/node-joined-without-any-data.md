...
The scenario constitutes a user error and is the incorrect way of adding new nodes to the cluster. See [Adding New Node](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/procedures/cluster-management/add-node-to-cluster.md) for more details. This article explains how to restore a cluster safely in such a case.
...
3. Once all the new nodes are decommissioned, add them again with the [correct procedure](https://opensource.docs.scylladb.com/branch-5.2/operating-scylla/procedures/cluster-management/add-node-to-cluster.md).
