...
public:
    ...
    static bool is_quantization_enabled(const index_options_map& properties);
    static std::optional<float> get_rescoring_factor(const index_options_map& properties);
private:
