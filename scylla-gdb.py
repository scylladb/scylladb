...
def find_sstables():
    ...
    for sst in intrusive_list(user_sstables_manager["_active"], link='_manager_link'):
        yield sst.address
    for sst in intrusive_list(system_sstables_manager["_active"], link='_manager_link'):
        yield sst.address
