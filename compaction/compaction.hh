...
// Splits a single new SSTable by segregating all its data according to the classifier.
// Its usage must be restricted to new SSTables not loaded into the table yet.
