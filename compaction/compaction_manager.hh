...
public:
    ...
    const std::vector<sstables::compaction_info> get_compactions(std::function<bool(const compaction_group_view*)> filter) const;
    ...
    future<> stop_compaction(sstring type, std::function<bool(const compaction_group_view*)> filter);
