...
private:
    ...
    future<compaction_manager::compaction_stats_opt> perform_task_on_all_files(tasks::task_info info, compaction_group_view& t, sstables::compaction_type_options options, owned_ranges_ptr owned_ranges_ptr, get_candidates_func get_func, Args... args);
...
public:
    ...
    future<compaction_reenabler> stop_and_disable_compaction(compaction::compaction_group_view& t);

    // Run a function with compaction temporarily disabled for a table T.
    future<> run_with_compaction_disabled(compaction::compaction_group_view& t, std::function<future<> ()> func);
