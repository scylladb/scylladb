...
std::vector<sstables::shared_sstable> compaction_manager::get_candidates(const replica::table& t) {
    return get_non_compacting_sstables(t.in_strategy_sstables());
}

std::vector<sstables::shared_sstable> compaction_manager::get_non_compacting_sstables(const std::vector<sstables::shared_sstable>& sstables) {
