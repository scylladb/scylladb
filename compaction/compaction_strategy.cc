...
compaction_descriptor compaction_strategy::get_sstables_for_compaction(table_state& table_s, strategy_control& control, repair::sstables_repair_state repair_state) {
    return _compaction_strategy_impl->get_sstables_for_compaction(table_s, control, repair_state);
}
