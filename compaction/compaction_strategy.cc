...
public:
    virtual compaction_descriptor get_sstables_for_compaction(table_state_view tsv, strategy_control& control) override {
...
compaction_descriptor compaction_strategy::get_sstables_for_compaction(table_state_view tsv, strategy_control& control) {
    return _compaction_strategy_impl->get_sstables_for_compaction(tsv, control);
}
