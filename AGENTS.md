...
- `skills/unflake-test/SKILL.md` — fix flaky tests: diagnosis, 20 fix strategies with commit examples, verification
...
- **If diagnosing or fixing a flaky test**: also read `skills/unflake-test/SKILL.md`
