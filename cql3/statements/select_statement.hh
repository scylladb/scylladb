...
protected:
    ...
    static uint64_t get_inner_loop_limit(const select_statement::get_limit_result& limit, const query_options& options,
       const expr::unset_bind_variable_guard& unset_guard, bool is_aggregate);
