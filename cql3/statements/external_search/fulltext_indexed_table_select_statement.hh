...
/// Replaces every BM25(), BM25_SCORE(), BM25_RANK() and BM25_HIGHLIGHT() call in the SELECT clause,
/// nested occurrences included, with a read of the temporary holding that value, allocating the temporary
