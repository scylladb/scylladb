...
functions::get(data_dictionary::database db,
    ...
    if (name.has_keyspace()
        ...
        auto fun = ::make_shared<similarity_cosine_fct>(arg_types);
    ...
    if (name.has_keyspace()
        ...
        auto arg_types = vector_similarity_fct::provide_arg_types(name, provided_args, db);
        auto fun = ::make_shared<similarity_euclidean_fct>(arg_types);
        validate_types(db, keyspace, schema.get(), fun, provided_args, receiver_ks, receiver_cf);
        return fun;
    }
    ...
    if (name.has_keyspace()
        ...
        auto arg_types = vector_similarity_fct::provide_arg_types(name, provided_args, db);
        auto fun = ::make_shared<similarity_dot_product_fct>(arg_types);
        validate_types(db, keyspace, schema.get(), fun, provided_args, receiver_ks, receiver_cf);
        return fun;
    }
