...
float vector_similarity_fct::find_matching_distance() {
    statements::primary_key row_primary_key =
            statements::primary_key{dht::decorated_key{dht::get_token(*_schema, *_row_partition_key), *_row_partition_key}, *_row_clustering_key};
...
void vector_similarity_fct::validate_similarity_function() {
    ...
    std::string similarity_function = similarity_function_it != vector_index_options.end() ? similarity_function_it->second : "cosine";
