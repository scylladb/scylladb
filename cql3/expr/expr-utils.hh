...
// Whether the call resolved to a function that declared itself external, meaning the statement has
// to deal with it while preparing; see db::functions::function::is_external(). An unresolved call
// holds a name rather than a function, and is reported as not external.
