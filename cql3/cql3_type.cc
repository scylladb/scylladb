...
thread_local shared_ptr<cql3_type> native_cql3_type::double_ = make("double", double_type, native_cql3_type::kind::DOUBLE);
thread_local shared_ptr<cql3_type> native_cql3_type::float_ = make("float", float_type, native_cql3_type::kind::FLOAT);
