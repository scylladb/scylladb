...
query_processor::execute_forwarding_statement(const cql3::statements::strongly_consistent_statement& stmt, service::query_state& query_state, const query_options& options) {
    auto [remote_, holder] = remote();
