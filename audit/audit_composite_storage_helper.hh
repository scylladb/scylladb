...
public:
    explicit audit_composite_storage_helper(const std::vector<sstring>& storage_helper_class_names, cql3::query_processor&, service::migration_manager&);
    virtual ~audit_composite_storage_helper();
