...
public:
    ...
    token_bound get_token_bound() const {
        // Mirrors ring_position_view::get_token_bound(): after_all_keys_weight means "end".
        return token_bound(_weight == ring_position_view::after_all_keys_weight ? 1 : _weight);
    }
