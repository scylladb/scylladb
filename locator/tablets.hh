...
struct load_stats {
    ...
    // - if the tablet is in migration, the tablet will be searched on the pending replica
    // - if the tablet is being rebuilt, we will return the average tablet size of all the pending replicas
