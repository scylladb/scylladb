...
private:
    ...
    void update_colocated_tables_for_existing_table(table_id id, std::optional<table_id> base_table_before, std::optional<table_id> base_table_after);
    void update_colocated_tables_for_new_table(table_id id, std::optional<table_id> base_table);
    void update_colocated_tables_for_dropped_table(table_id id, std::optional<table_id> base_table);
