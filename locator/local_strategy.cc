...
inet_address_vector_replica_set local_strategy::do_get_natural_endpoints(token t, const token_metadata& tm, can_yield can_yield) {
    return calculate_natural_endpoints(t, tm, can_yield);
}

inet_address_vector_replica_set local_strategy::calculate_natural_endpoints(token t, const token_metadata& tm, can_yield) const {
