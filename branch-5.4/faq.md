...
If you need our help, please follow [How to Report a Performance Problem](https://opensource.docs.scylladb.com/branch-5.4/troubleshooting/report-scylla-problem.md) to share data securely.
...
Swap can be set up in several ways. One way to set up swap is detailed in the KB Article [How to Set up a Swap Space](https://opensource.docs.scylladb.com/branch-5.4/kb/set-up-swap.md).
...
If you are using a time range in the query, refer to the solution in the troubleshooting document, [Time Range Queries Do Not Return Some or All of the Data](https://opensource.docs.scylladb.com/branch-5.4/troubleshooting/time-zone.md).
...
As SI is built ontop of MV, you can expect to see MV in your schema. There is nothing wrong with your system. More information on [Global Secondary Indexes](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/secondary-indexes.md).
...
Check the [Operating System Support Guide](https://opensource.docs.scylladb.com/branch-5.4/getting-started/os-support.md) for a list of supported operating systems and versions.

* On a docker node: `$ docker exec -it Node_Z scylla --version`

### Is Scylla Apache Cassandra compatible? Is API / interface X compatible?

See [ScyllaDB and Apache Cassandra Compatibility](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/cassandra-compatibility.md) for compatibility matrix.

### Which version(s) of Apache Cassandra is Scylla compatible with? Will Scylla be compatible with future Cassandra versions?

See [ScyllaDB and Apache Cassandra Compatibility](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/cassandra-compatibility.md) for current and future Apache Cassandra release compatibility.
...
The [new “mc” SSTable format](https://opensource.docs.scylladb.com/branch-5.4/architecture/sstable/sstable3/index.md) is supported in Scylla 3.0 and later.
...
- [Alter](https://opensource.docs.scylladb.com/branch-5.4/cql/ddl.md#alter-keyspace-statement) the replication factor for desired keyspace (using cqlsh for instance).
...
- If you’re increasing the replication factor, refer to [How to Safely Increase the RF](https://opensource.docs.scylladb.com/branch-5.4/kb/rf-increase.md)
...
function: it assists with gossip convergence. See [Scylla Seed Nodes](https://opensource.docs.scylladb.com/branch-5.4/kb/seed-nodes.md) for details.
...
You can, but it is not recommended. Scylla [clustering architecture](https://opensource.docs.scylladb.com/branch-5.4/architecture/ringarchitecture/index.md) already provides data replication across nodes and DCs.
...
Increase the Replication Factor (RF) of [relevant Keyspaces](https://opensource.docs.scylladb.com/branch-5.4/cql/ddl.md).

### Can I use JBOD and not use RAID0?

[JBOD](https://opensource.docs.scylladb.com/branch-5.4/reference/glossary.md#term-JBOD) is not supported by Scylla.
...
When running [nodetool repair](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/nodetool-commands/repair.md) on a node, it performs a repair on every token range this node owns; this will also repair other nodes that share the same range.
...
or added to your `scylla.yaml` (see [Scylla Configuration](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md)).
