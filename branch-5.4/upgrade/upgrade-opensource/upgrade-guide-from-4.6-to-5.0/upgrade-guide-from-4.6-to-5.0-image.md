...
* Download and install the new ScyllaDB release for Ubuntu. See
  the [upgrade guide for Ubuntu 20.04](https://opensource.docs.scylladb.com/branch-5.4/upgrade/upgrade-opensource/upgrade-guide-from-4.6-to-5.0/upgrade-guide-from-4.6-to-5.0-ubuntu-20-04.md)
  for instructions.
