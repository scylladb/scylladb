...
* Longer latencies on a single shard (look at the “Scylla Overview Metrics” dashboard of [ScyllaDB Monitoring Stack](https://monitoring.docs.scylladb.com/stable/)).
...
Partitions that are bigger than the size threshold and/or hold more than the rows count threshold are reported in the `system.large_partitions` table and generate a warning in the Scylla log (refer to [log](https://opensource.docs.scylladb.com/branch-5.4/getting-started/logging.md)).
...
[Troubleshoot](https://opensource.docs.scylladb.com/branch-5.4/troubleshooting/index.md)

## Additional Resources

[Large Partitions Hunting](https://opensource.docs.scylladb.com/branch-5.4/troubleshooting/debugging-large-partition.md)
