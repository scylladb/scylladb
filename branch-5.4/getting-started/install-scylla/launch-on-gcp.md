...
1. Choose an instance type. See [Cloud Instance Recommendations for GCP](https://opensource.docs.scylladb.com/branch-5.4/getting-started/cloud-instance-recommendations.md#system-requirements-gcp) for the list of recommended instances.

   Other instance types will work, but with lesser performance. If you choose an instance type other than the recommended ones, make sure to run the [scylla_setup](https://opensource.docs.scylladb.com/branch-5.4/getting-started/system-configuration.md#system-configuration-scripts) script.
2. Go to [ScyllaDB for GCP](https://www.scylladb.com/download/?platform=gcp#open-source) in ScyllaDB’s download center to obtain the image information:
   * image name
   * image id
   * project name
...
4. (Optional) Configure firewall rules.
   ...
   Ensure that all [ScyllaDB ports](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/security-checklist.md#networking-ports) are open.
...
* [Configure ScyllaDB](https://opensource.docs.scylladb.com/branch-5.4/getting-started/system-configuration.md)
...
* Get familiar with ScyllaDB’s [command line reference guide](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/nodetool.md).
