...
specify a Consistency Level per query is known as [Tunable Consistency](https://opensource.docs.scylladb.com/branch-5.4/reference/glossary.md#term-Tunable-Consistency).
...
* [Jepsen and ScyllaDB: Putting Consistency to the Test blog post](hhttps://www.scylladb.com/2020/12/23/jepsen-and-scylla-putting-consistency-to-the-test/)
