...
If you need text result of this query as a single run, without the page delimiter, you can [turn off paging](https://opensource.docs.scylladb.com/branch-5.4/cql/cqlsh.md#cqlsh-paging).
