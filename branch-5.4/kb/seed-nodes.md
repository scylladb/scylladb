...
In Scylla releases older than Scylla Open Source 4.3 and Scylla Enterprise 2021.1, seed node has one more function: it assists with [gossip](https://opensource.docs.scylladb.com/branch-5.4/kb/gossip.md) convergence.
