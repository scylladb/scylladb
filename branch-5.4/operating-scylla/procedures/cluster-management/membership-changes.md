...
Scylla guarantees that [LWT Operations](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/lwt.md) will be strictly serializable during a single membership change. Parallel membership changes will violate this guarantee.
