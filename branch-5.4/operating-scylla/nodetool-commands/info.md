...
| Native<br/>Transp<br/>ort<br/>active | Native Transport status (CQL)                                                                                                                    |
...
| Uptime<br/>(secon<br/>ds)            | Node Uptime since last restart                                                                                                                   |
| Heap<br/>Memory<br/>(MB)             | Not applicabl e with Scylla                                                                                                                      |
...
| Except<br/>ions                      | Not applicable with Scylla                                                                                                                       |
| Key<br/>Cache                        | Not applicable with Scylla                                                                                                                       |
| Row<br/>Cache                        | Row Cache usage                                                                                                                                  |
| Counter<br/>Cache                    | Not applicable with Scylla                                                                                                                       |
