...
1. If you want to create users and roles, continue to [Enable Authorization](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/enable-authorization.md).

## Additional Resources

* [Enable and Disable Authentication Without Downtime](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/runtime-authentication.md)
* [Enable Authorization](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/enable-authorization.md)
