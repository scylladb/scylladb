...
To build a self-signed certificate chain, see [generating a self-signed certificate chain using openssl](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/generate-certificate.md).
...
* [Encryption Data in Transit Client to Node](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/client-node-encryption.md)
* [Generating a self-signed Certificate Chain Using openssl](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/generate-certificate.md)
* [Authorization](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/authorization.md)
* [Invalid SSL Protocol Error](https://opensource.docs.scylladb.com/branch-5.4/troubleshooting/error-messages/invalid-ssl-prot-error.md)
