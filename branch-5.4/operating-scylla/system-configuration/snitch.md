...
<a id="snitch-rack-inferring-snitch"></a>
...
<a id="snitch-gossiping-property-file-snitch"></a>
...
|   Node number | Parameter to add to the specific node’s /etc/scylla/cassandra-rackdc.properties   |
|---------------|-----------------------------------------------------------------------------------|
|             1 | dc_suffix=_dc1-europe                                                             |
|             2 | dc_suffix=_dc1-europe                                                             |
|             3 | dc_suffix=_dc2-asia                                                               |
|             4 | dc_suffix=_dc2-asia                                                               |
|             5 | dc_suffix=_dc3-australia                                                          |
...
<a id="snitch-ec2-multi-region-snitch"></a>
...
This setting allows nodes from other zones to communicate with the node regardless of what is configured in the node’s [scylla.yaml](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md) configuration file for `broadcast_address` and `broadcast_rpc_address` parameters.
...
To use the GoogleCloudSnitch, add the snitch name to the [scylla.yaml](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md) file, which is located in the `/etc/scylla/` directory for **all nodes** in the cluster.
...
After creating the instances on GCE, edit the [scylla.yaml](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md) file to select the GoogleCloudSnitch.
...
To use the AzureSnitch, add the snitch name to the [scylla.yaml](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md) file, which is located in the `/etc/scylla/` directory, for **all nodes** in the cluster:
...
After creating the instances on Azure, edit the [scylla.yaml](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md) file to select the AzureSnitch.
