...
Make sure you have met the [System Requirements](https://opensource.docs.scylladb.com/branch-5.4/getting-started/system-requirements.md)  before you install and configure Scylla.

## Download and Install

See the [getting started page](https://opensource.docs.scylladb.com/branch-5.4/getting-started/index.md) for info on installing Scylla on your platform.

## System configuration

See [System Configuration Guide](https://opensource.docs.scylladb.com/branch-5.4/getting-started/system-configuration.md#system-configuration-files-and-scripts) for details on optimum OS settings for Scylla. (These settings are performed automatically in the Scylla packages, Docker containers, and Amazon AMIs.)
...
This command allows you to check your current version of Scylla. Note that this command is not the [nodetool version](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/nodetool-commands/version.md) command which reports the CQL version.
If you are looking for the CQL or Cassandra version, refer to the CQLSH reference for [SHOW VERSION](https://opensource.docs.scylladb.com/branch-5.4/cql/cqlsh.md#cqlsh-show-version).
...
| replace_node_first_boot | Host ID of a dead node this Scylla node is replacing. Refer to [Replace a Dead Node in a Scylla Cluster](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/procedures/cluster-management/replace-dead-node.md) for more details. |
...
To read the rest of the [Administration Guide](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md) (from the top).

To go to the System Configuration documentation, click [here](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/system-configuration/index.md).
...
Refer to the [Drivers Page](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/index.md) for more drivers.
...
Scylla versions 1.1 and greater support encryption between nodes and between client and node. See the Scylla [Scylla TLS/SSL guide:](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/security/index.md) for configuration settings.
...
#### NOTE
For tips and examples on how to configure these addresses, refer to [How to Properly Set Address Values in scylla.yaml](https://opensource.docs.scylladb.com/branch-5.4/kb/yaml-address.md)
...
Scylla places any core dumps in `var/lib/scylla/coredump`. They are not visible with the `coredumpctl` command. See the [System Configuration Guide](https://opensource.docs.scylladb.com/branch-5.4/getting-started/system-configuration.md) for details on core dump configuration scripts. Check with Scylla support before sharing any core dump, as they may contain sensitive data.
...
The [nodetool](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/nodetool.md) CLI tool interacts with a *scylla-jmx* process using JMX.
