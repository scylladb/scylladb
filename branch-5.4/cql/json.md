...
Scylla introduces JSON support to [SELECT](https://opensource.docs.scylladb.com/branch-5.4/cql/dml/select.md#select-statement) and [INSERT](https://opensource.docs.scylladb.com/branch-5.4/cql/dml/insert.md#insert-statement)
...
| `decimal`   | integer, float, string | float           | May exceed 32 or 64-bit IEEE-754 floating point precision in<br/>client-side decoder                                                                                                                                 |
...
| `timestamp` | integer, string        | string          | A timestamp. Strings constant allows to input [timestamps<br/>as dates](https://opensource.docs.scylladb.com/branch-5.4/cql/types.md#timestamps). Datestamps with format `YYYY-MM-DD<br/>HH:MM:SS.SSS` are returned. |
...
| `varint`    | integer, string        | integer         | Variable length; may overflow 32 or 64 bit integers in<br/>client-side decoder                                                                                                                                       |
