...
If you want to display your current ScyllaDB version, refer to [Check your current version of Scylla](https://opensource.docs.scylladb.com/branch-5.4/operating-scylla/admin.md#check-your-current-version-of-scylla).
...
CQLSH [lesson](https://university.scylladb.com/courses/data-modeling/lessons/basic-data-modeling-2/topic/cql-cqlsh-and-basic-cql-syntax/) on Scylla University

* [Apache Cassandra Query Language (CQL) Reference](https://opensource.docs.scylladb.com/branch-5.4/cql/index.md)

[Back](https://opensource.docs.scylladb.com/branch-5.4/getting-started/index.md)
