...
[Scylla Alternator for DynamoDB users](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md) document,
...
by configuring the **auto\_snapshot** option to `false`.
...
* [Getting Started With ScyllaDB Alternator](https://opensource.docs.scylladb.com/branch-5.4/alternator/getting-started.md)
  * [Installing ScyllaDB](https://opensource.docs.scylladb.com/branch-5.4/alternator/getting-started.md#installing-scylladb)
  * [Testing Scylla’s DynamoDB API support:](https://opensource.docs.scylladb.com/branch-5.4/alternator/getting-started.md#testing-scylla-s-dynamodb-api-support)
* [ScyllaDB Alternator for DynamoDB users](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md)
  * [Provisioning](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#provisioning)
  * [Scan ordering](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#scan-ordering)
  * [Load balancing](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#load-balancing)
  * [Write isolation policies](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#write-isolation-policies)
  * [Avoiding write reordering](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#avoiding-write-reordering)
  * [Authorization](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#authorization)
  * [Metrics](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#metrics)
  * [Time To Live (TTL)](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#time-to-live-ttl)
  * [Experimental API features](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#experimental-api-features)
  * [Unimplemented API features](https://opensource.docs.scylladb.com/branch-5.4/alternator/compatibility.md#unimplemented-api-features)
