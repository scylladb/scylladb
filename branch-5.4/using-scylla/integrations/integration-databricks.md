...
Scylla is Apache Cassandra compatible at the CQL binary protocol level, and any driver which uses CQL will work with Scylla (more [here](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/index.md)). Any application which uses a CQL driver will work with Scylla, for example, Databricks Spark cluster.
