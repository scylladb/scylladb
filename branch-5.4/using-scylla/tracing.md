...
of nodes in that datacenter. Alternatively, you can use `EverywhereReplicationStrategy`. See [How to Safely Increase the Replication Factor](https://opensource.docs.scylladb.com/branch-5.4/kb/rf-increase.md) for details on changing the RF.
...
If you are sending this data to Scylla for help, follow the directions in [How to Report a Scylla Problem](https://opensource.docs.scylladb.com/branch-5.4/troubleshooting/report-scylla-problem.md#report-performance-problem).
