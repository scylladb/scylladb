...
* **Log Table** - this is the table associated to the base table which is created when CDC is enabled. Read about it in the [log table document](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/cdc/cdc-log-table.md).
...
[Scylla University: Change Data Capture (CDC) lesson](https://university.scylladb.com/courses/data-modeling/lessons/change-data-capture-cdc/) -  Learn how to use CDC. Some of the topics covered are:
