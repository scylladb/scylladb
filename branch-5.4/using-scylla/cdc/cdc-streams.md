...
* the currently operating *CDC generation* ([CDC Stream Generations](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/cdc/cdc-stream-generations.md)),
