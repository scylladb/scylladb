...
The following is an example and does not contain all of the options available. To see all of the options available, refer to the [CQL Reference](https://opensource.docs.scylladb.com/branch-5.4/cql/secondary-indexes.md).
...
* [Local Secondary Indexes](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/local-secondary-indexes.md)
* [CQL Reference](https://opensource.docs.scylladb.com/branch-5.4/cql/secondary-indexes.md) - CQL Reference for Secondary Indexes
