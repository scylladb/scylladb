...
or include a library for [CDC](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/cdc/cdc-intro.md).

|                                                                                                                          | ScyllaDB Driver                                           | CDC Connector                                              |
|--------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------|------------------------------------------------------------|
| [Python](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/cql-drivers/scylla-python-driver.md)       | <i class="inline-icon icon-check" aria-hidden="true"></i> | <i class="inline-icon icon-cancel" aria-hidden="true"></i> |
| [Java](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/cql-drivers/scylla-java-driver.md)           | <i class="inline-icon icon-check" aria-hidden="true"></i> | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| [Go](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/cql-drivers/scylla-go-driver.md)               | <i class="inline-icon icon-check" aria-hidden="true"></i> | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
| [Go Extension](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/cql-drivers/scylla-gocqlx-driver.md) | <i class="inline-icon icon-check" aria-hidden="true"></i> | <i class="inline-icon icon-cancel" aria-hidden="true"></i> |
| [C++](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/cql-drivers/scylla-cpp-driver.md)             | <i class="inline-icon icon-check" aria-hidden="true"></i> | <i class="inline-icon icon-cancel" aria-hidden="true"></i> |
| [Rust](https://opensource.docs.scylladb.com/branch-5.4/using-scylla/drivers/cql-drivers/scylla-rust-driver.md)           | <i class="inline-icon icon-check" aria-hidden="true"></i> | <i class="inline-icon icon-check" aria-hidden="true"></i>  |
...
* [Rust](https://github.com/AlexPikalov/cdrs)
