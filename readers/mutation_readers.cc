...
public:
    compacting_reader(mutation_reader source, gc_clock::time_point compaction_time,
        ...
        , _compactor(*_schema, compaction_time, get_max_purgeable, std::move(gc_before_getter))
...
mutation_reader make_compacting_reader(mutation_reader source, gc_clock::time_point compaction_time,
        max_purgeable_fn get_max_purgeable,
        tombstone_gc_before_getter gc_before_getter, streamed_mutation::forwarding fwd) {
    return make_mutation_reader<compacting_reader>(std::move(source), compaction_time, get_max_purgeable, std::move(gc_before_getter), fwd);
}
