...
See [Enabling Experimental Features](https://opensource.docs.scylladb.com/stable/operating-scylla/admin.md#yaml-enabling-experimental-features) for details.
...
see [Counting all rows in a table is slow](https://opensource.docs.scylladb.com/stable/kb/count-all-rows.md) for instructions.
