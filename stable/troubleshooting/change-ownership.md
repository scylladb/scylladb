...
In cases where the ScyllaDB node fails to start, check ScyllaDB [logs](https://opensource.docs.scylladb.com/stable/getting-started/logging.md). If you see the following error message:
