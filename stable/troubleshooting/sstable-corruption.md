...
When there is an unknown problem, checking the [logs](https://opensource.docs.scylladb.com/stable/getting-started/logging.md) is mandatory, using `journalctl -xe`
...
2. Run the [nodetool repair](https://opensource.docs.scylladb.com/stable/operating-scylla/nodetool-commands/repair.md) command on the node with the corrupted SSTable
