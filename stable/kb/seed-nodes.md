...
#### NOTE
Seed nodes function was changed in ScyllaDB Open Source 4.3 and ScyllaDB Enterprise 2021.1; if you are running an older version, see [Older Version Of ScyllaDB](#seeds-older-versions).
...
In ScyllaDB releases older than ScyllaDB Open Source 4.3 and ScyllaDB Enterprise 2021.1, seed node has one more function: it assists with [gossip](https://opensource.docs.scylladb.com/stable/kb/gossip.md) convergence.
