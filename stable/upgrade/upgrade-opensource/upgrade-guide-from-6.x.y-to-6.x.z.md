...
and Ubuntu. See [OS Support by Platform and Version](https://opensource.docs.scylladb.com/stable/getting-started/os-support.md) for
...
> ```console
> sudo apt-get install scylla=6.x.y\* scylla-server=6.x.y\* scylla-tools=6.x.y\* scylla-tools-core=6.x.y\* scylla-kernel-conf=6.x.y\* scylla-conf=6.x.y\*
