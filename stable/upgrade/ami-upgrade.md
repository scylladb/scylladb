...
instructions on the **Debian/Ubuntu** tab in the [upgrade guide](https://opensource.docs.scylladb.com/stable/upgrade/index.md)
...
in the [upgrade guide](https://opensource.docs.scylladb.com/stable/upgrade/index.md) for your ScyllaDB version.
