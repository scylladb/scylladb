...
See the [CQL Reference for Materialized Views](https://opensource.docs.scylladb.com/stable/cql/mv.md) for more examples.

## Compaction Strategies with Materialized Views

Materialized views, just like regular tables, use one of the available [compaction strategies](https://opensource.docs.scylladb.com/stable/architecture/compaction/compaction-strategies.md).
...
* [CQL Reference for Materialized Views](https://opensource.docs.scylladb.com/stable/cql/mv.md)
