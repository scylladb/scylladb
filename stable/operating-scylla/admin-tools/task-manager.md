...
See [Nodetool tasks](https://opensource.docs.scylladb.com/stable/operating-scylla/nodetool-commands/tasks/index.md).

To learn how to interact with REST API see [REST API](https://opensource.docs.scylladb.com/stable/operating-scylla/rest.md).
