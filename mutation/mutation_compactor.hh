...
private:
    ...
    max_purgeable::can_purge_result can_gc(tombstone t, is_shadowable is_shadowable) {
        ...
        auto ret = max_purgeable.can_purge(t, get_gc_before());
        mclog.debug("can_gc: t={} is_shadowable={} max_purgeable={}: can_purge={}, timestamp_source={}", t, is_shadowable, max_purgeable.timestamp(), ret.can_purge, ret.timestamp_source);
        return ret;
    };
