...
ar.reloc_add(f'build/{args.mode}/SCYLLA-RELEASE-FILE', arcname='SCYLLA-RELEASE-FILE')
ar.reloc_add(f'build/{args.mode}/SCYLLA-VERSION-FILE', arcname='SCYLLA-VERSION-FILE')
