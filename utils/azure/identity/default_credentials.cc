...
future<default_credentials::credentials_opt> default_credentials::get_credentials_from_env(const resource_type& resource_uri) {
    ...
    if (!creds_found) {
        ...
        az_creds_logger.info("[{}] Incomplete credentials. Both 'AZURE_TENANT_ID' and 'AZURE_CLIENT_ID', and at least one of 'AZURE_CLIENT_SECRET', 'AZURE_CLIENT_CERTIFICATE_PATH' must be provided. Currently:", *this);
        az_creds_logger.info("[{}] Tenant ID is {}set", *this, tenant_id ? "" : "NOT ");
        az_creds_logger.info("[{}] Client ID is {}set", *this, client_id ? "" : "NOT ");
        az_creds_logger.info("[{}] Client Secret is {}set", *this, client_secret ? "" : "NOT ");
        az_creds_logger.info("[{}] Client Certificate is {}set", *this, client_certificate_path ? "" : "NOT ");
        az_creds_logger.info("[{}] Authority host is {}set", *this, authority ? "" : "NOT ");
        co_return std::nullopt;
    }
