...
class alien_worker {
    ...
    std::thread spawn(seastar::logger&, int niceness, const seastar::sstring& name_sufix);
public:
    alien_worker(seastar::logger&, int niceness, const seastar::sstring& name_sufix);
    ~alien_worker();
