...
using approx_exponential_histogram = seastar::metrics::internal::approximate_exponential_histogram<Min, Max, Precision>;
 ...
 */
using time_estimated_histogram = seastar::metrics::internal::time_estimated_histogram;
