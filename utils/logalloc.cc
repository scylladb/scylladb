...
public:
    ...
    const segment_descriptor& descriptor(segment*) const;
...
segment_pool::descriptor(segment* seg) const {
    uintptr_t index = idx_from_segment(seg);
    return _segments[index];
}
...
public:
        ...
        , _debug_enabled(timing_logger.is_enabled(logging::log_level::debug))
    {
        ...
        _old_pool_stats = _tracker.segment_pool().statistics();
    }
...
private:
    ...
    void report() const noexcept {
        ...
        auto pool_stats = _tracker.segment_pool().statistics();
