...
// final: retry_strategy_for_abort_source() (utils/s3/client.cc) dynamic_casts to this
// exact type to rebuild it with an abort_source; a subclass's override would be lost.
class default_aws_retry_strategy final : public seastar::http::retry_strategy {
protected:
