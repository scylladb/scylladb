...
shared_ptr<client> client::make(std::string endpoint, endpoint_config_ptr cfg, std::unique_ptr<http::experimental::retry_strategy> rs, global_factory gf) {
    return make(std::move(endpoint), std::move(cfg), std::move(rs), nullptr, std::move(gf));
}

shared_ptr<client> client::make(std::string endpoint, endpoint_config_ptr cfg, std::unique_ptr<http::experimental::retry_strategy> rs,
