...
struct object_info {
    ...
    // (RFC 9110 entity-tag). For an object uploaded in a single PUT it is the
    // hex-encoded MD5 of the content, for a multipart one it is the hex-encoded
    // MD5 of the concatenated part MD5s followed by "-" and the number of parts.
    sstring etag;
};
