...
class view_info final {
    ...
    db::view::base_dependent_view_info make_base_dependent_view_info(schema_ptr base_schema) const;
    bool make_has_computed_column_depending_on_base_non_primary_key() const;
    bool make_is_partition_key_permutation_of_base_partition_key(schema_ptr base_schema) const;
