...
public:
    vault_error(std::string_view code, std::string_view msg)
        : _code(code)
    ...
    static vault_error make_error(std::string_view result);
};
...
namespace vault_errors {
    [[maybe_unused]] static const char* Unauthorized = "Unauthorized";
    [[maybe_unused]] static const char* Forbidden = "Forbidden";
    [[maybe_unused]] static const char* TooManyRequests = "TooManyRequests";
}
