...
||||||| parent of 17b3b0cd5d (sstables_loader: persist original tablet hints before pinning them)
...
=======
            co_await loader._ss.local().alter_table_with_tablet_hints(_tid, _original_min_tablet_count, _original_max_tablet_count,
                    service::wait_balancer::no, service::remove_unset::yes);
>>>>>>> 17b3b0cd5d (sstables_loader: persist original tablet hints before pinning them)
        } catch (...) {
