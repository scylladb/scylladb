...
static future<V> two_dimensional_map_reduce(sharded<service::storage_proxy>& d,
...
static future<json::json_return_type>  sum_stats_storage_proxy(sharded<proxy>& d, V F::*f) {
...
static httpd::utils_json::rate_moving_average_and_histogram get_empty_moving_average() {
