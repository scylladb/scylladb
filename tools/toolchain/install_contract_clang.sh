...
if [ ! -d ${CONTRACT_CMPILER_DEST_DIR} ]; then
    ...
    echo "cloning from github.com/regevran/infra.git until https://github.com/compiler-explorer/infra/issues/1838 is fixed"
    git clone --branch 1838_skip_missing --depth 1 https://github.com/regevran/infra.git $INFRADIR
