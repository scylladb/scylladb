...
The compaction strategy and its options are the ones of the schema. --strategy
and --strategy-option are shortcuts for describing the layout in the terms of
another strategy, useful when the schema is not available
