...
using history_entry = db::system_keyspace_compaction_history_entry;
...
void compactionhistory_operation(scylla_rest_client& client, const bpo::variables_map& vm) {
    ...
    for (const auto& history_entry_json : history_json.GetArray()) {
        ...
        for (const auto& sstables_in_json : history_entry_json_object["sstables_in"].GetArray()) {
            ...
            nlog.warn("BBB: {}", std::string(rjson::to_string_view(sstables_in_json_object["generation"])));
    ...
    if (format == "text") {
        constexpr size_t column_count = 14;
        std::array<std::string, column_count> header_row{"id", "shard_id", "keyspace_name", "columnfamily_name", "compaction_name", "compacted_at",
        ...
        for (const auto& e : history) {
            rows.push_back({fmt::to_string(e.id), fmt::to_string(e.shard_id), e.ks, e.cf, e.compaction_type, format_compacted_at(e.compacted_at),
                    fmt::to_string(e.bytes_in), fmt::to_string(e.bytes_out), fmt::to_string(std::map<int32_t, int64_t>(e.rows_merged.begin(), e.rows_merged.end())),
                    fmt::to_string(e.sstables_in), fmt::to_string(e.sstables_out), fmt::to_string(e.total_tombstone_purge_attempt),
        ...
        const auto header_row_format =
                fmt::format("{{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} \n",
                max_column_length[0], max_column_length[1], max_column_length[2], max_column_length[3], max_column_length[4], max_column_length[5],
                max_column_length[6], max_column_length[7], max_column_length[8], max_column_length[9], max_column_length[10], max_column_length[11],
                max_column_length[12], max_column_length[13]);
        const auto regular_row_format =
                fmt::format("{{:<{}}} {{:>{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:>{}}} {{:>{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} {{:<{}}} \n",
                max_column_length[0], max_column_length[1], max_column_length[2], max_column_length[3], max_column_length[4], max_column_length[5],
                max_column_length[6], max_column_length[7], max_column_length[8], max_column_length[9], max_column_length[10], max_column_length[11],
                max_column_length[12], max_column_length[13]);
        ...
        fmt::print(std::cout, fmt::runtime(header_row_format.c_str()), header_row[0], header_row[1], header_row[2], header_row[3], header_row[4],
                header_row[5], header_row[6], header_row[7], header_row[8], header_row[9], header_row[10], header_row[11], header_row[12], header_row[13]);
        for (const auto& r : rows) {
            fmt::print(std::cout, fmt::runtime(regular_row_format.c_str()), r[0], r[1], r[2], r[3], r[4], r[5], r[6], r[7], r[8], r[9], r[10], r[11], r[12], r[13]);
        }
    } else if (format == "json") {
