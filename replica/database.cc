...
database::database(const db::config& cfg, database_config dbcfg, service::migration_notifier& mn, gms::feature_service& feat, locator::shared_token_metadata& stm,
        ...
        utils::disk_space_monitor* dsm, const abort_source& abort, utils::cross_shard_barrier barrier)
    ...
    , _out_of_space_subscription(dsm && (this_shard_id() == 0) ? dsm->subscribe(_cfg.critical_disk_utilization_level, [this] (auto threshold_reached) {
