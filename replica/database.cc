...
database::init_logstor() {
    ...
    auto cfg = logstor::logstor_config{
        .segment_manager_cfg = {
            ...
            .trigger_compaction_threshold = static_cast<utils::updateable_value<double>>(_cfg.logstor_compaction_trigger_threshold),
            .compaction_soft_pressure_threshold = static_cast<utils::updateable_value<double>>(_cfg.logstor_compaction_soft_pressure_threshold),
