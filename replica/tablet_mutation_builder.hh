...
public:
    ...
    tablet_mutation_builder& set_tablet_task_info(dht::token last_token, locator::tablet_task_info info);
    tablet_mutation_builder& del_tablet_task_info(dht::token last_token);
