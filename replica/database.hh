...
public:
    ...
    //   if there is a keyspace that uses numeric replication factors.
    // * If not `enforce_rack_list`, a warning will be printed for each keyspace
    //   that uses numeric replication factors, but no exception should be produced.
