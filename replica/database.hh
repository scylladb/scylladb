...
public:
    ...
    static future<> disable_user_table_writes_on_all_shards(sharded<database>& sharded_db, bool disabled);
    bool are_user_table_writes_disabled() const { return _disable_user_table_writes; }
