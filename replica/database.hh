...
private:
    ...
    // Per-shard EWMA activity tracking for tablet allocation.
    // Ticked every 10 seconds by _activity_rate_timer.
    static constexpr std::chrono::seconds activity_rate_tick_interval{10};
    utils::moving_average _read_rate_ewma;
