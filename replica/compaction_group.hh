...
public:
    ...
    future<> split(sstables::compaction_type_options::split opt, tasks::task_info parent_info);
...
public:
    ...
    virtual future<> split_all_storage_groups(tasks::task_info parent_info) = 0;
