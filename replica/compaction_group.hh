...
class compaction_group {
    ...
    // logical compaction group representing the sstables undergoing repair.
    ...
    repair_classifier_func _repair_classifier;
private:
...
public:
    ...
    compaction::compaction_group_view& default_view_for_new_sstables() const;
