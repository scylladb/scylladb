...
table::seal_active_memtable(compaction_group& cg, flush_permit&& flush_permit) noexcept {
    ...
    co_await with_retry([&] {
        ...
        utils::get_local_injector().inject<std::bad_alloc>("table_seal_active_memtable_add_memtable");
    ...
    co_await with_retry([&] {
        ...
        utils::get_local_injector().inject<std::bad_alloc>("table_seal_active_memtable_start_op");
    ...
    co_await with_retry([&] () -> future<> {
        ...
        if (!permit.has_sstable_write_permit()) {
            ...
            utils::get_local_injector().inject<std::bad_alloc>("table_seal_active_memtable_reacquire_write_permit");
