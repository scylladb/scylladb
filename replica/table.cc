...
locator::combined_load_stats tablet_storage_group_manager::table_load_stats() const {
    ...
    for_each_storage_group([&] (size_t id, storage_group& sg) {
        ...
        // If transition hasn't reached streaming stage, then leaving replicas are accounted.
        // If transition is past streaming stage, then pending replicas are accounted.
