...
const sstring& gossiper::get_recovery_leader() const noexcept {
...
future<> gossiper::handle_syn_msg(locator::host_id from, gossip_digest_syn syn_msg) {
    ...
    bool both_nodes_in_recovery = !syn_msg.recovery_leader().empty() && !get_recovery_leader().empty();
    ...
    bool no_recovery = syn_msg.recovery_leader().empty() && get_recovery_leader().empty();
