...
class metadata final {
    ...
    using table_streams_ptr = lw_shared_ptr<foreign_ptr<lw_shared_ptr<const table_streams>>>;
...
public:
    ...
    void load_tablet_streams_map(table_id tid, foreign_ptr<lw_shared_ptr<const table_streams>> new_table_map);
