...
public:
    ...
    future<> generate_tablet_resize_update(utils::chunked_vector<canonical_mutation>& muts, table_id table, const locator::shared_tablet_map& new_tablet_map, api::timestamp_type ts);
