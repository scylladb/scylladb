...
public:
    ...
    static inline future<> setup_keyspace(const sstring& keyspace_name, const sstring& replication_factor, const Args&... args) {
        if (engine().cpu_id() == 0) {
            return seastar::async([&keyspace_name, &replication_factor, &args...] {
