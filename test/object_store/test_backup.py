...
<<<<<<< HEAD:test/object_store/test_backup.py
...
||||||| parent of 9281bff0e3 (test/cluster/object_store/test_backup.py: Adjust to RF-rack-validity):test/cluster/object_store/test_backup.py
    logger.info(f'Start cluster with {topology.nodes} nodes in {topology.dcs} DCs, {topology.racks} racks')
...
>>>>>>> 9281bff0e3 (test/cluster/object_store/test_backup.py: Adjust to RF-rack-validity):test/cluster/object_store/test_backup.py
    cmd = [ '--logger-log-level', 'sstables_loader=debug:sstable_directory=trace:snapshots=trace:s3=trace:sstable=debug:http=debug' ]
    servers = []
    host_ids = {}
