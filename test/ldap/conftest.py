...
from test.pylib.cpp.ldap.prepare_instance import get_prepare_instance
...
def pytest_runtestloop(session):
    ...
    prepare_instance = get_prepare_instance(root_dir, temp_dir, worker_id, modes, byte_limit)
    try:
