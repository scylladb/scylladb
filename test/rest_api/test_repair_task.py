...
from rest_util import set_tmp_task_ttl, long_time
    ...
    with set_tmp_task_ttl(rest_api, long_time):
        ...
        with new_test_keyspace(cql, f"WITH REPLICATION = {{ 'class' : 'NetworkTopologyStrategy', '{this_dc}' : 1 }}") as keyspace:
            ...
            with new_test_table(cql, keyspace, schema) as t0:
                ...
                # Run repair and with until it is finished.
                ...
                statuses = list(filter(lambda s : s is not None, map(lambda s: get_status(rest_api, s, sequence_number), resp.json())))
