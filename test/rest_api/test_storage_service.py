...
# Test for basic operations on `v2/client-routes` endpoint
...
# This test verifies that some of the `...port` fields can be ommited in `v2/client-routes` requests
...
# This tests verifies that `v2/client-routes` can handle very long inputs in a single request
...
def test_client_routes_null_terminators(cql, this_dc, rest_api):
    """Verify that how null terminators are handled by API endpoint"""
