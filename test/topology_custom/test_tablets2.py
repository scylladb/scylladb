...
||||||| parent of 7f34366b9d (sstables_loader: Don't bypass synchronization with busy topology):test/cluster/test_tablets2.py
...
async def test_tablet_load_and_stream_and_split_synchronization(manager: ManagerClient, primary_replica_only):
    ...
    async with new_test_keyspace(manager, f"WITH replication = {{'class': 'NetworkTopologyStrategy', 'replication_factor': 1}}") as ks:
        ...
        await check(ks)
>>>>>>> 7f34366b9d (sstables_loader: Don't bypass synchronization with busy topology):test/cluster/test_tablets2.py
