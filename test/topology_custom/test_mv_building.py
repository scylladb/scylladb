...
<<<<<<< HEAD:test/topology_custom/test_mv_building.py
||||||| parent of 0a22ac3c9e (mv: don't mark the view as built if the reader produced no partitions):test/cluster/mv/test_mv_building.py
...
>>>>>>> 0a22ac3c9e (mv: don't mark the view as built if the reader produced no partitions):test/cluster/mv/test_mv_building.py
