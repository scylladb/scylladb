...
import boto3
import botocore
<<<<<<< HEAD:test/topology_custom/test_alternator.py
=======
import requests
import json
...
>>>>>>> 0d1aa399f9 (alternator: fix "/localnodes" to not return nodes still joining):test/topology_experimental_raft/test_alternator.py
