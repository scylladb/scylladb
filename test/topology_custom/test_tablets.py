...
||||||| parent of 83c9af9670 (test: add test for repair and resize finalization):test/cluster/test_tablets.py
...
@pytest.mark.asyncio
@skip_mode('release', 'error injections are not supported in release mode')
>>>>>>> 83c9af9670 (test: add test for repair and resize finalization):test/cluster/test_tablets.py
