...
<<<<<<< HEAD:test/topology_custom/test_cdc_generation_clearing.py
        await check_system_topology_and_cdc_generations_v3_consistency(manager, [host1])
||||||| parent of 8aeb404893 (test_cdc_generation_clearing: wait for generations to propagate):test/cluster/test_cdc_generation_clearing.py
        await check_system_topology_and_cdc_generations_v3_consistency(manager, [host1, host2, host3])
=======
        await asyncio.gather(*[read_barrier(manager.api, s.ip_addr) for s in servers])
        await check_system_topology_and_cdc_generations_v3_consistency(manager, [host1, host2, host3])
>>>>>>> 8aeb404893 (test_cdc_generation_clearing: wait for generations to propagate):test/cluster/test_cdc_generation_clearing.py
