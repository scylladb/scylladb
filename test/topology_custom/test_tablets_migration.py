...
<<<<<<< HEAD:test/topology_custom/test_tablets_migration.py
            await make_server()
||||||| parent of dbb8835fdf (test/cluster: Adjust simple tests to RF-rack-validity):test/cluster/test_tablets_migration.py
            for _ in range(2):
                await make_server()
=======
            await make_server("r1")
            await make_server("r2")
>>>>>>> dbb8835fdf (test/cluster: Adjust simple tests to RF-rack-validity):test/cluster/test_tablets_migration.py
