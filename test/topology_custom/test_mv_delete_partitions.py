...
<<<<<<< HEAD:test/topology_custom/test_mv_delete_partitions.py
from test.topology.util import new_test_keyspace
||||||| parent of 2ece08ba43 (test: run mv tests depending on metrics on a standalone instance):test/cluster/mv/test_mv_delete_partitions.py
from test.cluster.util import new_test_keyspace
=======
from test.cluster.util import new_test_keyspace, new_test_table, new_materialized_view
>>>>>>> 2ece08ba43 (test: run mv tests depending on metrics on a standalone instance):test/cluster/mv/test_mv_delete_partitions.py
