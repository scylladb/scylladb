...
export S3_USE_HTTPS_FOR_TEST=false && \
...
//    tools/toolchain/dbuild -e AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY -e AWS_SESSION_TOKEN -e AWS_DEFAULT_REGION -e S3_SERVER_ADDRESS_FOR_TEST -e S3_SERVER_PORT_FOR_TEST -e S3_BUCKET_FOR_TEST -- build/dev/test/manual/s3_storage_roundtrip_test_g
SEASTAR_TEST_CASE(test_s3_storage_sink_source_roundtrip) {
    auto port = (unsigned int)std::stoul(tests::getenv_or_default("S3_SERVER_PORT_FOR_TEST", "9000"));
    ...
    const auto use_https = tests::getenv_or_default("S3_USE_HTTPS_FOR_TEST", "true") == "true";
    ...
    try {
        ...
        // TODO: replace empty etag constructor with actual etag once #31703 is merged
#if 0
