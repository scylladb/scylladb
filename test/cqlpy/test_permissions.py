    ...
    with new_user(cql) as username:
        with new_session(cql, username) as user_session:
            with new_test_table(cql, test_keyspace, "a int, PRIMARY KEY (a)") as t:
                ...
                eventually_unauthorized(lambda: user_session.execute(f"INSERT INTO {test_keyspace}.{test_table} (a) VALUES (1)"))
                ...
                eventually_authorized(lambda: user_session.execute(f"INSERT INTO {test_keyspace}.{test_table} (a) VALUES (1)"))
