...
# Poll system.vector_indexes until a row matching the predicate appears,
...
# The system.vector_indexes virtual table reports, per vector store node,
...
# similarity function).
def test_vector_indexes_serving(cql, test_keyspace, vector_store_mock, skip_without_tablets):
    schema = "pk1 tinyint, pk2 tinyint, ck1 tinyint, ck2 tinyint, embedding vector<float, 3>, PRIMARY KEY ((pk1, pk2), ck1, ck2)"
...
def test_vector_indexes_building_stage(cql, test_keyspace, vector_store_mock, skip_without_tablets):
    schema = "pk1 tinyint, pk2 tinyint, ck1 tinyint, ck2 tinyint, embedding vector<float, 3>, PRIMARY KEY ((pk1, pk2), ck1, ck2)"
...
def test_vector_indexes_unreachable_node(cql, test_keyspace, vector_store_mock, skip_without_tablets):
    schema = "pk1 tinyint, pk2 tinyint, ck1 tinyint, ck2 tinyint, embedding vector<float, 3>, PRIMARY KEY ((pk1, pk2), ck1, ck2)"
