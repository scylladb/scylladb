...
async def test_node_ops_task_wait(manager: ManagerClient):
    ...
    await waiting_task
<<<<<<< HEAD:test/topology_tasks/test_node_ops_tasks.py
...
||||||| parent of 41e2c2d1c4 (Merge 'tasks: do not fail the wait request if rpc fails' from Aleksandra Martyniuk):test/cluster/tasks/test_node_ops_tasks.py
...
async def test_get_children(manager: ManagerClient):
    ...
    await asyncio.gather(*(_decommission(), _get_status()))
=======
>>>>>>> 41e2c2d1c4 (Merge 'tasks: do not fail the wait request if rpc fails' from Aleksandra Martyniuk):test/cluster/tasks/test_node_ops_tasks.py
