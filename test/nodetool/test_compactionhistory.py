...
HISTORY_RESPONSE = [
        {
            ...
            "sstables_in": [
                {
                    "generation": "379c0130-8f93-11ef-a1d3-9c608091ed0e",
                    "origin": "memtable",
                    "size": 5466,
                },
                {
                    "generation": "372aa1c0-8f93-11ef-a1d3-9c608091ed0e",
                    "origin": "memtable",
                    "size": 5519,
                }],
            "sstables_out": [
                {
                    "generation": "39113c10-8f93-11ef-a1d3-9c608091ed0e",
                    "origin": "compaction",
                    "size": 5457,
                }],
        ...
        },
        {
            ...
            "sstables_in": [
                {
                    "generation": "00000000-0000-1000-0000-000000000001",
                    "origin": "memtable",
                    "size": 5668,
                },
                {
                    "generation": "36a01500-8f93-11ef-a1d3-9c608091ed0e",
                    "origin": "memtable",
                    "size": 5669,
                }],
            "sstables_out": [
                {
                    "generation": "36a28600-8f93-11ef-a1d3-9c608091ed0e",
                    "origin": "compaction",
                    "size": 5687,
                }],
            "total_tombstone_purge_attempt": 14,
...
def _test_text_nodetool_scylla(nodetool):
    ...
    expected_response = \
"""Compaction History:
id                                   shard_id keyspace_name columnfamily_name compaction_name compacted_at            bytes_in bytes_out rows_merged  sstables_in                                                                                                                                                          sstables_out                                                                         total_tombstone_purge_attempt total_tombstone_purge_failure_due_to_overlapping_with_memtable total_tombstone_purge_failure_due_to_overlapping_with_uncompacting_sstable 
edef82f0-5e9c-11ee-a8f6-7d85dcfeb8f4        0 system_schema functions         Compact         {}     5790      5944 {{1: 5, 2: 1}} [{{generation: 00000000-0000-1000-0000-000000000001, origin: memtable, size: 5668}}, {{generation: 36a01500-8f93-11ef-a1d3-9c608091ed0e, origin: memtable, size: 5669}}] [{{generation: 36a28600-8f93-11ef-a1d3-9c608091ed0e, origin: compaction, size: 5687}}] 14                            5                                                              5                                                                          
edde9300-5e9c-11ee-a8f6-7d85dcfeb8f4        0 system        peers             Compact         {}    11714     11808 {{1: 12}}      [{{generation: 379c0130-8f93-11ef-a1d3-9c608091ed0e, origin: memtable, size: 5466}}, {{generation: 372aa1c0-8f93-11ef-a1d3-9c608091ed0e, origin: memtable, size: 5519}}] [{{generation: 39113c10-8f93-11ef-a1d3-9c608091ed0e, origin: compaction, size: 5457}}] 14                            0                                                              0                                                                          
""".format(format_compacted_at(1695973859491), format_compacted_at(1695973859380))
