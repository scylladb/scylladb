...
def test_repair_all_single_keyspace_tablets(nodetool):
    ...
    res = nodetool("tablet-repair", expected_requests=[
...
Starting tablet repair with id {id1} on keyspace ks1, table table1
Repair with task_id={id1} finished
Starting tablet repair with id {id2} on keyspace ks1, table table2
...
Starting tablet repair with id {id1} on keyspace ks1, table table1
Repair with task_id={id1} finished
Starting tablet repair with id {id2} on keyspace ks2, table table2
Repair with task_id={id2} finished
"""
...
def test_repair_keyspace_tablets(nodetool):
    id1 = "ef1b7a61-66c8-494c-bb03-6f65724e6eee"
    id2 = "ef1b7a61-66c8-494c-bb03-6f65724e6eef"
    res = nodetool("tablet-repair", "ks", expected_requests=[
    ...
    assert _remove_log_timestamp(res.stdout) == f"""\
Starting tablet repair with id {id1} on keyspace ks, table table1
Repair with task_id={id1} finished
Starting tablet repair with id {id2} on keyspace ks, table table2
Repair with task_id={id2} finished
"""

def test_repair_one_table_tablets(nodetool):
    id1 = "ef1b7a61-66c8-494c-bb03-6f65724e6eee"
    res = nodetool("tablet-repair", "ks", "table1", expected_requests=[
        expected_request("GET", "/storage_service/keyspaces", response=["ks"]),
        expected_request("GET", "/storage_service/keyspaces", params={"replication": "tablets"}, response=["ks"]),
        expected_request(
            "POST",
...
def test_repair_two_tables_tablets(nodetool):
    id1 = "ef1b7a61-66c8-494c-bb03-6f65724e6eee"
    id2 = "ef1b7a61-66c8-494c-bb03-6f65724e6eef"
    res = nodetool("tablet-repair", "ks", "table1", "table2", expected_requests=[
        expected_request("GET", "/storage_service/keyspaces", response=["ks"]),
        expected_request("GET", "/storage_service/keyspaces", params={"replication": "tablets"}, response=["ks"]),
        expected_request(
            "POST",
...
def _do_test_repair_options_tablets(
    ...
    assert _remove_log_timestamp(res.stdout) == f"""\
Starting tablet repair with id {id1} on keyspace ks, table table
Repair with task_id={id1} finished
"""
...
def test_repair_keyspace(nodetool):
    check_nodetool_fails_with(
        ...
        ["error processing arguments: nodetool tablet-repair repairs only tablet keyspaces. To repair vnode keyspaces use nodetool repair."])
