...
class ScyllaRESTAPIClient:
    ...
    async def restore_tablets(self, node_ip: str, ks: str, cf: str, snap: str, dest: str, bucket: str, manifests) -> str:
        params = {
            "keyspace": ks,
            "table": cf,
            "snapshot": snap,
        ...
        return await self.client.post_json(f"/storage_service/tablets/restore", host=node_ip, params=params)
