...
class ScyllaRESTAPIClient:
    ...
    async def load_new_sstables(self, node_ip: str, keyspace: str, table: str, primary_replica : bool = False, scope: str = None, load_and_stream : bool = False) -> None:
        """Load sstables from upload directory"""
        params = {"cf": table,
                  "primary_replica_only": "true" if primary_replica else "false",
                  "scope": scope if scope else "all",
