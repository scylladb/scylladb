...
# Use cache to execute this function once per pytest session.
@cache
def add_scylla_cql_connection_options(parser: Parser) -> None:
    """Add pytest options for Scylla CQL connection."""

    cql_options = parser.getgroup("Scylla CQL connection options")
