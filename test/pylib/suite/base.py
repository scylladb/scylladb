...
async def prepare_environment(tempdir_base: pathlib.Path, modes: list[str], gather_metrics: bool, save_log_on_success: bool,
    ...
    if 'TEST_ENVIRONMENT_PREPARED' in os.environ:
        logger.warning('Environment variable TEST_ENVIRONMENT_PREPARED is set. Skipping environment setup.')
        return
    ...
    os.environ['TEST_ENVIRONMENT_PREPARED'] = 'true'
