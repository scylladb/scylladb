...
# pytest kicks in. In addition, it is possible just to start this server using another script - `start_s3_proxy.py` to
# run it locally to provide proxy between tests and minio
class S3ProxyServer:
