...
from test import TOP_SRCDIR, TESTDIR
...
class ScyllaServer:
    ...
    def __init__(self, mode: str, exe: str, vardir: str | pathlib.Path,
        ...
        self.resourcesdir = TESTDIR / "pylib/resources"
    ...
    async def start(self,
        ...
        env['UBSAN_OPTIONS'] = f'halt_on_error=1:abort_on_error=1:suppressions={TOP_SRCDIR / "ubsan-suppressions.supp"}'
