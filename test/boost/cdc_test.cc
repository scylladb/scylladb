...
SEASTAR_THREAD_TEST_CASE(test_change_splitting) {
    do_with_cql_env_thread([](cql_test_env& e) {
        ...
        auto empty_map = make_map_value(m_type, {}); // TODO: don't we want to use map_null instead of empty_map?
...

        {
            ...
            std::vector<std::vector<data_value>> expected = {
                ...
                //
                {int32_t(1), int32_t(2), empty_map, true, oper_ut(cdc::operation::update)},
