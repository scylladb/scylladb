...
BOOST_AUTO_TEST_CASE(test_3_1) {
    ...
    // iterations:
    test_hit_rates({0.999, 0.999, 0.4}, 1, false, 5000000);
    test_hit_rates({0.999, 0.999, 0.2}, 1, false, 5000000);
    test_hit_rates({0.999, 0.999, 0.8}, 1, false, 5000000);
    test_hit_rates({0.999, 0.99, 0.5123}, 1, false, 5000000);
}
