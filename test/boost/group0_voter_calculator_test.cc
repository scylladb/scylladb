...
const auto& yes = raft::can_vote_t::yes;
const auto& no = raft::can_vote_t::no;
...
BOOST_AUTO_TEST_CASE(single_node_is_selected_as_voter) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes{
            {ids[0], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(multiple_nodes_are_selected_as_voters) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes{
            {ids[0], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[1], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(no_voters_selected_when_all_nodes_are_dead) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = false}},
            {ids[1], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = false}},
    };
...
BOOST_AUTO_TEST_CASE(dead_nonvoters_dont_become_voters) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = false}},
            {ids[1], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[2], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = false}},
            {ids[3], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[4], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = false}},
    };
    ...
    for (const auto id : voters) {
        BOOST_CHECK(bool(nodes.at(id).is_voter));
    }
}
...
BOOST_AUTO_TEST_CASE(voter_limit_is_kept) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[1], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(limit_kept_on_voter_removal) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
            // the node being removed
            {ids[1], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = false}},
            {ids[2], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
...
BOOST_AUTO_TEST_CASE(limit_is_kept_on_removal_and_insert) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            // nodes being added
            {ids[3], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(existing_voters_are_kept) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[2], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[3], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(voters_are_distributed_across_dcs) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc-1", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(voters_are_distributed_across_dcs_across_multiple_inserts) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            // the initial set of nodes
            {ids[0], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[2], {.datacenter = "dc-2", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            // nodes being added
            {ids[4], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = true}},
...
BOOST_AUTO_TEST_CASE(voters_are_distributed_asymmetrically_across_two_dcs) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc-1", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc-1", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(dc_cannot_have_half_or_more_of_voters) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc-1", .rack = "rack-1", .is_voter = no, .is_alive = true}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc-1", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(dc_cannot_have_half_or_more_of_voters_on_node_removal) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[2], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[4], {.datacenter = "dc-3", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[5], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = false}},
    };
...
BOOST_AUTO_TEST_CASE(all_nodes_become_voters_after_third_dc_removal) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[1], {.datacenter = "dc-1", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[3], {.datacenter = "dc-1", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc-2", .rack = "rack", .is_voter = yes, .is_alive = true}},
            // the nodes being removed
            {ids[5], {.datacenter = "dc-3", .rack = "rack", .is_voter = yes, .is_alive = false}},
            {ids[6], {.datacenter = "dc-3", .rack = "rack", .is_voter = yes, .is_alive = false}},
    };
...
BOOST_AUTO_TEST_CASE(voters_distributed_as_two_dc_asymmetric_after_third_dc_removal) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[3], {.datacenter = "dc-2", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[4], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc-2", .rack = "rack", .is_voter = yes, .is_alive = true}},
            // the nodes being removed
            {ids[6], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = false}},
            {ids[7], {.datacenter = "dc-3", .rack = "rack", .is_voter = no, .is_alive = false}},
    };
...
BOOST_AUTO_TEST_CASE(dead_voters_kept_if_no_other_voters_are_available) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[1], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[2], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[3], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = false}},
            {ids[4], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = false}},
    };
    ...
    for (const auto id : voters) {
        const auto& node = nodes.at(id);
        BOOST_CHECK(bool(node.is_voter));
    }
}
...
BOOST_AUTO_TEST_CASE(dead_voters_moved_to_available_alive_nodes) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[3], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = false}},
            {ids[4], {.datacenter = "dc", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc", .rack = "rack", .is_voter = yes, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(voters_are_distributed_across_racks) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc", .rack = "rack-1", .is_voter = no, .is_alive = true}},
            {ids[1], {.datacenter = "dc", .rack = "rack-1", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc", .rack = "rack-1", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc", .rack = "rack-3", .is_voter = no, .is_alive = true}},
            {ids[6], {.datacenter = "dc", .rack = "rack-3", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(more_racks_preferred_over_more_nodes_in_two_dc) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc-2", .rack = "rack-3", .is_voter = no, .is_alive = true}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack-1", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc-1", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack-3", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc-2", .rack = "rack-3", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc-1", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[6], {.datacenter = "dc-2", .rack = "rack-3", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(dcs_preferred_over_racks) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc-1", .rack = "rack-1", .is_voter = no, .is_alive = true}},
            {ids[1], {.datacenter = "dc-2", .rack = "rack-4", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc-1", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc-4", .rack = "rack-6", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc-3", .rack = "rack-5", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc-1", .rack = "rack-3", .is_voter = no, .is_alive = true}},
            {ids[6], {.datacenter = "dc-5", .rack = "rack-7", .is_voter = no, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(existing_voters_are_retained_across_dcs) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[1], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc-3", .rack = "rack", .is_voter = yes, .is_alive = true}},
            {ids[3], {.datacenter = "dc-4", .rack = "rack", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc-5", .rack = "rack", .is_voter = yes, .is_alive = true}},
    };
...
BOOST_AUTO_TEST_CASE(existing_voters_are_kept_across_racks) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            {ids[0], {.datacenter = "dc", .rack = "rack-1", .is_voter = yes, .is_alive = true}},
            {ids[1], {.datacenter = "dc", .rack = "rack-2", .is_voter = no, .is_alive = true}},
            {ids[2], {.datacenter = "dc", .rack = "rack-3", .is_voter = yes, .is_alive = true}},
            {ids[3], {.datacenter = "dc", .rack = "rack-4", .is_voter = no, .is_alive = true}},
            {ids[4], {.datacenter = "dc", .rack = "rack-5", .is_voter = yes, .is_alive = true}},
    };
...
BOOST_DATA_TEST_CASE(leader_is_retained_as_voter, boost::unit_test::data::make({0, 1, 2}), leader_node_idx) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[0], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 0}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 1}},
            {ids[2], {.datacenter = "dc-2", .rack = "rack", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 2}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack", .is_voter = no, .is_alive = true}},
...
BOOST_DATA_TEST_CASE(leader_is_retained_as_voter_in_racks, boost::unit_test::data::make({0, 1, 3}), leader_node_idx) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            // The initial nodes (just 2 DCs)
            {ids[0], {.datacenter = "dc-1", .rack = "rack-1", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 0}},
            {ids[1], {.datacenter = "dc-1", .rack = "rack-2", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 1}},
            {ids[2], {.datacenter = "dc-2", .rack = "rack-3", .is_voter = no, .is_alive = true}},
            {ids[3], {.datacenter = "dc-2", .rack = "rack-4", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 3}},
            // The new nodes (3rd DC)
            // - this will lead to 1 voter being removed from the DC-1
            {ids[4], {.datacenter = "dc-3", .rack = "rack-5", .is_voter = no, .is_alive = true}},
            {ids[5], {.datacenter = "dc-3", .rack = "rack-6", .is_voter = no, .is_alive = true}},
    };
...
BOOST_DATA_TEST_CASE(leader_is_retained_as_voter_in_two_dc_asymmetric_setup, boost::unit_test::data::make({0, 1}), leader_node_idx) {
    ...
    const service::group0_voter_calculator::nodes_list_t nodes = {
            ...
            {ids[0], {.datacenter = "dc-1", .rack = "rack", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 0}},
            {ids[1], {.datacenter = "dc-2", .rack = "rack", .is_voter = yes, .is_alive = true, .is_leader = leader_node_idx == 1}},
