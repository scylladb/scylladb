...
SEASTAR_TEST_CASE(multiple_nodes_are_selected_as_voters) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc", .rack = "rack"});
...
SEASTAR_TEST_CASE(limit_is_kept_on_multiple_inserts) {
    ...
    server_info_accessor.set_info(initial_ids[0], {.datacenter = "dc", .rack = "rack"});
...
SEASTAR_TEST_CASE(voters_are_distributed_across_dcs) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc-1", .rack = "rack"});
    server_info_accessor.set_info(ids[1], {.datacenter = "dc-1", .rack = "rack"});
    server_info_accessor.set_info(ids[2], {.datacenter = "dc-2", .rack = "rack"});
    ...
    for (const auto id : voters) {
        const auto& server_info = server_info_accessor.find(id);
...
SEASTAR_TEST_CASE(voters_are_distributed_across_dcs_across_multiple_inserts) {
    ...
    server_info_accessor.set_info(initial_ids[0], {.datacenter = "dc-1", .rack = "rack"});
    server_info_accessor.set_info(initial_ids[1], {.datacenter = "dc-1", .rack = "rack"});
    server_info_accessor.set_info(initial_ids[2], {.datacenter = "dc-2", .rack = "rack"});
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc-3", .rack = "rack"});
...
SEASTAR_TEST_CASE(voters_are_distributed_asymmetrically_across_two_dcs) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc-1", .rack = "rack"});
    server_info_accessor.set_info(ids[1], {.datacenter = "dc-1", .rack = "rack"});
    server_info_accessor.set_info(ids[2], {.datacenter = "dc-1", .rack = "rack"});
    server_info_accessor.set_info(ids[3], {.datacenter = "dc-2", .rack = "rack"});
    server_info_accessor.set_info(ids[4], {.datacenter = "dc-2", .rack = "rack"});
...
SEASTAR_TEST_CASE(dc_cannot_have_majority_of_voters) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc-1", .rack = "rack-1"});
    server_info_accessor.set_info(ids[1], {.datacenter = "dc-1", .rack = "rack-2"});
    server_info_accessor.set_info(ids[2], {.datacenter = "dc-2", .rack = "rack"});
...
SEASTAR_TEST_CASE(adaptive_voters_is_low_bound_with_lower_dc_count) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = dcs[0], .rack = "rack"});
    server_info_accessor.set_info(ids[1], {.datacenter = dcs[0], .rack = "rack"});
    server_info_accessor.set_info(ids[2], {.datacenter = dcs[0], .rack = "rack"});
    server_info_accessor.set_info(ids[3], {.datacenter = dcs[1], .rack = "rack"});
    server_info_accessor.set_info(ids[4], {.datacenter = dcs[1], .rack = "rack"});
    server_info_accessor.set_info(ids[5], {.datacenter = dcs[1], .rack = "rack"});
    server_info_accessor.set_info(ids[6], {.datacenter = dcs[1], .rack = "rack"});
    server_info_accessor.set_info(ids[7], {.datacenter = dcs[2], .rack = "rack"});
    server_info_accessor.set_info(ids[8], {.datacenter = dcs[2], .rack = "rack"});
    server_info_accessor.set_info(ids[9], {.datacenter = dcs[2], .rack = "rack"});
...
SEASTAR_TEST_CASE(adaptive_voters_is_equal_with_regular_dc_count) {
    ...
    server_info_accessor.set_info(ids[4], {.datacenter = dcs[1], .rack = "rack"});
    server_info_accessor.set_info(ids[5], {.datacenter = dcs[1], .rack = "rack"});
    server_info_accessor.set_info(ids[6], {.datacenter = dcs[2], .rack = "rack"});
    server_info_accessor.set_info(ids[7], {.datacenter = dcs[2], .rack = "rack"});
    server_info_accessor.set_info(ids[8], {.datacenter = dcs[3], .rack = "rack"});
    server_info_accessor.set_info(ids[9], {.datacenter = dcs[3], .rack = "rack"});
    server_info_accessor.set_info(ids[10], {.datacenter = dcs[4], .rack = "rack"});
    server_info_accessor.set_info(ids[11], {.datacenter = dcs[4], .rack = "rack"});
    server_info_accessor.set_info(ids[12], {.datacenter = dcs[5], .rack = "rack"});
    server_info_accessor.set_info(ids[13], {.datacenter = dcs[6], .rack = "rack"});
    server_info_accessor.set_info(ids[14], {.datacenter = dcs[6], .rack = "rack"});
...
SEASTAR_TEST_CASE(adaptive_voters_is_high_bound_with_higher_dc_count) {
    ...
    server_info_accessor.set_info(ids[13], {.datacenter = dcs[6], .rack = "rack"});
    server_info_accessor.set_info(ids[14], {.datacenter = dcs[6], .rack = "rack"});
    server_info_accessor.set_info(ids[15], {.datacenter = dcs[7], .rack = "rack"});
    server_info_accessor.set_info(ids[16], {.datacenter = dcs[7], .rack = "rack"});
    server_info_accessor.set_info(ids[17], {.datacenter = dcs[7], .rack = "rack"});
    server_info_accessor.set_info(ids[18], {.datacenter = dcs[8], .rack = "rack"});
    server_info_accessor.set_info(ids[19], {.datacenter = dcs[8], .rack = "rack"});
    server_info_accessor.set_info(ids[20], {.datacenter = dcs[9], .rack = "rack"});
    server_info_accessor.set_info(ids[21], {.datacenter = dcs[9], .rack = "rack"});
    server_info_accessor.set_info(ids[22], {.datacenter = dcs[9], .rack = "rack"});
    server_info_accessor.set_info(ids[23], {.datacenter = dcs[10], .rack = "rack"});
    server_info_accessor.set_info(ids[24], {.datacenter = dcs[10], .rack = "rack"});
    server_info_accessor.set_info(ids[25], {.datacenter = dcs[11], .rack = "rack"});
    server_info_accessor.set_info(ids[26], {.datacenter = dcs[11], .rack = "rack"});
...
SEASTAR_TEST_CASE(voters_are_distributed_across_racks) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc", .rack = "rack-1"});
    server_info_accessor.set_info(ids[1], {.datacenter = "dc", .rack = "rack-1"});
    server_info_accessor.set_info(ids[2], {.datacenter = "dc", .rack = "rack-1"});
    server_info_accessor.set_info(ids[3], {.datacenter = "dc", .rack = "rack-2"});
    server_info_accessor.set_info(ids[4], {.datacenter = "dc", .rack = "rack-2"});
    server_info_accessor.set_info(ids[5], {.datacenter = "dc", .rack = "rack-3"});
    server_info_accessor.set_info(ids[6], {.datacenter = "dc", .rack = "rack-3"});
...
SEASTAR_TEST_CASE(more_racks_preferred_over_more_nodes_in_two_dc) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc-1", .rack = "rack-1"});
    server_info_accessor.set_info(ids[1], {.datacenter = "dc-1", .rack = "rack-2"});
    server_info_accessor.set_info(ids[2], {.datacenter = "dc-1", .rack = "rack-2"});
    server_info_accessor.set_info(ids[3], {.datacenter = "dc-2", .rack = "rack-3"});
    server_info_accessor.set_info(ids[4], {.datacenter = "dc-2", .rack = "rack-3"});
    server_info_accessor.set_info(ids[5], {.datacenter = "dc-2", .rack = "rack-3"});
    server_info_accessor.set_info(ids[6], {.datacenter = "dc-2", .rack = "rack-3"});
...
SEASTAR_TEST_CASE(dcs_preferred_over_racks) {
    ...
    server_info_accessor.set_info(ids[0], {.datacenter = "dc-1", .rack = "rack-1"});
    server_info_accessor.set_info(ids[1], {.datacenter = "dc-1", .rack = "rack-2"});
    server_info_accessor.set_info(ids[2], {.datacenter = "dc-1", .rack = "rack-3"});
    server_info_accessor.set_info(ids[3], {.datacenter = "dc-2", .rack = "rack-4"});
    server_info_accessor.set_info(ids[4], {.datacenter = "dc-3", .rack = "rack-5"});
    server_info_accessor.set_info(ids[5], {.datacenter = "dc-4", .rack = "rack-6"});
    server_info_accessor.set_info(ids[6], {.datacenter = "dc-5", .rack = "rack-7"});
