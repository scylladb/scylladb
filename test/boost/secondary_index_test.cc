...
// allocations. The allocation threshold is set to an arguably high value (512KiB)
// to filter out large allocations that may be caused by other internal operations.
//
...
SEASTAR_TEST_CASE(test_large_allocations) {
    return do_with_cql_env([] (cql_test_env& e) -> future<> {
        ...
        int allocation_threshold = 512 * 1024;
        int partitions = 5000;
