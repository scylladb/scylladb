...
future<> test_using_working_sst(schema_ptr s, sstring dir, sstables::generation_type::value_type gen) {
...
inline auto
test_using_reusable_sst(schema_ptr s, sstring dir, sstables::generation_type::value_type gen, Func&& func) {
...
static future<sstable_ptr> do_write_sst(test_env& env, schema_ptr schema, sstring load_dir, sstring write_dir, sstables::generation_type::value_type generation) {
...
static future<> write_sst_info(schema_ptr schema, sstring load_dir, sstring write_dir, sstables::generation_type::value_type generation) {
...
struct sstdesc {
    sstring dir;
    sstables::generation_type::value_type gen;
};
...
static future<>
test_sstable_exists(sstring dir, sstables::generation_type::value_type generation, bool exists) {
