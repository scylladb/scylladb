...
inline auto
test_using_reusable_sst(schema_ptr s, sstring dir, sstables::generation_type::int_t gen, std::invocable<test_env&, sstable_ptr> auto&& func) {
    using ret_type = std::invoke_result_t<decltype(func), test_env&, sstable_ptr>;
