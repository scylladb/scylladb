...
static future<> broken_sst(sstring dir, sstables::generation_type::value_type generation, schema_ptr s, sstring msg, std::optional<sstring> sst_name,
...
static future<> broken_sst(sstring dir, sstables::generation_type::value_type generation, sstring msg, std::optional<sstring> sst_name = std::nullopt) {
