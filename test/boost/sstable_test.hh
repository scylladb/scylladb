...
public:
    ...
    static void update_sstables_known_generation(replica::column_family& cf, sstables::generation_type::int_t generation) {
        cf.update_sstables_known_generation(generation_from_value(generation));
    }

    static sstables::generation_type::int_t calculate_generation_for_new_table(replica::column_family& cf) {
