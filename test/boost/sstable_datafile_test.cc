...
SEASTAR_TEST_CASE(test_validate_checksums) {
    return test_env::do_with_async([&] (test_env& env) {
        ...
        const auto muts = tests::generate_random_mutations(random_schema, tests::default_timestamp_generator(), tests::no_expiry_expiry_generator(),
                std::uniform_int_distribution<size_t>(8, 16), std::uniform_int_distribution<size_t>(16, 128), std::uniform_int_distribution<size_t>(4, 16),
                this_shard_id()).get();
...
SEASTAR_TEST_CASE(test_non_full_and_empty_row_keys) {
    return do_with_cql_env_thread([] (cql_test_env& env) {
        ...
        const auto generated_mutations = tests::generate_random_mutations(random_schema, tests::default_timestamp_generator(), tests::no_expiry_expiry_generator(),
                std::uniform_int_distribution<size_t>(8, 16), std::uniform_int_distribution<size_t>(16, 128), std::uniform_int_distribution<size_t>(4, 16),
                this_shard_id()).get();
