...
def run_scylla_cmd(pid, dir):
    ...
    return ([scylla_link,
        ...
        '--kernel-page-cache', '1',
        '--config', 'commitlog_use_o_dsync: false',
        '--config', 'flush_schema_tables_after_modification: false',
        '--config', f'api_address: {ip}',
        '--config', f'rpc_address: {ip}',
        '--config', f'listen_address: {ip}',
        '--config', f'prometheus_address: {ip}',
        '--config', f'seed_provider: [ {{ parameters: [ {{ seeds: "{ip}" }} ] }} ]',
        '--workdir', dir,
        '--config', 'auto_snapshot: false',
        '--config', 'skip_wait_for_gossip_to_settle: 0',
        ...
        '--config', 'query_tombstone_page_limit: 1000',
        ...
        '--config', 'range_request_timeout_in_ms: 300000',
        '--config', 'read_request_timeout_in_ms: 300000',
        '--config', 'counter_write_request_timeout_in_ms: 300000',
        '--config', 'cas_contention_timeout_in_ms: 300000',
        '--config', 'truncate_request_timeout_in_ms: 300000',
        '--config', 'write_request_timeout_in_ms: 300000',
        '--config', 'request_timeout_in_ms: 300000',
        '--config', 'user_defined_function_time_limit_ms: 1000',
        ...
        # test/alternator/run.
        '--config', 'experimental_features: [udf, keyspace-storage-options]',
        ...
        '--config', 'strict_allow_filtering: true',
        '--config', 'strict_is_not_null_in_views: true',
        '--config', 'permissions_update_interval_in_ms: 100',
        '--config', 'permissions_validity_in_ms: 5',
        '--config', 'shutdown_announce_in_ms: 0',
        '--config', 'maintenance_socket: workdir',
        '--config', 'service_levels_interval_ms: 500',
        # Avoid unhelpful "guardrails" warnings
        '--config', 'minimum_replication_factor_warn_threshold: -1',
        ], env)
