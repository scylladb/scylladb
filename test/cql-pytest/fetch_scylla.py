...
# downloaded (e.g., 5.4.7) and return the ready-to-use scylla executable
# (actually, a shell-script wrapper) in that directory - or raise exception
# if this release cannot be found.
# If the same download was already done in the past, discover this as quickly
# as possible (a 3-component release like 5.4.7 doesn't even require a network
# lookup, a 2-component release like 5.4 does) and don't download again.
