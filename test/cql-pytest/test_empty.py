...
def test_insert_empty_string_key_compact(cql, test_keyspace, compact_storage):
...
def test_insert_empty_string_compound_clustering_key_compact(cql, test_keyspace, compact_storage):
