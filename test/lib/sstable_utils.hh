...
sstables::shared_sstable make_sstable_containing(std::function<sstables::shared_sstable()> sst_factory, mutation_vector muts, validate do_validate = validate::yes);
sstables::shared_sstable make_sstable_containing(sstables::shared_sstable sst, mutation_vector muts, validate do_validate = validate::yes);
