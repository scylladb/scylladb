...
||||||| parent of 2dbd1a85a3 (test/alternator: tests for new auth failure metrics and log messages)
...
def test_rcu(test_table_s, metrics):
    with check_increases_metric_exact(metrics, 'scylla_alternator_rcu_total', 2):
        p = random_string()
        val = random_string()
