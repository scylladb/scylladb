...
# but the item-count metrics should count the requested keys, not the number of
# partitions they fall into. The metrics checked here are:
#   scylla_alternator_batch_item_count{op="BatchGetItem"}
#   scylla_alternator_table_batch_item_count{op="BatchGetItem", cf="<table>"}
# and their _histogram_bucket counterparts.
