...
# The RCU returned is calculated as each of the requests
# separately
def test_simple_batch_get_items(test_table_sb):
    p1 = random_string()
    val = random_string()
    c1 = random_bytes()
    test_table_sb.put_item(Item={'p': p1, 'c': c1, 'att': val}, ReturnConsumedCapacity='TOTAL')

    p2 = random_string()
    c2 = random_bytes()
    test_table_sb.put_item(Item={'p': p2, 'c': c2, 'att': val}, ReturnConsumedCapacity='TOTAL')
