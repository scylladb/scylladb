...
# its type).
# Reproduces #7239 (disabled streams should still be visible) and also
# SCYLLADB-2051 (disabled stream should NOT appear in DescribeTable's
# StreamSpecification).
...
def test_streams_disabled_view_type(dynamodb, dynamodbstreams, stream_type):
    with create_table_ss(dynamodb, dynamodbstreams, stream_type) as (table, arn):
        ...
        # disabled: (reproduces SCYLLADB-2051)
