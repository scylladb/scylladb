...
# Otherwise a ConditionExpression defines that a given value must be different from the already set value.
# With `condition_fails`=False, request is expected to succeed.
# With `condition_fails`=True, request is expected to fail.
