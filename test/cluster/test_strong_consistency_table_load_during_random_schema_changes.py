...
async def op_drop_recreate_keyspace(
    ...
    """
    logger.info("DDL: DROP+RECREATE KEYSPACE starting")
    ...
    state.recreate_count += 1
    logger.info("DDL: DROP+RECREATE KEYSPACE done (recreate #%d)", state.recreate_count)
