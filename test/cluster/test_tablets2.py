...
<<<<<<< HEAD
@pytest.mark.asyncio
||||||| parent of 775623b8c0 (tablets: refresh load stats when resize reconciliation fails)
=======
...
>>>>>>> 775623b8c0 (tablets: refresh load stats when resize reconciliation fails)
@pytest.mark.skip_mode('release', 'error injections are not supported in release mode')
