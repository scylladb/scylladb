...
async def test_different_group0_ids(manager: ManagerClient):
    ...
    cfg = {'force_gossip_topology_changes': True, 'tablets_mode_for_new_keyspaces': 'disabled', 'allowed_repair_based_node_ops': 'replace,removenode,rebuild,bootstrap,decommission'}
