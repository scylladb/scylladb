...
from test.cluster.util import wait_for_cql_and_get_hosts, create_new_test_keyspace, new_test_keyspace, reconnect_driver, get_topology_coordinator, find_server_by_host_id
...
async def test_failed_tablet_rebuild_is_retried(request: pytest.FixtureRequest, manager: ManagerClient) -> None:
    ...
    config = {"tablets_mode_for_new_keyspaces": "enabled", "error_injections_at_startup": [injection], "rf_rack_valid_keyspaces": "false"}
    cmdline = [
