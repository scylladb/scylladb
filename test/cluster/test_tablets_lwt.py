...
async def test_lwt(manager: ScyllaClusterManager, storage_config: FeatureConfig):
...
@pytest.mark.skip_mode(mode='release', reason='error injections are not supported in release mode')
async def test_lwt_state_is_preserved_on_tablet_migration(manager: ScyllaClusterManager, storage_config: FeatureConfig):
    # Scenario:
...
@pytest.mark.skip_mode(mode='release', reason='error injections are not supported in release mode')
async def test_lwt_state_is_preserved_on_tablet_rebuild(manager: ScyllaClusterManager, storage_config: FeatureConfig):
    # Scenario:
...
@pytest.mark.skip_mode(mode='release', reason='error injections are not supported in release mode')
async def test_no_uncertainty_for_reads(manager: ScyllaClusterManager, storage_config: FeatureConfig):
...
async def test_lwts_for_special_tables(manager: ScyllaClusterManager, storage_config: FeatureConfig):
    """
...
@pytest.mark.skip_mode(mode='release', reason='error injections are not supported in release mode')
async def test_tablets_merge_waits_for_lwt(manager: ScyllaClusterManager, scale_timeout, storage_config: FeatureConfig):
    """
    ...
    config = storage_config.get_cluster_cfg(config)
...
@pytest.mark.skip_mode(mode='release', reason='error injections are not supported in release mode')
async def test_column_mapping_migrated_with_tablet(manager: ScyllaClusterManager, storage_config: FeatureConfig):
