...
<<<<<<< HEAD
||||||| parent of 164364ed3e (test/cluster/test_encryption.py: use single-partition reads in read_verify_workload())
...
async def test_system_encryption_reboot(manager: ManagerClient, tmpdir):
    ...
    async with LocalFileSystemKeyProviderFactory(tmpdir) as kp:
        await _smoke_test(manager, key_provider=kp, 
                          ...
                          options=options,
                          restart=restart)
>>>>>>> 164364ed3e (test/cluster/test_encryption.py: use single-partition reads in read_verify_workload())
