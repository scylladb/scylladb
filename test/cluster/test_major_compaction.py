...
@pytest.mark.skip_mode(mode='release', reason='error injections are not supported in release mode')
async def test_stop_compaction_stops_major_compaction(manager: ScyllaClusterManager, stop_type):
    """
...
@pytest.mark.skip_mode(mode='release', reason='error injections are not supported in release mode')
async def test_stop_regular_compaction_does_not_stop_major_compaction(manager: ScyllaClusterManager):
    """
...
async def test_stop_compaction_type_translation(manager: ScyllaClusterManager, stop_type, expected_types):
    """
