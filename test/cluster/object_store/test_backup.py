...
||||||| parent of 6e12b730cd (test: check tablet hints survive node loss during tablet restore)
...
async def test_restore_tablets_leaves_a_hintless_table_resizable(build_mode: str, manager: ScyllaClusterManager,
>>>>>>> 6e12b730cd (test: check tablet hints survive node loss during tablet restore)
                                                                 object_storage):
