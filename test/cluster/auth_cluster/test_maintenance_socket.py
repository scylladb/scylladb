...
async def test_no_default_superuser_exists_by_default(manager: ManagerClient):
    ...
    # Verify we cannot connect with default credentials
    try:
...
async def test_no_default_superuser_maintenance_socket_ops(manager: ManagerClient):
    ...
    # Connect via Maintenance Socket
    ...
    # Check system.roles content BEFORE operations
    ...
    # Test CREATE ROLE WITH HASHED PASSWORD
