...
||||||| parent of b7e6d479a8 (test/cluster/test_bti_index: rework the test to incorporate both "mt" and "ms")
...
async def test_bti_index_output_format(manager: ManagerClient) -> None:
    ...
    """
>>>>>>> b7e6d479a8 (test/cluster/test_bti_index: rework the test to incorporate both "mt" and "ms")
