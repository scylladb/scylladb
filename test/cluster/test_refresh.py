...
<<<<<<< HEAD
||||||| parent of 13e93e1014 (test/cluster: cover refresh racing with its own sstable rewrites)
...
async def test_refresh_does_not_claim_sstables_created_by_another_shard(manager: ScyllaClusterManager):
    ...
    async with new_test_keyspace(manager, "WITH replication = {'class': 'NetworkTopologyStrategy', "
        ...
        await wait_for_upload_dir_empty(upload_dir)
>>>>>>> 13e93e1014 (test/cluster: cover refresh racing with its own sstable rewrites)
