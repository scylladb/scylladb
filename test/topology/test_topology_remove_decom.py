...
<<<<<<< HEAD:test/topology/test_topology_remove_decom.py
||||||| parent of dbb8835fdf (test/cluster: Adjust simple tests to RF-rack-validity):test/cluster/test_topology_remove_decom.py
pytestmark = pytest.mark.prepare_3_nodes_cluster
=======
pytestmark = pytest.mark.prepare_3_racks_cluster
>>>>>>> dbb8835fdf (test/cluster: Adjust simple tests to RF-rack-validity):test/cluster/test_topology_remove_decom.py
