...
scylla_core = (['message/messaging_service.cc',
                ...
                'service/raft/strong_consistency/sc_groups_manager.cc',
                'service/raft/strong_consistency/sc_storage_proxy.cc',
                'service/raft/strong_consistency/sc_state_machine.cc',
