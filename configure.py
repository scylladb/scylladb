...
scylla_core = (['message/messaging_service.cc',
                ...
                'utils/s3/config_file_aws_credentials_provider.cc',
                'utils/s3/environment_aws_credentials_provider.cc',
                'utils/s3/instance_profile_credentials_provider.cc',
                'utils/s3/sts_assume_role_credentials_provider.cc',
                'utils/s3/aws_credentials_provider_chain.cc',
