...
modes = {
    ...
    'sanitize': {
        'cxxflags': '-g1 -DSANITIZE -DSCYLLA_ENABLE_ERROR_INJECTION',
        'cxx_ld_flags': '',
        ...
        'build_seastar_shared_libs': False,
        'default': False,
        'description': 'a mode with optimizations and sanitizersenabled, used to simulate release mode with sanitizers for CI runs',
        'advanced_optimizations': False,
    },
    'coverage': {
