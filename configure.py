...
scylla_tests = set([
    'test/boost/boost_boost_combined_tests',
    'test/boost/boost_seastar_combined_tests',
...
raft_tests = set([
    'test/raft/raft_boost_combined_tests',
    'test/raft/raft_seastar_combined_tests',
])
...
deps['test/boost/boost_boost_combined_tests'] += [
    'test/boost/UUID_test.cc',
    'test/boost/allocation_strategy_test.cc',
    'test/boost/alternator_unit_test.cc',
    'test/boost/anchorless_list_test.cc',
    'test/boost/auth_passwords_test.cc',
    'test/boost/auth_resource_test.cc',
    'test/boost/big_decimal_test.cc',
    'test/boost/bytes_ostream_test.cc',
    'test/boost/caching_options_test.cc',
    'test/boost/cartesian_product_test.cc',
    'test/boost/cdc_generation_test.cc',
    'test/boost/checksum_utils_test.cc',
    'test/boost/chunked_vector_test.cc',
    'test/boost/compress_test.cc',
    'test/boost/cql_auth_syntax_test.cc',
    'test/boost/crc_test.cc',
    'test/boost/duration_test.cc',
    'test/boost/dynamic_bitset_test.cc',
    'test/boost/enum_option_test.cc',
    'test/boost/enum_set_test.cc',
    'test/boost/estimated_histogram_test.cc',
    'test/boost/expr_test.cc',
    'test/boost/idl_test.cc',
    'test/boost/input_stream_test.cc',
    'test/boost/json_test.cc',
    'test/boost/keys_test.cc',
    'test/boost/like_matcher_test.cc',
    'test/boost/linearizing_input_stream_test.cc',
    'test/boost/log_heap_test.cc',
    'test/boost/managed_bytes_test.cc',
    'test/boost/map_difference_test.cc',
    'test/boost/murmur_hash_test.cc',
    'test/boost/nonwrapping_interval_test.cc',
    'test/boost/observable_test.cc',
    'test/boost/pretty_printers_test.cc',
    'test/boost/range_tombstone_list_test.cc',
    'test/boost/rust_test.cc',
    'test/boost/serialization_test.cc',
    'test/boost/small_vector_test.cc',
    'test/boost/string_format_test.cc',
    'test/boost/summary_test.cc',
    'test/boost/sstable_generation_test.cc',
    'test/boost/top_k_test.cc',
    'test/boost/utf8_test.cc',
    'test/boost/vint_serialization_test.cc',
    'test/boost/wrapping_interval_test.cc',
    'test/lib/expr_test_utils.cc',
    'rust/inc/src/lib.rs',
]

deps['test/boost/boost_seastar_combined_tests'] += [
    ...
    'test/boost/btree_test.cc',
    'test/boost/cache_algorithm_test.cc',
    'test/boost/cached_file_test.cc',
    'test/boost/cache_mutation_reader_test.cc',
    'test/boost/canonical_mutation_test.cc',
    'test/boost/castas_fcts_test.cc',
    'test/boost/cell_locker_test.cc',
    'test/boost/cdc_test.cc',
    'test/boost/chunked_managed_vector_test.cc',
    'test/boost/clustering_ranges_walker_test.cc',
    ...
    'test/boost/continuous_data_consumer_test.cc',
    'test/boost/counter_test.cc',
    ...
    'test/boost/exception_container_test.cc',
    ...
    'test/boost/flush_queue_test.cc',
    'test/boost/fragmented_temporary_buffer_test.cc',
    'test/boost/frozen_mutation_test.cc',
    'test/boost/generic_server_test.cc',
    'test/boost/gossiping_property_file_snitch_test.cc',
    'test/boost/group0_cmd_merge_test.cc',
    'test/boost/group0_test.cc',
    'test/boost/hash_test.cc',
    'test/boost/hashers_test.cc',
    'test/boost/hint_test.cc',
    'test/boost/index_reader_test.cc',
    'test/boost/index_with_paging_test.cc',
    'test/boost/intrusive_array_test.cc',
    'test/boost/json_cql_query_test.cc',
    'test/boost/large_paging_state_test.cc',
    'test/boost/limiting_data_source_test.cc',
    'test/boost/lister_test.cc',
    'test/boost/loading_cache_test.cc',
    'test/boost/locator_topology_test.cc',
    'test/boost/logalloc_standard_allocator_segment_pool_backend_test.cc',
    'test/boost/logalloc_test.cc',
    'test/boost/managed_vector_test.cc',
    ...
    'test/boost/mutation_reader_another_test.cc',
    ...
    'test/boost/serialized_action_test.cc',
    'test/boost/service_level_controller_test.cc',
    'test/boost/sessions_test.cc',
    'test/boost/snitch_reset_test.cc',
    'test/boost/sorting_test.cc',
    ...
    'test/boost/tagged_integer_test.cc',
    'test/boost/token_metadata_test.cc',
    'test/boost/tracing_test.cc',
    'test/boost/transport_test.cc',
    ...
    'test/boost/wasm_alloc_test.cc',
    'test/boost/wasm_test.cc',
    'test/boost/tree_test_key.cc',
    'tools/schema_loader.cc',
...
deps['test/raft/raft_boost_combined_tests'] = [
    'test/raft/raft_boost_combined_tests.cc',
    'test/raft/fsm_test.cc',
    'test/raft/etcd_test.cc',
    'test/raft/discovery_test.cc',
    'test/raft/helpers.cc',
    'test/lib/log.cc',
    'service/raft/discovery.cc'
] + scylla_raft_dependencies
deps['test/raft/raft_seastar_combined_tests'] = [
    'test/raft/raft_seastar_combined_tests.cc',
    'test/raft/replication_test.cc',
    'test/raft/randomized_nemesis_test.cc',
    'test/raft/many_test.cc',
    'test/raft/raft_server_test.cc',
    'test/raft/raft_sys_table_storage_test.cc',
    'test/raft/raft_address_map_test.cc',
    'test/raft/failure_detector_test.cc',
    'test/raft/replication.cc',
    'test/raft/helpers.cc',
