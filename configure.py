...
scylla_core = (['message/messaging_service.cc',
                ...
                'cql3/statements/strong_consistency/sc_modification_statement.cc',
                'cql3/statements/strong_consistency/sc_select_statement.cc',
                'cql3/statements/strong_consistency/sc_statement_helpers.cc',
                ...
                'service/strong_consistency/sc_groups_manager.cc',
                'service/strong_consistency/sc_storage_proxy.cc',
                'service/strong_consistency/sc_state_machine.cc',
