...
scylla_tests = set([
    ...
    'test/boost/parquet_tiering_test',
...
scylla_core = (['message/messaging_service.cc',
                ...
                'sstables/parquet/format/parquet_metadata.cc',
                'sstables/parquet/format/page_header.cc',
                'sstables/parquet/format/parquet_writer.cc',
                'sstables/parquet/schema_mapping.cc',
                'sstables/parquet/writer_impl.cc',
                'sstables/parquet/reader.cc',
                'sstables/parquet/batch_reader.cc',
                'sstables/parquet/tiering_policy.cc',
                'sstables/parquet/tiering_context.cc',
                'sstables/parquet/gain_estimator.cc',
                'sstables/parquet/format/parquet_reader.cc',
                'sstables/parquet/format/encryption.cc',
                'sstables/parquet/encryption_keys.cc',
                ...
                'ent/encryption/parquet_key_source.cc',
