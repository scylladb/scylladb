...
scylla_core = (['database.cc',
                ...
                'sstables/writer.cc',
                'cql3/transport/cql_protocol_extension.cc',
                'cql3/transport/event.cc',
                'cql3/transport/event_notifier.cc',
                'cql3/transport/server.cc',
                'cql3/transport/controller.cc',
                'cql3/transport/messages/result_message.cc',
