...
scylla_core = (['database.cc',
                ...
                'sstables/writer.cc',
                'cassandra/transport/cql_protocol_extension.cc',
                'cassandra/transport/event.cc',
                'cassandra/transport/event_notifier.cc',
                'cassandra/transport/server.cc',
                'cassandra/transport/controller.cc',
                'cassandra/transport/messages/result_message.cc',
                'cdc/cdc_partitioner.cc',
                'cdc/log.cc',
                'cdc/split.cc',
                'cdc/generation.cc',
                'cdc/metadata.cc',
                'cassandra/cql3/type_json.cc',
                'cassandra/cql3/abstract_marker.cc',
                'cassandra/cql3/attributes.cc',
                'cassandra/cql3/cf_name.cc',
                'cassandra/cql3/cql3_type.cc',
                'cassandra/cql3/operation.cc',
                'cassandra/cql3/index_name.cc',
                'cassandra/cql3/keyspace_element_name.cc',
                'cassandra/cql3/lists.cc',
                'cassandra/cql3/sets.cc',
                'cassandra/cql3/tuples.cc',
                'cassandra/cql3/maps.cc',
                'cassandra/cql3/values.cc',
                'cassandra/cql3/expr/expression.cc',
                'cassandra/cql3/functions/user_function.cc',
                'cassandra/cql3/functions/functions.cc',
                'cassandra/cql3/functions/aggregate_fcts.cc',
                'cassandra/cql3/functions/castas_fcts.cc',
                'cassandra/cql3/functions/error_injection_fcts.cc',
                'cassandra/cql3/statements/cf_prop_defs.cc',
                'cassandra/cql3/statements/cf_statement.cc',
                'cassandra/cql3/statements/authentication_statement.cc',
                'cassandra/cql3/statements/create_keyspace_statement.cc',
                'cassandra/cql3/statements/create_table_statement.cc',
                'cassandra/cql3/statements/create_view_statement.cc',
                'cassandra/cql3/statements/create_type_statement.cc',
                'cassandra/cql3/statements/create_function_statement.cc',
                'cassandra/cql3/statements/drop_index_statement.cc',
                'cassandra/cql3/statements/drop_keyspace_statement.cc',
                'cassandra/cql3/statements/drop_table_statement.cc',
                'cassandra/cql3/statements/drop_view_statement.cc',
                'cassandra/cql3/statements/drop_type_statement.cc',
                'cassandra/cql3/statements/drop_function_statement.cc',
                'cassandra/cql3/statements/schema_altering_statement.cc',
                'cassandra/cql3/statements/ks_prop_defs.cc',
                'cassandra/cql3/statements/function_statement.cc',
                'cassandra/cql3/statements/modification_statement.cc',
                'cassandra/cql3/statements/cas_request.cc',
                'cassandra/cql3/statements/raw/parsed_statement.cc',
                'cassandra/cql3/statements/property_definitions.cc',
                'cassandra/cql3/statements/update_statement.cc',
                'cassandra/cql3/statements/delete_statement.cc',
                'cassandra/cql3/statements/batch_statement.cc',
                'cassandra/cql3/statements/select_statement.cc',
                'cassandra/cql3/statements/use_statement.cc',
                'cassandra/cql3/statements/index_prop_defs.cc',
                'cassandra/cql3/statements/index_target.cc',
                'cassandra/cql3/statements/create_index_statement.cc',
                'cassandra/cql3/statements/truncate_statement.cc',
                'cassandra/cql3/statements/alter_table_statement.cc',
                'cassandra/cql3/statements/alter_view_statement.cc',
                'cassandra/cql3/statements/list_users_statement.cc',
                'cassandra/cql3/statements/authorization_statement.cc',
                'cassandra/cql3/statements/permission_altering_statement.cc',
                'cassandra/cql3/statements/list_permissions_statement.cc',
                'cassandra/cql3/statements/grant_statement.cc',
                'cassandra/cql3/statements/revoke_statement.cc',
                'cassandra/cql3/statements/alter_type_statement.cc',
                'cassandra/cql3/statements/alter_keyspace_statement.cc',
                'cassandra/cql3/statements/role-management-statements.cc',
                'cassandra/cql3/update_parameters.cc',
                'cassandra/cql3/util.cc',
                'cassandra/cql3/ut_name.cc',
                'cassandra/cql3/role_name.cc',
                'cassandra/thrift/handler.cc',
                'cassandra/thrift/server.cc',
                'cassandra/thrift/controller.cc',
                'cassandra/thrift/thrift_validation.cc',
                'utils/runtime.cc',
                ...
                'cassandra/cql3/relation.cc',
                'cassandra/cql3/column_identifier.cc',
                'cassandra/cql3/column_specification.cc',
                'cassandra/cql3/constants.cc',
                'cassandra/cql3/query_processor.cc',
                'cassandra/cql3/query_options.cc',
                'cassandra/cql3/single_column_relation.cc',
                'cassandra/cql3/token_relation.cc',
                'cassandra/cql3/column_condition.cc',
                'cassandra/cql3/user_types.cc',
                'cassandra/cql3/untyped_result_set.cc',
                'cassandra/cql3/selection/abstract_function_selector.cc',
                'cassandra/cql3/selection/simple_selector.cc',
                'cassandra/cql3/selection/selectable.cc',
                'cassandra/cql3/selection/selector_factories.cc',
                'cassandra/cql3/selection/selection.cc',
                'cassandra/cql3/selection/selector.cc',
                'cassandra/cql3/restrictions/statement_restrictions.cc',
                'cassandra/cql3/result_set.cc',
                'cassandra/cql3/variable_specifications.cc',
                ...
                ] + [Antlr3Grammar('cassandra/cql3/Cql.g')] + [Thrift('interface/cassandra.thrift', 'Cassandra')] \
                  + scylla_raft_core
               )
