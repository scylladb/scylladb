...
scylla_core = (['message/messaging_service.cc',
                ...
                'utils/s3/client.cc',
                'utils/s3/helpers/bucket_lister.cc',
                'utils/s3/helpers/copy_s3_object.cc',
                'utils/s3/helpers/do_upload_file.cc',
                'utils/s3/helpers/download_source.cc',
                'utils/s3/helpers/multipart_upload.cc',
                'utils/s3/helpers/readable_file.cc',
                'utils/s3/helpers/upload_sinks.cc',
                ...
                'utils/s3/utils/client_utils.cc',
