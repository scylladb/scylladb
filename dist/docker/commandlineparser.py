...
def parse():
    ...
    parser.add_argument('--alternator-write-consistency-level', default=None, dest='alternatorWriteCL', help="Alternator default write consistency level. Should be LOCAL_QUORUM or QUORUM.")
