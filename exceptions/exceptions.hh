...
struct rate_limit_exception : public cassandra_exception {
    ...
    // Constructor for deserialization (message already formatted)
    rate_limit_exception(sstring message, db::operation_type op_type_, bool rejected_by_coordinator_) noexcept;
};
