...
std::vector<sstables::shared_sstable> table_state_view::filter_sstables(std::vector<sstables::shared_sstable> sstables) const {
    return repair::filter_sstables(std::move(sstables), repair_state, ts->get_sstables_repaired_at());
}

std::vector<sstables::frozen_sstable_run> table_state_view::filter_sstables(std::vector<sstables::frozen_sstable_run> sstables) const {
    return repair::filter_sstables(std::move(sstables), repair_state, ts->get_sstables_repaired_at());
}
