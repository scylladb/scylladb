...
private:
    ...
    // The abort source of the task owning this repair. Plugged in with
    // plug_abort_source() when the task starts.
...
public:
    shard_repair_state(repair_service& repair,
            sstring keyspace,
    ...
    void plug_abort_source(seastar::abort_source& as) noexcept {
        _as = &as;
    }
