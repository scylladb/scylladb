...
In ScyllaDB releases older than ScyllaDB Open Source 4.3 and ScyllaDB Enterprise 2021.1, seed node has one more function: it assists with [gossip](https://opensource.docs.scylladb.com/branch-6.1/kb/gossip.md) convergence.
