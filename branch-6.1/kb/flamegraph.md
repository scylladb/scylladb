...
1. Install flamegraph and flamegraph-stackcollapse-perf
   ...
   cd FlameGraph
   ```
2. Run the following perf commands, using [Map CPU to ScyllaDB Shards](https://opensource.docs.scylladb.com/branch-6.1/kb/map-cpu.md)  and [Using the perf utility with ScyllaDB](https://opensource.docs.scylladb.com/branch-6.1/kb/use-perf.md) for reference.
   ```shell
