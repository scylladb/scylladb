...
specify a Consistency Level per query is known as [Tunable Consistency](https://opensource.docs.scylladb.com/branch-6.1/reference/glossary.md#term-Tunable-Consistency).
