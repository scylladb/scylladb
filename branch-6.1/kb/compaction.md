...
* Minor Compaction
  : ScyllaDB automatically triggers a compaction of some SSTables, according to a [compaction strategy](https://opensource.docs.scylladb.com/branch-6.1/reference/glossary.md#term-Compaction-Strategy) (as described below). This is the recommended method.
* Major Compaction
...
Compaction strategies are set as part of the `CREATE` or `ALTER` statement when creating or altering tables. Refer to the [CQL syntax](https://opensource.docs.scylladb.com/branch-6.1/cql/compaction.md) for details.
...
An SSTable is added to an existing bucket if size of the SSTable is within the parameters: [bucket_low](https://opensource.docs.scylladb.com/branch-6.1/cql/compaction.md#stcs-options) and [bucket_high](https://opensource.docs.scylladb.com/branch-6.1/cql/compaction.md#stcs-options), which is based on calculating the current average size of the SSTables already in the bucket.
...
Use the table in [Which strategy is best](https://opensource.docs.scylladb.com/branch-6.1/architecture/compaction/compaction-strategies.md#which-strategy-is-best) to determine the right strategy for your needs.

## References

* [CQL Reference for Compaction](https://opensource.docs.scylladb.com/branch-6.1/cql/compaction.md)
