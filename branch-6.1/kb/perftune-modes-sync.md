...
the `sq_split` mode instead of the `mq` mode (see [Seastar Perftune](https://opensource.docs.scylladb.com/branch-6.1/operating-scylla/admin-tools/perftune.md) for information about the modes).
