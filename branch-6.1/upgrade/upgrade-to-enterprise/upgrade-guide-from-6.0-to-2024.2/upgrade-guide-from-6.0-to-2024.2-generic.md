...
and Ubuntu. See [OS Support by Platform and Version](https://opensource.docs.scylladb.com/branch-6.1/getting-started/os-support.md)
...
If you’re using a [ScyllaDB driver](https://opensource.docs.scylladb.com/branch-6.1/using-scylla/drivers/cql-drivers/index.md),
...
See [Data Distribution with Tablets](https://opensource.docs.scylladb.com/branch-6.1/architecture/tablets.md) for more information
about tablets.
...
See [Restore from a Backup and Incremental Backup](https://opensource.docs.scylladb.com/branch-6.1/operating-scylla/procedures/backup-restore/restore.md)
for reference.
