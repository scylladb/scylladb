...
* Replication of row-level changes from ScyllaDB using [ScyllaDB CDC](https://opensource.docs.scylladb.com/branch-6.1/using-scylla/cdc/cdc-intro.md). The connector replicates the following operations: `INSERT`, `UPDATE`, `DELETE` (single row deletes)
...
* [ScyllaDB CDC Source Connector Quickstart](https://opensource.docs.scylladb.com/branch-6.1/using-scylla/integrations/scylla-cdc-source-connector-quickstart.md)
