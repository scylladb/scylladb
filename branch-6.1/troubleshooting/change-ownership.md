...
In cases where the ScyllaDB node fails to start, check ScyllaDB [logs](https://opensource.docs.scylladb.com/branch-6.1/getting-started/logging.md). If you see the following error message:
...
[Troubleshoot](https://opensource.docs.scylladb.com/branch-6.1/troubleshooting/index.md)
