...
<a id="system-requirements-supported-platforms"></a>
...
See [OS Support by Platform and Version](https://opensource.docs.scylladb.com/branch-6.1/getting-started/os-support.md) for information about
supported operating systems, distros, and versions.

See [Cloud Instance Recommendations for AWS, GCP, and Azure](https://opensource.docs.scylladb.com/branch-6.1/getting-started/cloud-instance-recommendations.md) for information
about instance types recommended for cloud deployments.

<a id="system-requirements-hardware"></a>

## Hardware Requirements

It’s recommended to have a balanced setup. If there are only 4-8 [Logical Cores](https://opensource.docs.scylladb.com/branch-6.1/reference/glossary.md#term-Logical-Core-lcore), large disks or 10Gbps networking may not be needed.
This works in the opposite direction as well.
ScyllaDB can be used in many types of installation environments.

To see which system would best suit your workload requirements, use the [ScyllaDB Sizing Calculator](https://www.scylladb.com/product/scylla-cloud/get-pricing/) to customize ScyllaDB for your usage.
...
<a id="system-requirements-disk"></a>
...
Use the default ICS  unless you’ll have a clear understanding that another strategy is better for your use case. More on [choosing a Compaction Strategy](https://opensource.docs.scylladb.com/branch-6.1/architecture/compaction/compaction-strategies.md).
In order to maintain a high level of service availability, keep 50% to 20% free disk space at all times!

<a id="system-requirements-network"></a>
