...
controlled by the [`enable_tablets`](https://opensource.docs.scylladb.com/branch-6.1/reference/configuration-parameters.md#confval-enable_tablets) option. However, tablets only work if
