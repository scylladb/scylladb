...
#### NOTE
ScyllaDB Open Source 3.0 and later and ScyllaDB Enterprise 2019.1 and later support [Materialized View(MV)](https://opensource.docs.scylladb.com/branch-6.1/using-scylla/materialized-views.md) and [Secondary Index(SI)](https://opensource.docs.scylladb.com/branch-6.1/using-scylla/secondary-indexes.md).
...
* Upload all the data with sstableloader first, and only then [create the secondary indexes](https://opensource.docs.scylladb.com/branch-6.1/cql/secondary-indexes.md#create-index-statement) and [MVs](https://opensource.docs.scylladb.com/branch-6.1/cql/mv.md#create-materialized-view-statement).
...
More on [ScyllaDB and Apache Cassandra Compatibility](https://opensource.docs.scylladb.com/branch-6.1/using-scylla/cassandra-compatibility.md)
