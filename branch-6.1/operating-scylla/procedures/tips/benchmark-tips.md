...
Install and use the [ScyllaDB Monitoring Stack](http://monitoring.docs.scylladb.com/); it gives excellent additional value beyond performance.
...
With the recent addition of the [ScyllaDB Advisor](http://monitoring.docs.scylladb.com/stable/advisor.html) to the ScyllaDB Monitoring Stack, it is even easier to find potential issues.

## Install ScyllaDB Manager

Install and use [ScyllaDB Manager](https://manager.docs.scylladb.com) together with the [ScyllaDB Monitoring Stack](http://monitoring.docs.scylladb.com/).
...
But, if `scylla_setup` has not run, the system won’t be configured optimally. Refer to the [System Configuration](https://opensource.docs.scylladb.com/branch-6.1/getting-started/system-configuration.md) guide for details.
...
Tools, such as [cassandra-stress](https://opensource.docs.scylladb.com/branch-6.1/operating-scylla/admin-tools/cassandra-stress.md), use a default data model that does not reflect the actions that you will perform in production.
...
* [Large partitions](https://opensource.docs.scylladb.com/branch-6.1/troubleshooting/large-partition-table.md), [large rows and large cells](https://opensource.docs.scylladb.com/branch-6.1/troubleshooting/large-rows-large-cells-tables.md) should be avoided because it can cause high latencies.
...
Read more about [Stop Wasting ScyllaDB’s CPU Time by Not Being Prepared](https://www.scylladb.com/2017/12/13/prepared-statements-scylla/).
...
[Workload prioritization](https://enterprise.docs.scylladb.com/stable/using-scylla/workload-prioritization.html) is only available with [ScyllaDB Enterprise](https://enterprise.docs.scylladb.com/).
...
See [Bypass Cache](https://opensource.docs.scylladb.com/branch-6.1/cql/dml/select.md#bypass-cache) for more information.
...
Without [batching](https://opensource.docs.scylladb.com/branch-6.1/cql/dml/batch.md#batch-statement) the total latency would be 10x(0.9+0.1)=10.0 ms.
...
Use the [ScyllaDB drivers](https://opensource.docs.scylladb.com/branch-6.1/using-scylla/drivers/index.md) that are available for Java, Python, Go, and C/C++.
...
Read more about [ScyllaDB System Requirements](https://opensource.docs.scylladb.com/branch-6.1/getting-started/system-requirements.md).
...
Read more about  [ScyllaDB System Requirements](https://opensource.docs.scylladb.com/branch-6.1/getting-started/system-requirements.md) or [Starting ScyllaDB in a Shared Environment](https://opensource.docs.scylladb.com/branch-6.1/getting-started/scylla-in-a-shared-environment.md).
...
Read more about [ScyllaDB Network Requirements](https://opensource.docs.scylladb.com/branch-6.1/getting-started/system-requirements.md#system-requirements-network).
...
Read more about [Starting ScyllaDB in a Shared Environment](https://opensource.docs.scylladb.com/branch-6.1/getting-started/scylla-in-a-shared-environment.md).
...
Read more about [ScyllaDB Supported Platforms](https://opensource.docs.scylladb.com/branch-6.1/getting-started/system-requirements.md#system-requirements-supported-platforms).
...
Read more about [Azure Requirements](https://opensource.docs.scylladb.com/branch-6.1/getting-started/cloud-instance-recommendations.md#system-requirements-azure).

### Docker

When running in Docker platform, please use CPU pinning and host networking for best performance.
Read more about [The Cost of Containerization for Your ScyllaDB](https://www.scylladb.com/2018/08/09/cost-containerization-scylla/).
...
Read more about [Exploring ScyllaDB on Kubernetes](https://www.scylladb.com/2018/03/29/scylla-kubernetes-overview/).
...
* Use the following [Compaction Strategy Matrix](https://opensource.docs.scylladb.com/branch-6.1/architecture/compaction/compaction-strategies.md#csm1) to use the correct compaction strategy for your workload.
...
Read more about [Compaction Strategies](https://opensource.docs.scylladb.com/branch-6.1/architecture/compaction/compaction-strategies.md)
...
Read more about [Fault Tolerance](https://opensource.docs.scylladb.com/branch-6.1/architecture/architecture-fault-tolerance.md)
