...
See [Remove a Node from a ScyllaDB Cluster (Down Scale)](https://opensource.docs.scylladb.com/branch-6.1/operating-scylla/procedures/cluster-management/remove-node.md)
