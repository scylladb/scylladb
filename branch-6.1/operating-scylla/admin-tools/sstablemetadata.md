...
Please consider switching to [dump-statistics](https://opensource.docs.scylladb.com/branch-6.1/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-statistics) and [dump-summary](https://opensource.docs.scylladb.com/branch-6.1/operating-scylla/admin-tools/scylla-sstable.md#scylla-sstable-dump-summary).
