...
For more information about the sstable components and the format itself, visit [SSTable Format](https://opensource.docs.scylladb.com/branch-6.1/architecture/sstable/index.md).
