...
ScyllaDB introduces JSON support to [SELECT](https://opensource.docs.scylladb.com/branch-6.1/cql/dml/select.md#select-statement) and [INSERT](https://opensource.docs.scylladb.com/branch-6.1/cql/dml/insert.md#insert-statement)
...
| `timestamp` | integer, string        | string          | A timestamp. Strings constant allows to input [timestamps<br/>as dates](https://opensource.docs.scylladb.com/branch-6.1/cql/types.md#timestamps). Datestamps with format `YYYY-MM-DD<br/>HH:MM:SS.SSS` are returned. |
