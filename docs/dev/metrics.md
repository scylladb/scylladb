...
same "ks" and "cf" labels. They do not depend on the flag above: they are
always on, summed over the shards of the node, and reported per shard only
with `enable_strong_consistency_per_shard_metrics`. See
