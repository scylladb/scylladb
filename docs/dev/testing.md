...
This means that `test.py` will not run tests directly, but will delegate all work to the `pytest`.
That's why all theses directories do not have `suite.yaml` files.
