...
- `tablet_count` - contains the number of tablets allcated in the table. If `tablets_type` is `powof2`, the tablet_count would be a power of 2.
...
The `files` member contains a list of non-SSTable files included in the snapshot directory.
```
