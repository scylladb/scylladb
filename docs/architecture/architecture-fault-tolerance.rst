...
The Consistency Level itself impacts availability. A **higher** Consistency Level (more nodes required to be online)  means less availability but with higher tolerance node failures. A **lower** Consistency Level means more availability but less fault tolerance.
