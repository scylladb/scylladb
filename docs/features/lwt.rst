...
This table is automatically created and maintained by Scylla on each node and holds Paxos
...
Access to the `$paxos` tables is restricted. Scylla does not grant any explicit permissions on them.
