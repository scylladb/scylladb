...
* For batch statement, ScyllaDB allows mixing `IF EXISTS`, `IF NOT EXISTS`, and other conditions.
...
More on :doc:`Lightweight Transactions (LWT) </features/lwt>` and :doc:`ScyllaDB CQL Extensions </cql/cql-extensions>`
