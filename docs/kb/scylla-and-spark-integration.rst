...
``src/main/scala/ScyllaDBSparkExampleSimple.scala``:
...
.. code:: scala
    ...
    object ScyllaDBSparkExampleSimple {
...
::
    ...
    ./bin/spark-submit --properties-file /path/to/scylla-spark-example/spark-scylla.conf \
        --class ScyllaDBSparkExampleSimple /path/to/scylla-spark-example/target/scala-2.10/scylla-spark-example-simple-assembly-1.0.jar
