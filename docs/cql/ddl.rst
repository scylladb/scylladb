...
- After ``ALTER`` statement that increases the RF finishes, client applications should be restarted. Without restart drivers will not know about new replicas, which may cause request imbalance.
