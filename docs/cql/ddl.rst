...
.. code-block:: cql
   ...
   unquoted_name: re('[a-zA-Z_0-9]{1, 207}')
   quoted_name: '"' `unquoted_name` '"'

Both keyspace and table names consist of only alphanumeric characters, cannot be empty, and are limited in
size to 207 characters (that limit exists mostly to avoid filenames, which may include the keyspace and table name, to go
