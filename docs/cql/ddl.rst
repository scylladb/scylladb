...
to use. The default supported class are ``'IncrementalCompactionStrategy'``,
``'LeveledCompactionStrategy'``, and ``'TimeWindowCompactionStrategy'``.
...
the strategy chosen (see the section corresponding to your strategy for details: :ref:`ICS <ics-options>`, :ref:`LCS <lcs-options>`, :ref:`TWCS <twcs-options>`, and :ref:`STCS <stcs-options>`).
