...
.. code-block:: sh
   ...
   wget https://github.com/scylladb/scylla-monitoring/archive/scylla-monitoring-3.1.tar.gz
   tar -xvf scylla-monitoring-3.1.tar.gz
   cd scylla-monitoring-scylla-monitoring-3.1
