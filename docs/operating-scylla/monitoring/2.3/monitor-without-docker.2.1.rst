...
The following instructions will help to deploy :doc:`Scylla Monitoring Stack</operating-scylla/monitoring/2.3/monitoring-stack/>` in the case you can not use the docker version.
