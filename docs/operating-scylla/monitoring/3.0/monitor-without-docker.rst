...
2. Copy the following file: ``rule_config.yml`` from ``scylla-monitoring-scylla-monitoring-3.0/prometheus`` directory to ``alertmanager.yml`` in the alertmanager installation directory.

For example:

.. code-block:: shell

   cp -p /home/centos/scylla-monitoring-scylla-monitoring-3.0/prometheus/rule_config.yml /home/centos/alertmanager-0.16.0.linux-amd64/alertmanager.yml
...
2. Copy the following files: ``scylla_servers.yml``, ``node_exporter_servers.yml``, ``prometheus.rules.yml`` from ``scylla-monitoring-scylla-monitoring-3.0/prometheus`` directory to the Prometheus installation directory.
...
.. code-block:: shell
   ...
   cp -p /home/centos/scylla-monitoring-scylla-monitoring-3.0/prometheus/*.yml /home/centos/prometheus-2.6.1.linux-amd64
...
``cd /home/centos/scylla-monitoring-scylla-monitoring-3.0/``
...
.. code-block:: shell
   ...
   cp -r grafana/plugins /home/centos/grafana-6.1.6/public/app
...
.. code-block:: shell
   ...
   cp -p -r grafana/build/* /home/centos/grafana-6.1.6/public/build/
   cp -p grafana/provisioning/dashboards/load.* /home/centos/grafana-6.1.6/conf/provisioning/dashboards/

Edit the ``load.*``  files in ``/home/centos/grafana-6.1.6/conf/provisioning/dashboards/`` for the correct path,
for example ``load.3.0.yaml`` would point to: ``/home/centos/grafana-6.1.6/public/build/ver_3.0``
...
.. code-block:: shell
   ...
   cp -p grafana/datasource.yml /home/centos/grafana-6.1.6/conf/provisioning/datasources/
...
``cp -p /home/centos/grafana-6.1.6/conf/sample.ini /home/centos/grafana-6.1.6/conf/scylla.ini``
...
.. code-block:: shell
    ...
    plugins = /home/centos/grafana-6.1.6/data/plugins
    provisioning = /home/centos/grafana-6.1.6/conf/provisioning
...
.. code-block:: shell
    ...
    cd /home/centos/grafana-6.1.6/
    ./bin/grafana-server -config /home/centos/grafana-6.1.6/conf/scylla.ini
