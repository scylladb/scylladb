...
||||||| parent of 0ba3dabcd9 (Merge '[Backport 2025.3] docs: update a documentation of adding/removing DC and rebuilding a node' from Scylladb[bot])
=======
   For tablet keyspaces, update the replication factor one by one:
...
>>>>>>> 0ba3dabcd9 (Merge '[Backport 2025.3] docs: update a documentation of adding/removing DC and rebuilding a node' from Scylladb[bot])
