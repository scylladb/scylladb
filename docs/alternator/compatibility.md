...
* DynamoDB's DescribeTable will return information about the table, which,
  according to AWS documentation, can lag behind by up to 6 hours.
...
* DynamoDB's DescribeTable will return the `TableByteSize` field. This is size of
