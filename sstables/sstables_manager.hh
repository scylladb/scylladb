...
private:
    using signal_type = boost::signals2::signal_type<void (sstables::generation_type, manager_event_type), boost::signals2::keywords::mutex_type<boost::signals2::dummy_mutex>>::type;
...
public:
    ...
    manager_signal_connection_type subscribe(manager_signal_callback_type callback);
