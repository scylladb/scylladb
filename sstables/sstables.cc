...
||||||| parent of ed405e1519 (sstables: track metadata size on disk when rewriting a component)
...
>>>>>>> ed405e1519 (sstables: track metadata size on disk when rewriting a component)
