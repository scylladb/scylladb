...
public:
    ...
    double estimate_droppable_tombstone_ratio(const gc_clock::time_point& compaction_time, tombstone_gc_before_getter gc_before_getter, const schema_ptr& s) const;
