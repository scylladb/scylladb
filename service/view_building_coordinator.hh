...
public:
    ...
    void generate_tablet_migration_updates(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, const locator::tablet_map& tmap, locator::global_tablet_id gid, const locator::tablet_transition_info& trinfo);
    void generate_tablet_resize_updates(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, table_id table_id, const locator::tablet_map& old_tmap, const locator::tablet_map& new_tmap);

    void abort_tasks(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, table_id table_id);
    void abort_tasks(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, table_id table_id, locator::tablet_replica replica, dht::token last_token);
    void rollback_aborted_tasks(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, table_id table_id);
    void rollback_aborted_tasks(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, table_id table_id, locator::tablet_replica replica, dht::token last_token);
