...
public:
    ...
    future<> generate_tablet_migration_updates(std::vector<canonical_mutation>& out, const group0_guard& guard, const locator::tablet_migration_info& mig);
    future<> generate_tablet_resize_updates(std::vector<canonical_mutation>& out, const group0_guard& guard, table_id table_id, locator::resize_decision resize_decision);
...
private:
    ...
    std::set<locator::tablet_replica> get_replicas();
