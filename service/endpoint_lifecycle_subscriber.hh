...
public:
     ...
     */
    virtual void on_leave_cluster(const gms::inet_address& endpoint, const locator::host_id& hid) = 0;
...
public:
    ...
    future<> notify_left(gms::inet_address endpoint, locator::host_id hid);
