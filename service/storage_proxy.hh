...
public:
    ...
    void start_remote(netw::messaging_service&, gms::gossiper&, migration_manager&, sharded<db::system_keyspace>& sys_ks, raft_group0_client&, topology_state_machine&, view_building::view_building_state_machine&);
    future<> stop_remote();
