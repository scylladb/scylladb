...
private:
    ...
    future<foreign_ptr<lw_shared_ptr<query::result>>> query_singular(lw_shared_ptr<query::read_command> cmd, std::vector<dht::partition_range>&& partition_ranges, db::consistency_level cl, tracing::trace_state_ptr trace_state);
    ...
    future<foreign_ptr<lw_shared_ptr<query::result>>> query_partition_key_range(lw_shared_ptr<query::read_command> cmd, std::vector<dht::partition_range> partition_ranges, db::consistency_level cl, tracing::trace_state_ptr trace_state);
    std::vector<dht::partition_range> get_restricted_ranges(keyspace& ks, const schema& s, dht::partition_range range);
    ...
    future<std::vector<foreign_ptr<lw_shared_ptr<query::result>>>> query_partition_key_range_concurrent(std::chrono::steady_clock::time_point timeout,
            std::vector<foreign_ptr<lw_shared_ptr<query::result>>>&& results, lw_shared_ptr<query::read_command> cmd, db::consistency_level cl, std::vector<dht::partition_range>::iterator&& i,
    ...
    future<foreign_ptr<lw_shared_ptr<reconcilable_result>>> query_nonsingular_mutations_locally(
            schema_ptr s, lw_shared_ptr<query::read_command> cmd, const std::vector<dht::partition_range>& pr, tracing::trace_state_ptr trace_state);
...
public:
    ...
    */
    ...
    future<foreign_ptr<lw_shared_ptr<reconcilable_result>>> query_mutations_locally(
            schema_ptr s, lw_shared_ptr<query::read_command> cmd, const std::vector<dht::partition_range>& pr,
            tracing::trace_state_ptr trace_state = nullptr);
...
std::vector<dht::partition_range> get_restricted_ranges(locator::token_metadata&,
