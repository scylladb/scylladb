...
struct storage_proxy_coordinator_mutate_options {
    std::optional<cdc::per_request_options> cdc_options;
...
public:
    ...
    */
    future<> mutate(utils::chunked_vector<mutation> mutations, db::consistency_level cl, clock_type::time_point timeout, tracing::trace_state_ptr tr_state, service_permit permit, db::allow_per_partition_rate_limit allow_limit, bool raw_counters = false, std::optional<cdc::per_request_options> request_opts = {});
    ...
    */
    ...
    future<bool> cas(schema_ptr schema, cas_shard cas_shard, shared_ptr<cas_request> request, lw_shared_ptr<query::read_command> cmd,
            ...
            clock_type::time_point write_timeout, clock_type::time_point cas_timeout, bool write = true, std::optional<cdc::per_request_options> cdc_opts = {});
