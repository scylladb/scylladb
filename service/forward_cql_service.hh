...
private:
    ...
    bool is_stale_topology(const cql3::statements::strongly_consistent_statement& stmt, topology::version_t req_topology_version) const;
    ...
    dht::token get_token(const cql3::statements::strongly_consistent_statement& stmt, const cql3::query_options& options) const;

    locator::host_id select_replica(const cql3::statements::strongly_consistent_statement& stmt, const cql3::query_options& options, const locator::effective_replication_map& erm) const;
    ...
    const replica::column_family& get_column_family_from_statement(const cql3::statements::strongly_consistent_statement& stmt) const;
