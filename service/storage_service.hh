...
private:
    ...
    future<> transit_tablet(table_id, dht::token, noncopyable_function<future<std::tuple<utils::chunked_vector<canonical_mutation>, sstring>>(const locator::tablet_map& tmap, api::timestamp_type)> prepare_mutations);
