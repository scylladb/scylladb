...
public:
     ...
     */
    future<> removenode(locator::host_id host_id, locator::host_id_or_endpoint_list ignore_nodes, bool only_mark);
...
private:
    ...
    future<> mark_excluded(locator::host_id_or_endpoint_list);
