...
private:
    ...
    // Stores the views whose build is finished on every node of topology in the tombstone GC state of every shard
    future<> update_built_views(const locator::topology& topology, const db::system_keyspace::view_build_status_map& statuses);
