...
public:
    ...
    future<locator::mutable_token_metadata_ptr> prepare_token_metadata_with_tablets_change(const locator::tablet_metadata_change_hint& hint, mutable_token_metadata_ptr pending_token_metadata);
