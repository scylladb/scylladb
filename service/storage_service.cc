...
||||||| parent of b6fc7fa46f (topology_coordinator: Convert tablet-related updates to group0_update_collector)
        utils::chunked_vector<canonical_mutation> updates;
...
>>>>>>> b6fc7fa46f (topology_coordinator: Convert tablet-related updates to group0_update_collector)
