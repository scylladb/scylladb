...
||||||| parent of 1cca04d0ad (topology_coordinator: don't run ordered ops under a foreign session)
...
>>>>>>> 1cca04d0ad (topology_coordinator: don't run ordered ops under a foreign session)
                break;
            } catch (group0_concurrent_modification&) {
            }
        }
