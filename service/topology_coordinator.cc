...
class topology_coordinator : public endpoint_lifecycle_subscriber {
    ...
    std::unique_ptr<view_building::view_building_coordinator> _vb_coordinator;
    ...
    future<> generate_migration_update(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, const tablet_migration_info& mig) {
    ...
    future<> generate_resize_update(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, table_id table_id, locator::resize_decision resize_decision) {
...
public:
    topology_coordinator(
        ...
        , _vb_coordinator(std::make_unique<view_building::view_building_coordinator>(_db, _raft, _group0, _sys_ks, _messaging, _vb_sm, _topo_sm, _term, _as))
