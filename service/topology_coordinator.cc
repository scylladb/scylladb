            ...
            switch (trinfo.stage) {
                ...
                case locator::tablet_transition_stage::rebuild_repair: {
                    ...
                    if (advance_in_background(gid, tablet_state.rebuild_repair, "rebuild_repair", [&] {
                        ...
                        auto dst = locator::maybe_get_primary_replica(tid, {tsi.read_from.begin(), tsi.read_from.end()}, [] (const auto& tr) { return true; }).value().host;
                ...
                case locator::tablet_transition_stage::repair: {
                    ...
                    if (advance_in_background(gid, tablet_state.repair, "repair", [&, base_gid] () -> future<> {
                        auto gids = gid;
                        auto& tinfo = tmap.get_tablet_info(tid);
