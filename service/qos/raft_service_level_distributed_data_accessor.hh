...
public:
    ...
    static future<std::pair<utils::chunked_vector<mutation>, sstring>> set_service_level_mutations(cql3::query_processor& qp, sstring service_level_name, qos::service_level_options slo, api::timestamp_type timestamp);
};
