...
public:
    ...
    /**
     * Automatically create sl:driver if it hasn't been created earlier
     */
    future<> create_driver_service_level(service::raft_group0_client& group0_client, db::system_keyspace& sys_ks);
