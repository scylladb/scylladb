...
future<std::pair<utils::chunked_vector<mutation>, sstring>> raft_service_level_distributed_data_accessor::set_service_level_mutations(cql3::query_processor& qp, sstring service_level_name, qos::service_level_options slo, api::timestamp_type timestamp) {
    ...
    co_return std::make_pair(muts, insert_query);
}
...
future<> raft_service_level_distributed_data_accessor::set_service_level(sstring service_level_name, qos::service_level_options slo, service::group0_batch& mc) const {
    ...
    auto [muts, insert_query] = co_await raft_service_level_distributed_data_accessor::set_service_level_mutations(_qp, service_level_name, slo, mc.write_timestamp());
