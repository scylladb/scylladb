...
future<> view_building_coordinator::generate_tablet_migration_updates(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, dht::token last_token, const locator::tablet_migration_info& mig) {
...
future<> view_building_coordinator::generate_tablet_resize_updates(utils::chunked_vector<canonical_mutation>& out, const group0_guard& guard, const locator::tablet_map& tmap, table_id table_id, locator::resize_decision resize_decision) {
...
future<> generate_tablet_replicas_change_updates(db::system_keyspace& sys_ks, std::vector<view_building_task> tasks_for_tablet_id,
        utils::chunked_vector<canonical_mutation>& out, api::timestamp_type write_timestamp,
