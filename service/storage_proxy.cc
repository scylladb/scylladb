...
class storage_proxy::remote {
    ...
    view_building::view_building_state_machine& _vb_state_machine;
...
public:
    remote(storage_proxy& sp, netw::messaging_service& ms, gms::gossiper& g, migration_manager& mm, sharded<db::system_keyspace>& sys_ks,
                raft_group0_client& group0_client, topology_state_machine& tsm, view_building::view_building_state_machine& vbsm)
...
view_building::view_building_state_machine& storage_proxy::view_building_state_machine() {
