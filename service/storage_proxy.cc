...
public:
    ...
    future<> learn_decision(lw_shared_ptr<paxos::proposal> proposal, bool allow_hints = false, std::optional<cdc::per_request_options> cdc_opts = {});
...
future<> paxos_response_handler::learn_decision(lw_shared_ptr<paxos::proposal> decision, bool allow_hints, std::optional<cdc::per_request_options> cdc_opts) {
 ...
 */
future<> storage_proxy::mutate(utils::chunked_vector<mutation> mutations, db::consistency_level cl, clock_type::time_point timeout, tracing::trace_state_ptr tr_state, service_permit permit, db::allow_per_partition_rate_limit allow_limit, bool raw_counters, std::optional<cdc::per_request_options> request_opts) {
...
future<bool> storage_proxy::cas(schema_ptr schema, cas_shard cas_shard, shared_ptr<cas_request> request, lw_shared_ptr<query::read_command> cmd,
        ...
        clock_type::time_point write_timeout, clock_type::time_point cas_timeout, bool write, std::optional<cdc::per_request_options> cdc_opts) {
