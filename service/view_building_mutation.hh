...
public:
    ...
    view_building_task_mutation_builder& set_type(utils::UUID id, view_building_task::task_type type);
    view_building_task_mutation_builder& set_state(utils::UUID id, view_building_task::task_state state);
