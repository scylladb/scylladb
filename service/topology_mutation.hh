...
public:
    ...
    topology_mutation_builder& schedule_rf_change_request_id(const utils::UUID& value);
    topology_mutation_builder& drop_first_scheduled_rf_change_request_id(const std::vector<utils::UUID>&, utils::UUID&);
