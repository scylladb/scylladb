...
public:
    table_metrics(table_id table, sstring ks_name, sstring cf_name, bool per_shard);
    ...
    const sstring& ks_name() const { return _ks_name; }
    const sstring& cf_name() const { return _cf_name; }
