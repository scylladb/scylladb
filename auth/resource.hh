...
class resource final {
    ...
    // True if this is a data resource and the table has a vector index **and we care about it**.
    ...
    bool _is_vector_indexed_table = false;

public:
    ///
    /// A root resource of a particular kind.
    ///
    resource(resource_kind, bool is_vector_indexed = false);
    ...
    bool is_vector_indexed_table() const noexcept {
        return _is_vector_indexed_table;
    }
