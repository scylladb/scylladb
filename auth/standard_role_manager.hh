...
public:
    ...
    virtual future<> create(std::string_view role_name, const role_config&, mutations_collector&) override;
...
private:
    ...
    future<> create_or_replace(std::string_view role_name, const role_config&, mutations_collector&);
