...
verb [[with_client_info, with_timeout]] forward_cql_execute (unsigned shard, service::forward_cql_execute_request req [[ref]]) -> service::forward_cql_execute_response;
