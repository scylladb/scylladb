...
verb [[with_client_info]] repair_compaction_ctrl (locator::global_tablet_id gid, service::frozen_topology_guard topo_guard);
verb [[with_client_info]] repair_update_repaired_at(table_id);
