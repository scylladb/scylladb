...
verb forward_request(parallel_aggregations::parametrized_forward_request<lowres_system_clock::time_point>, std::optional<tracing::trace_info>) -> parallel_aggregations::forward_result;
