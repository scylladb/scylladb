...
enum class messaging_verb : int32_t {
    ...
    WAIT_FOR_SNAPSHOT_TRANSFER = 94,
    SYNC_RAFT_GROUP_CONFIG = 95,
    REPAIR_GET_ROW_DIFF_WITH_RPC_STREAM_BATCHED = 96,
    REPAIR_PUT_ROW_DIFF_WITH_RPC_STREAM_BATCHED = 97,
    REPAIR_GET_FULL_ROW_HASHES_WITH_RPC_STREAM_BATCHED = 98,
