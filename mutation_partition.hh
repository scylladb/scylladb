...
public:
    ...
    void query(query::result::partition_writer& pw, const schema& s, const query::partition_slice& slice, gc_clock::time_point now, uint32_t limit = query::max_rows) const;
};
