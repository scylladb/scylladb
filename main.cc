...
// the ticket about migrating to libunwind: scylladb/seastar#1878
          ...
          shared_token_metadata::mutate_on_all_shards(token_metadata, [host_id] (locator::token_metadata& tm) {
            ...
            alternator::controller alternator_ctl(gossiper, proxy, mm, sys_dist_ks, sys_ks, cdc_generation_service, service_memory_limiter, auth_service, sl_controller, *cfg, dbcfg.statement_scheduling_group);
