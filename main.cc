...
<<<<<<< HEAD
||||||| parent of 69a5888da7 (test: add test_stop_before_starting_compaction_manager)
...
=======
            ...
            cm.invoke_on_all(&compaction::compaction_manager::start, std::ref(*cfg), only_on_shard0(&*disk_space_monitor_shard0)).get();
>>>>>>> 69a5888da7 (test: add test_stop_before_starting_compaction_manager)
...
// the ticket about migrating to libunwind: scylladb/seastar#1878
          ...
          shared_token_metadata::mutate_on_all_shards(token_metadata, [host_id] (locator::token_metadata& tm) {
            ...
            sst_loader.start(std::ref(db), std::ref(ss), std::ref(messaging), std::ref(view_builder), std::ref(task_manager), std::ref(sstm), maintenance_scheduling_group).get();
