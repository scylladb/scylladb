...
column_definition::column_definition(bytes name, data_type type, column_kind kind, column_id component_index, column_view_virtual is_view_virtual, column_internal_t is_internal, column_computation_ptr computation, api::timestamp_type dropped_at)
        : _name(std::move(name))
...
schema_builder& schema_builder::with_column(bytes name, data_type type, column_kind kind, column_view_virtual is_view_virtual, column_internal_t is_internal) {
    // component_index will be determined by schema constructor
    return with_column(name, type, kind, 0, is_view_virtual, is_internal);
}

schema_builder& schema_builder::with_column(bytes name, data_type type, column_kind kind, column_id component_index, column_view_virtual is_view_virtual, column_internal_t is_internal, column_computation_ptr computation) {
...
schema_builder& schema_builder::with_computed_column(bytes name, data_type type, column_kind kind, column_computation_ptr computation) {
    return with_column(name, type, kind, 0, column_view_virtual::no, column_internal_t::no, std::move(computation));
}
