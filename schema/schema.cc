...
schema_ptr schema_builder::build(schema::raw_schema& new_raw) {
    ...
    if (_base_info) {
        return make_lw_shared<schema>(schema::private_tag{}, new_raw, _static_props, _base_info);
    } else if (_base_schema) {
        return make_lw_shared<schema>(schema::private_tag{}, new_raw, _static_props, _base_schema);
    }
    return make_lw_shared<schema>(schema::private_tag{}, new_raw, _static_props);
}
