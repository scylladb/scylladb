...
public:
    ...
    // The maximum length of any name. It is limited by the maximum length of a table name.
    ...
    // We also reserve 15 bytes for the "_scylla_cdc_log" suffix in case of CDC-enabled tables.
