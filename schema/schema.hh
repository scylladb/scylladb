...
using column_internal_t = bool_class<class column_internal_tag>;
...
private:
    ...
    column_internal_t _is_internal;
...
public:
    column_definition(bytes name, data_type type, column_kind kind,
        ...
        column_internal_t = column_internal_t::no,
    ...
    column_internal_t is_internal() const { return _is_internal; }
