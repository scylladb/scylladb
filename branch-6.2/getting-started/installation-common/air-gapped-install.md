...
- Without root privileges: using the [ScyllaDB Unified Installer](https://opensource.docs.scylladb.com/stable/getting-started/installation-common/unified-installer.md).
