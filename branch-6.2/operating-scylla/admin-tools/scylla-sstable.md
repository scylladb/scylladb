...
For more information about the sstable components and the format itself, visit [SSTable Format](https://opensource.docs.scylladb.com/stable/architecture/sstable/index.md).
