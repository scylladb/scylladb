...
#### WARNING
SSTabledump is deprecated since ScyllaDB 5.4, and will be removed in a future release.
Please consider switching to [ScyllaDB SSTable](https://opensource.docs.scylladb.com/stable/operating-scylla/admin-tools/scylla-sstable.md).

This tool allows you to converts SSTable into a JSON format file.
If you need more flexibility or want to dump more than just the data-component, see [scylla-sstable](https://opensource.docs.scylladb.com/stable/operating-scylla/admin-tools/scylla-sstable.md).
