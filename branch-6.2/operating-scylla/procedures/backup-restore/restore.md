...
If this is not the case, one should use other restoration methods tools like [sstableloader](https://opensource.docs.scylladb.com/stable/operating-scylla/procedures/cassandra-to-scylla-migration-process.md). This procedure is much slower than restoring to the same topology cluster.
...
#### NOTE
Best practise is **not** to restore [Materialized Views (MV)](https://opensource.docs.scylladb.com/stable/features/materialized-views.md) and [Secondary Indexes (SI)](https://opensource.docs.scylladb.com/stable/features/secondary-indexes.md) SSTables.
...
1. Run the [nodetool drain](https://opensource.docs.scylladb.com/stable/operating-scylla/nodetool-commands/drain.md) command to ensure the data is flushed to the SSTables
