...
3. Start cqlsh with the default superuser username and password.
   ...
   to improve security.
   See [Creating a Custom Superuser](https://opensource.docs.scylladb.com/stable/operating-scylla/security/create-superuser.md) for instructions.
4. If you want to create users and roles, continue to [Enable Authorization](https://opensource.docs.scylladb.com/stable/operating-scylla/security/enable-authorization.md).

## Additional Resources

* [Enable and Disable Authentication Without Downtime](https://opensource.docs.scylladb.com/stable/operating-scylla/security/runtime-authentication.md)
* [Enable Authorization](https://opensource.docs.scylladb.com/stable/operating-scylla/security/enable-authorization.md)
* [Authorization](https://opensource.docs.scylladb.com/stable/operating-scylla/security/authorization.md)
