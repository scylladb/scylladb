...
To build a self-signed certificate chain, see [generating a self-signed certificate chain using openssl](https://opensource.docs.scylladb.com/stable/operating-scylla/security/generate-certificate.md).
...
* [Generating a self-signed Certificate Chain Using openssl](https://opensource.docs.scylladb.com/stable/operating-scylla/security/generate-certificate.md)
* [Authorization](https://opensource.docs.scylladb.com/stable/operating-scylla/security/authorization.md)
* [Invalid SSL Protocol Error](https://opensource.docs.scylladb.com/stable/troubleshooting/error-messages/invalid-ssl-prot-error.md)
