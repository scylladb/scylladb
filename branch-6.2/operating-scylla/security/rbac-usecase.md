...
In this case, four roles would be created: staff, customer, trainer, and administrator. Permissions could be any of the [following](https://opensource.docs.scylladb.com/stable/operating-scylla/security/authorization.md#data-control).
...
* [CQLSh the CQL shell](https://opensource.docs.scylladb.com/stable/cql/cqlsh.md)
