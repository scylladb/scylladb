...
See [Remove a Node from a ScyllaDB Cluster (Down Scale)](https://opensource.docs.scylladb.com/stable/operating-scylla/procedures/cluster-management/remove-node.md)
