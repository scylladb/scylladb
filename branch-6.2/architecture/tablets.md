...
controlled by the [`enable_tablets`](https://opensource.docs.scylladb.com/stable/reference/configuration-parameters.md#confval-enable_tablets) option. However, tablets only work if
