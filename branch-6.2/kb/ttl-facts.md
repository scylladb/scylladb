...
It is not always clear under which circumstances data is deleted when using Time to Live (TTL) and [gc_grace_seconds](https://opensource.docs.scylladb.com/stable/cql/ddl.md#gc-grace-seconds) arguments in table definitions.
...
* [How to Change gc_grace_seconds for a Table](https://opensource.docs.scylladb.com/stable/kb/gc-grace-seconds.md)
* [Expiring Data with Time to Live (TTL)](https://opensource.docs.scylladb.com/stable/cql/time-to-live.md)
