...
specify a Consistency Level per query is known as [Tunable Consistency](https://opensource.docs.scylladb.com/stable/reference/glossary.md#term-Tunable-Consistency).
...
A related feature is [Lightweight Transactions (LWT)](https://opensource.docs.scylladb.com/stable/features/lwt.md). LWT in ScyllaDB allow the client
