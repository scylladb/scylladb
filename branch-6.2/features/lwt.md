...
#### NOTE
The LWT feature is not supported in keyspaces with [tablets](https://opensource.docs.scylladb.com/stable/architecture/tablets.md) enabled.
...
* [How does ScyllaDB LWT Differ from Apache Cassandra ?](https://opensource.docs.scylladb.com/stable/kb/lwt-differences.md) - How does ScyllaDB’s implementation of lightweight transactions differ from Apache Cassandra?
* [How to Change gc_grace_seconds for a Table](https://opensource.docs.scylladb.com/stable/kb/gc-grace-seconds.md) - How to change the `gc_grace_seconds` parameter for a table
