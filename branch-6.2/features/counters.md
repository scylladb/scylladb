...
#### NOTE
Counters are not supported in keyspaces with [tablets](https://opensource.docs.scylladb.com/stable/architecture/tablets.md) enabled.
...
* Updates are **not** [idempotent](https://opensource.docs.scylladb.com/stable/reference/glossary.md#term-Idempotent). In the case of a write failure, the client cannot safely retry the request.
...
* Read our [blog](http://www.scylladb.com/2017/04/04/counters/) on counters, or see the data type [description](https://opensource.docs.scylladb.com/stable/cql/types.md#counters).
