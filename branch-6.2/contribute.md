...
The entire process is [documented here](https://github.com/scylladb/scylla/blob/master/CONTRIBUTING.md).
...
For general information or to contribute to the ScyllaDB Sphinx theme, read the [Contributor’s Guide](https://sphinx-theme.scylladb.com/stable/contribute/).
