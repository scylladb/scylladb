...
a ScyllaDB table using [ScyllaDB CDC](https://opensource.docs.scylladb.com/stable/features/cdc/cdc-intro.md).
...
environments, please refer to the [Getting Started guide](https://opensource.docs.scylladb.com/stable/getting-started/index.md).
...
To learn more about ScyllaDB CDC, visit [Change Data Capture (CDC) page](https://opensource.docs.scylladb.com/stable/features/cdc/index.md).
