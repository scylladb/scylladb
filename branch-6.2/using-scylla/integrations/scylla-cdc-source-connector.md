...
* Replication of row-level changes from ScyllaDB using [ScyllaDB CDC](https://opensource.docs.scylladb.com/stable/features/cdc/cdc-intro.md). The connector replicates the following operations: `INSERT`, `UPDATE`, `DELETE` (single row deletes)
...
* [ScyllaDB CDC Source Connector Quickstart](https://opensource.docs.scylladb.com/stable/using-scylla/integrations/scylla-cdc-source-connector-quickstart.md)
